...
//
//	04	kdoig	06-jan-2013
//

import org.petermac.pathos.loader.EtlTransform
import org.petermac.util.Locator

println( "SeqETL Configuration Ver 1.0.1" )
...
transform
        {
            ...
            {
				def tsv = "mp_vep.tsv"
                transform = { et.mp_vep( new File("Raw",tsv), new File(stagingDir,tsv))}
            }
            ...
            mp_mutdesc
            {
                ...
                transform = { et.mp_mutdesc( new File("Raw",tsv), new File(stagingDir,tsv))}
			}
...
//
//	Post database load stitch up  Todo: deprecated
//
postload
        {
            scriptdir = 'PostLoad'
