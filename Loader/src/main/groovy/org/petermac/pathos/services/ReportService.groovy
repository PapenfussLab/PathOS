...
class ReportService
{
     ...
     */
    byte[] sampleReport( SeqSample sample, Boolean hidePat, String fileExt, String swVersion = '' ) throws FileNotFoundException
    {
        //  Open files
        //
        File outfile   = setOutput( sample, fileExt )
        List templates = setTemplates( sample )
        if ( ! templates )
        {
     ...
     */
    public List setTemplates( SeqSample sample )
    {
