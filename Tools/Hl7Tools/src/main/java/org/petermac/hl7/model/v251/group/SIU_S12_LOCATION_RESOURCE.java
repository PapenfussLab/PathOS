...
/**
 * <p>Represents a SIU_S12_LOCATION_RESOURCE group structure (a Group object).
...
public class SIU_S12_LOCATION_RESOURCE extends AbstractGroup {

    /** 
     * Creates a new SIU_S12_LOCATION_RESOURCE group
     */
    public SIU_S12_LOCATION_RESOURCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SIU_S12_LOCATION_RESOURCE - this is probably a bug in the source code generator.", e);
       }
    }
