...
/**
 * <p>Represents a SQM_S25_RESOURCES group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RGS (Resource Group) <b>  </b></li>
                         * <li>2: SQM_S25_SERVICE (a Group object) <b>optional repeating </b></li>
                         * <li>3: SQM_S25_GENERAL_RESOURCE (a Group object) <b>optional repeating </b></li>
                         * <li>4: SQM_S25_PERSONNEL_RESOURCE (a Group object) <b>optional repeating </b></li>
                         * <li>5: SQM_S25_LOCATION_RESOURCE (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class SQM_S25_RESOURCES extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(SQM_S25_SERVICE.class, false, true, false);
                                  this.add(SQM_S25_GENERAL_RESOURCE.class, false, true, false);
                                  this.add(SQM_S25_PERSONNEL_RESOURCE.class, false, true, false);
                                  this.add(SQM_S25_LOCATION_RESOURCE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating SQM_S25_RESOURCES - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SQM_S25_SERVICE getSERVICE() { 
       SQM_S25_SERVICE retVal = getTyped("SERVICE", SQM_S25_SERVICE.class);
       return retVal;
    }
    ...
    public SQM_S25_SERVICE getSERVICE(int rep) { 
       SQM_S25_SERVICE retVal = getTyped("SERVICE", rep, SQM_S25_SERVICE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQM_S25_SERVICE> getSERVICEAll() throws HL7Exception {
    	return getAllAsList("SERVICE", SQM_S25_SERVICE.class);
    } 
    ...
    public SQM_S25_GENERAL_RESOURCE getGENERAL_RESOURCE() { 
       SQM_S25_GENERAL_RESOURCE retVal = getTyped("GENERAL_RESOURCE", SQM_S25_GENERAL_RESOURCE.class);
       return retVal;
    }
    ...
    public SQM_S25_GENERAL_RESOURCE getGENERAL_RESOURCE(int rep) { 
       SQM_S25_GENERAL_RESOURCE retVal = getTyped("GENERAL_RESOURCE", rep, SQM_S25_GENERAL_RESOURCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQM_S25_GENERAL_RESOURCE> getGENERAL_RESOURCEAll() throws HL7Exception {
    	return getAllAsList("GENERAL_RESOURCE", SQM_S25_GENERAL_RESOURCE.class);
    } 
    ...
    public SQM_S25_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE() { 
       SQM_S25_PERSONNEL_RESOURCE retVal = getTyped("PERSONNEL_RESOURCE", SQM_S25_PERSONNEL_RESOURCE.class);
       return retVal;
    }
    ...
    public SQM_S25_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE(int rep) { 
       SQM_S25_PERSONNEL_RESOURCE retVal = getTyped("PERSONNEL_RESOURCE", rep, SQM_S25_PERSONNEL_RESOURCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQM_S25_PERSONNEL_RESOURCE> getPERSONNEL_RESOURCEAll() throws HL7Exception {
    	return getAllAsList("PERSONNEL_RESOURCE", SQM_S25_PERSONNEL_RESOURCE.class);
    } 
    ...
    public SQM_S25_LOCATION_RESOURCE getLOCATION_RESOURCE() { 
       SQM_S25_LOCATION_RESOURCE retVal = getTyped("LOCATION_RESOURCE", SQM_S25_LOCATION_RESOURCE.class);
       return retVal;
    }
    ...
    public SQM_S25_LOCATION_RESOURCE getLOCATION_RESOURCE(int rep) { 
       SQM_S25_LOCATION_RESOURCE retVal = getTyped("LOCATION_RESOURCE", rep, SQM_S25_LOCATION_RESOURCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQM_S25_LOCATION_RESOURCE> getLOCATION_RESOURCEAll() throws HL7Exception {
    	return getAllAsList("LOCATION_RESOURCE", SQM_S25_LOCATION_RESOURCE.class);
    } 
