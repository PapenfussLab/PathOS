...
/**
 * <p>Represents a BRP_O30_TIMING group structure (a Group object).
...
public class BRP_O30_TIMING extends AbstractGroup {

    /** 
     * Creates a new BRP_O30_TIMING group
     */
    public BRP_O30_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating BRP_O30_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
