...
/**
 * <p>Represents a REF_I12_PROVIDER_CONTACT group structure (a Group object).
...
public class REF_I12_PROVIDER_CONTACT extends AbstractGroup {

    /** 
     * Creates a new REF_I12_PROVIDER_CONTACT group
     */
    public REF_I12_PROVIDER_CONTACT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating REF_I12_PROVIDER_CONTACT - this is probably a bug in the source code generator.", e);
       }
    }
