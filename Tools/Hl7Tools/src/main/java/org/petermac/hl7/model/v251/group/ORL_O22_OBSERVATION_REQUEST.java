...
/**
 * <p>Represents a ORL_O22_OBSERVATION_REQUEST group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OBR (Observation Request) <b>  </b></li>
                         * <li>2: ORL_O22_SPECIMEN (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class ORL_O22_OBSERVATION_REQUEST extends AbstractGroup {
    ...
    public ORL_O22_SPECIMEN getSPECIMEN() { 
       ORL_O22_SPECIMEN retVal = getTyped("SPECIMEN", ORL_O22_SPECIMEN.class);
       return retVal;
    }
    ...
    public ORL_O22_SPECIMEN getSPECIMEN(int rep) { 
       ORL_O22_SPECIMEN retVal = getTyped("SPECIMEN", rep, ORL_O22_SPECIMEN.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORL_O22_SPECIMEN> getSPECIMENAll() throws HL7Exception {
