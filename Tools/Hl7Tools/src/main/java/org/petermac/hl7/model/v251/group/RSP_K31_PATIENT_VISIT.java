...
/**
 * <p>Represents a RSP_K31_PATIENT_VISIT group structure (a Group object).
...
public class RSP_K31_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new RSP_K31_PATIENT_VISIT group
     */
    public RSP_K31_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_K31_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
