...
public class FT1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Transaction Code");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Department Code");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Insurance Plan ID");
                                  ...
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "Diagnosis Code - FT1");
                                  ...
                                  this.add(CNE.class, false, 1, 250, new Object[]{ getMessage() }, "NDC Code");
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 28: return new CNE(getMessage());
