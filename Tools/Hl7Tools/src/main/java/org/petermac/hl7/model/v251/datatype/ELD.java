 ...
 * 
 * The Original Code is "ELD.java".  Description:
 * "Composite class ELD"
 * 
...
/**
 * <p>Represents an HL7 ELD (Error Location and Description) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>Segment ID (ST)
 * <li>Segment Sequence (NM)
 * <li>Field Position (NM)
 * <li>Code Identifying Error (CE)
 * </ul>
 */
...
public class ELD extends AbstractComposite {
    ...
    /**
     * Returns Code Identifying Error (component 4).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public CE getCodeIdentifyingError() {
       return getTyped(3, CE.class);
    }
