...
/**
 * <p>Represents a RRD_O14_DISPENSE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXD (Pharmacy/Treatment Dispense) <b>  </b></li>
...
public class RRD_O14_DISPENSE extends AbstractGroup {

    /** 
     * Creates a new RRD_O14_DISPENSE group
     */
    public RRD_O14_DISPENSE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRD_O14_DISPENSE - this is probably a bug in the source code generator.", e);
       }
    }
