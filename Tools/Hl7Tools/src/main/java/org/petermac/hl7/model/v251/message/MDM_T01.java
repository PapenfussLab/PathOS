...
/**
 * <p>Represents a MDM_T01 message structure (see chapter 9.5.1). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: MDM_T01_COMMON_ORDER (a Group object) <b>optional repeating</b> </li>
...
public class MDM_T01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(MDM_T01_COMMON_ORDER.class, false, true);
    ...
    public MDM_T01_COMMON_ORDER getCOMMON_ORDER() { 
       return getTyped("COMMON_ORDER", MDM_T01_COMMON_ORDER.class);
    }
    ...
    public MDM_T01_COMMON_ORDER getCOMMON_ORDER(int rep) { 
       return getTyped("COMMON_ORDER", rep, MDM_T01_COMMON_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<MDM_T01_COMMON_ORDER> getCOMMON_ORDERAll() throws HL7Exception {
    	return getAllAsList("COMMON_ORDER", MDM_T01_COMMON_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertCOMMON_ORDER(MDM_T01_COMMON_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public MDM_T01_COMMON_ORDER insertCOMMON_ORDER(int rep) throws HL7Exception { 
       return (MDM_T01_COMMON_ORDER)super.insertRepetition("COMMON_ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public MDM_T01_COMMON_ORDER removeCOMMON_ORDER(int rep) throws HL7Exception { 
       return (MDM_T01_COMMON_ORDER)super.removeRepetition("COMMON_ORDER", rep);
    }
