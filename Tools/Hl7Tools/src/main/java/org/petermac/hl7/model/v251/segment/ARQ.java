...
public class ARQ extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 75, new Object[]{ getMessage() }, "Placer Appointment ID");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Schedule ID");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Request Event Reason");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Appointment Reason");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Appointment Type");
                                  this.add(NM.class, false, 1, 20, new Object[]{ getMessage() }, "Appointment Duration");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Appointment Duration Units");
                                  this.add(DR.class, false, 0, 53, new Object[]{ getMessage() }, "Requested Start Date/Time Range");
                                  this.add(ST.class, false, 1, 5, new Object[]{ getMessage() }, "Priority-ARQ");
                                  ...
                                  this.add(XCN.class, true, 0, 250, new Object[]{ getMessage() }, "Placer Contact Person");
                                  this.add(XTN.class, false, 0, 250, new Object[]{ getMessage() }, "Placer Contact Phone Number");
                                  ...
                                  this.add(EI.class, false, 0, 22, new Object[]{ getMessage() }, "Filler Order Number");
