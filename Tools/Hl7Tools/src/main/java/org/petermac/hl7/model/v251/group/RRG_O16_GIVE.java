...
public class RRG_O16_GIVE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RRG_O16_TIMING_GIVE.class, true, true, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRG_O16_GIVE - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public java.util.List<RRG_O16_TIMING_GIVE> getTIMING_GIVEAll() throws HL7Exception {
