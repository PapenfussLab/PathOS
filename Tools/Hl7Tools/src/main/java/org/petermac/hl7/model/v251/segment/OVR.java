...
public class OVR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Business Rule Override Type");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Business Rule Override Code");
                                  this.add(TX.class, false, 1, 200, new Object[]{ getMessage() }, "Override Comments");
                                  this.add(XCN.class, false, 1, 250, new Object[]{ getMessage() }, "Override Entered By");
                                  this.add(XCN.class, false, 1, 250, new Object[]{ getMessage() }, "Override Authorized By");
