...
/**
 * <p>Represents a RSP_Z88_COMMON_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: RSP_Z88_TIMING (a Group object) <b>optional repeating </b></li>
                         * <li>3: RSP_Z88_ORDER_DETAIL (a Group object) <b>optional  </b></li>
                         * <li>4: RSP_Z88_ORDER_ENCODED (a Group object) <b>optional  </b></li>
                         * <li>5: RXD (Pharmacy/Treatment Dispense) <b>  </b></li>
                         * <li>6: RXR (Pharmacy/Treatment Route) <b> repeating </b></li>
                         * <li>7: RXC (Pharmacy/Treatment Component Order) <b>optional repeating </b></li>
                         * <li>8: RSP_Z88_OBSERVATION (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RSP_Z88_COMMON_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RSP_Z88_TIMING.class, false, true, false);
                                  this.add(RSP_Z88_ORDER_DETAIL.class, false, false, false);
                                  this.add(RSP_Z88_ORDER_ENCODED.class, false, false, false);
                                  this.add(RXD.class, true, false, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
                                  this.add(RSP_Z88_OBSERVATION.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z88_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RSP_Z88_TIMING getTIMING() { 
       RSP_Z88_TIMING retVal = getTyped("TIMING", RSP_Z88_TIMING.class);
       return retVal;
    }
    ...
    public RSP_Z88_TIMING getTIMING(int rep) { 
       RSP_Z88_TIMING retVal = getTyped("TIMING", rep, RSP_Z88_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RSP_Z88_TIMING> getTIMINGAll() throws HL7Exception {
    	return getAllAsList("TIMING", RSP_Z88_TIMING.class);
    } 
     ...
     */
    public void insertTIMING(RSP_Z88_TIMING structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RSP_Z88_TIMING insertTIMING(int rep) throws HL7Exception { 
       return (RSP_Z88_TIMING)super.insertRepetition("TIMING", rep);
    }
     ...
     */
    public RSP_Z88_TIMING removeTIMING(int rep) throws HL7Exception { 
       return (RSP_Z88_TIMING)super.removeRepetition("TIMING", rep);
    }
    ...
    public RSP_Z88_ORDER_DETAIL getORDER_DETAIL() { 
       RSP_Z88_ORDER_DETAIL retVal = getTyped("ORDER_DETAIL", RSP_Z88_ORDER_DETAIL.class);
       return retVal;
    }
    ...
    /**
     * Returns
     * ORDER_ENCODED (a Group object) - creates it if necessary
     */
    public RSP_Z88_ORDER_ENCODED getORDER_ENCODED() { 
       RSP_Z88_ORDER_ENCODED retVal = getTyped("ORDER_ENCODED", RSP_Z88_ORDER_ENCODED.class);
       return retVal;
    }
    ...
    public RSP_Z88_OBSERVATION getOBSERVATION() { 
       RSP_Z88_OBSERVATION retVal = getTyped("OBSERVATION", RSP_Z88_OBSERVATION.class);
       return retVal;
    }
    ...
    public RSP_Z88_OBSERVATION getOBSERVATION(int rep) { 
       RSP_Z88_OBSERVATION retVal = getTyped("OBSERVATION", rep, RSP_Z88_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RSP_Z88_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", RSP_Z88_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBSERVATION(RSP_Z88_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RSP_Z88_OBSERVATION insertOBSERVATION(int rep) throws HL7Exception { 
       return (RSP_Z88_OBSERVATION)super.insertRepetition("OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RSP_Z88_OBSERVATION removeOBSERVATION(int rep) throws HL7Exception { 
       return (RSP_Z88_OBSERVATION)super.removeRepetition("OBSERVATION", rep);
    }
