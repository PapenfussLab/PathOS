...
/**
 * <p>Represents a ACK message structure (see chapter 2.14.1). This structure contains the 
...
public class ACK extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ACK - this is probably a bug in the source code generator.", e);
       }
    }
