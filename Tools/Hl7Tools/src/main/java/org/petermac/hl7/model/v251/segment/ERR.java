 ...
 * <ul>
     * <li>ERR-1: Error Code and Location (ELD) <b>optional repeating</b>
     ...
     * <li>ERR-9: Inform Person Indicator (IS) <b>optional repeating</b>
...
public class ERR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ELD.class, false, 0, 493, new Object[]{ getMessage() }, "Error Code and Location");
                                  this.add(ERL.class, false, 0, 18, new Object[]{ getMessage() }, "Error Location");
                                  this.add(CWE.class, true, 1, 705, new Object[]{ getMessage() }, "HL7 Error Code");
                                              this.add(ID.class, true, 1, 2, new Object[]{ getMessage(), new Integer(516) }, "Severity");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Application Error Code");
                                  this.add(ST.class, false, 10, 80, new Object[]{ getMessage() }, "Application Error Parameter");
                                  this.add(TX.class, false, 1, 2048, new Object[]{ getMessage() }, "Diagnostic Information");
                                  this.add(TX.class, false, 1, 250, new Object[]{ getMessage() }, "User Message");
                                              this.add(IS.class, false, 0, 20, new Object[]{ getMessage(), new Integer(517) }, "Inform Person Indicator");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Override Type");
                                  this.add(CWE.class, false, 0, 705, new Object[]{ getMessage() }, "Override Reason Code");
                                  this.add(XTN.class, false, 0, 652, new Object[]{ getMessage() }, "Help Desk Contact Point");
    ...
    public IS[] getInformPersonIndicator() {
    	IS[] retVal = this.getTypedField(9, new IS[0]);
    	return retVal;
    }
    ...
    public IS getInformPersonIndicator(int rep) { 
		IS retVal = this.getTypedField(9, rep);
		return retVal;
    }
