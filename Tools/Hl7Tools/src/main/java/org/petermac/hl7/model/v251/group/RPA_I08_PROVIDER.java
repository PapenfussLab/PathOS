...
/**
 * <p>Represents a RPA_I08_PROVIDER group structure (a Group object).
...
public class RPA_I08_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RPA_I08_PROVIDER group
     */
    public RPA_I08_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I08_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
