...
/**
 * <p>Represents a RAS_O17_TIMING_ENCODED group structure (a Group object).
...
public class RAS_O17_TIMING_ENCODED extends AbstractGroup {

    /** 
     * Creates a new RAS_O17_TIMING_ENCODED group
     */
    public RAS_O17_TIMING_ENCODED(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RAS_O17_TIMING_ENCODED - this is probably a bug in the source code generator.", e);
       }
    }
