...
/**
 * <p>Represents a RRA_O18_RESPONSE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RRA_O18_PATIENT (a Group object) <b>optional  </b></li>
                         * <li>2: RRA_O18_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RRA_O18_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRA_O18_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RRA_O18_PATIENT getPATIENT() { 
       RRA_O18_PATIENT retVal = getTyped("PATIENT", RRA_O18_PATIENT.class);
       return retVal;
    }
    ...
    public RRA_O18_ORDER getORDER() { 
       RRA_O18_ORDER retVal = getTyped("ORDER", RRA_O18_ORDER.class);
       return retVal;
    }
    ...
    public RRA_O18_ORDER getORDER(int rep) { 
       RRA_O18_ORDER retVal = getTyped("ORDER", rep, RRA_O18_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RRA_O18_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", RRA_O18_ORDER.class);
    } 
