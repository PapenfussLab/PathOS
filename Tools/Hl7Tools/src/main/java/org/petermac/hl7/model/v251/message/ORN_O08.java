...
/**
 * <p>Represents a ORN_O08 message structure (see chapter 4.10.4). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORN_O08_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORN_O08 extends AbstractMessage  {

    /**
     * Creates a new ORN_O08 message with DefaultModelClassFactory. 
     */ 
    public ORN_O08() { 
    ...
    /** 
     * Creates a new ORN_O08 message with custom ModelClassFactory.
     */
    public ORN_O08(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORN_O08_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORN_O08 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORN_O08_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORN_O08_RESPONSE.class);
    }
