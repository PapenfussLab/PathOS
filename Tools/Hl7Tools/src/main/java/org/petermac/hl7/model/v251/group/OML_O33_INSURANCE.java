...
/**
 * <p>Represents a OML_O33_INSURANCE group structure (a Group object).
...
public class OML_O33_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new OML_O33_INSURANCE group
     */
    public OML_O33_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OML_O33_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
