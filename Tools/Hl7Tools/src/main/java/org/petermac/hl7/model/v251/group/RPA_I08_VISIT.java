...
/**
 * <p>Represents a RPA_I08_VISIT group structure (a Group object).
...
public class RPA_I08_VISIT extends AbstractGroup {

    /** 
     * Creates a new RPA_I08_VISIT group
     */
    public RPA_I08_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I08_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
