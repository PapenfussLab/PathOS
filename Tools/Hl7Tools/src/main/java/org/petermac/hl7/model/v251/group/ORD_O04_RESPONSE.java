...
/**
 * <p>Represents a ORD_O04_RESPONSE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORD_O04_PATIENT (a Group object) <b>optional  </b></li>
                         * <li>2: ORD_O04_ORDER_DIET (a Group object) <b> repeating </b></li>
                         * <li>3: ORD_O04_ORDER_TRAY (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class ORD_O04_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ORD_O04_PATIENT.class, false, false, false);
                                  this.add(ORD_O04_ORDER_DIET.class, true, true, false);
                                  this.add(ORD_O04_ORDER_TRAY.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORD_O04_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORD_O04_PATIENT getPATIENT() { 
       ORD_O04_PATIENT retVal = getTyped("PATIENT", ORD_O04_PATIENT.class);
       return retVal;
    }
    ...
    public ORD_O04_ORDER_DIET getORDER_DIET() { 
       ORD_O04_ORDER_DIET retVal = getTyped("ORDER_DIET", ORD_O04_ORDER_DIET.class);
       return retVal;
    }
    ...
    public ORD_O04_ORDER_DIET getORDER_DIET(int rep) { 
       ORD_O04_ORDER_DIET retVal = getTyped("ORDER_DIET", rep, ORD_O04_ORDER_DIET.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORD_O04_ORDER_DIET> getORDER_DIETAll() throws HL7Exception {
    ...
    public ORD_O04_ORDER_TRAY getORDER_TRAY() { 
       ORD_O04_ORDER_TRAY retVal = getTyped("ORDER_TRAY", ORD_O04_ORDER_TRAY.class);
       return retVal;
    }
    ...
    public ORD_O04_ORDER_TRAY getORDER_TRAY(int rep) { 
       ORD_O04_ORDER_TRAY retVal = getTyped("ORDER_TRAY", rep, ORD_O04_ORDER_TRAY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORD_O04_ORDER_TRAY> getORDER_TRAYAll() throws HL7Exception {
