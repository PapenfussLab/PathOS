...
/**
 * <p>Represents a OMN_O07_PATIENT_VISIT group structure (a Group object).
...
public class OMN_O07_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new OMN_O07_PATIENT_VISIT group
     */
    public OMN_O07_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMN_O07_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
