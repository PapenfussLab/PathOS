...
/**
 * <p>Represents a ORL_O34_SPECIMEN group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: ORL_O34_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class ORL_O34_SPECIMEN extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORL_O34_SPECIMEN - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORL_O34_ORDER getORDER() { 
       ORL_O34_ORDER retVal = getTyped("ORDER", ORL_O34_ORDER.class);
       return retVal;
    }
    ...
    public ORL_O34_ORDER getORDER(int rep) { 
       ORL_O34_ORDER retVal = getTyped("ORDER", rep, ORL_O34_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORL_O34_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", ORL_O34_ORDER.class);
    } 
