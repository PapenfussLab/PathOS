...
/**
 * <p>Represents a RAS_O17 message structure (see chapter 4.13.11). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: NTE (Notes and Comments) <b>optional repeating</b> </li>
		                 * <li>4: RAS_O17_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>5: RAS_O17_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RAS_O17 extends AbstractMessage  {

    /**
     * Creates a new RAS_O17 message with DefaultModelClassFactory. 
     */ 
    public RAS_O17() { 
    ...
    /** 
     * Creates a new RAS_O17 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RAS_O17 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RAS_O17_PATIENT getPATIENT() { 
       return getTyped("PATIENT", RAS_O17_PATIENT.class);
    }
    ...
    public RAS_O17_ORDER getORDER() { 
       return getTyped("ORDER", RAS_O17_ORDER.class);
    }
    ...
    public RAS_O17_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, RAS_O17_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RAS_O17_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", RAS_O17_ORDER.class);
    } 
