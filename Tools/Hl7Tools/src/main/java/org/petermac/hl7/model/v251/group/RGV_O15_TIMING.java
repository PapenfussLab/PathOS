...
/**
 * <p>Represents a RGV_O15_TIMING group structure (a Group object).
...
public class RGV_O15_TIMING extends AbstractGroup {

    /** 
     * Creates a new RGV_O15_TIMING group
     */
    public RGV_O15_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGV_O15_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
