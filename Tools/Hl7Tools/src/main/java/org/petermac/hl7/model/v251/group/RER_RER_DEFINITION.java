...
/**
 * <p>Represents a RER_RER_DEFINITION group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RER_RER_PATIENT (a Group object) <b>optional  </b></li>
                         * <li>4: RER_RER_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RER_RER_DEFINITION extends AbstractGroup {
    ...
    public RER_RER_PATIENT getPATIENT() { 
       RER_RER_PATIENT retVal = getTyped("PATIENT", RER_RER_PATIENT.class);
       return retVal;
    }
    ...
    public RER_RER_ORDER getORDER() { 
       RER_RER_ORDER retVal = getTyped("ORDER", RER_RER_ORDER.class);
       return retVal;
    }
    ...
    public RER_RER_ORDER getORDER(int rep) { 
       RER_RER_ORDER retVal = getTyped("ORDER", rep, RER_RER_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RER_RER_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", RER_RER_ORDER.class);
    } 
