...
/**
 * <p>Represents a ADT_A21 message structure (see chapter 3.3.21). This structure contains the 
...
public class ADT_A21 extends AbstractMessage  {

    /**
     * Creates a new ADT_A21 message with DefaultModelClassFactory. 
     */ 
    public ADT_A21() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A21 - this is probably a bug in the source code generator.", e);
       }
    }
