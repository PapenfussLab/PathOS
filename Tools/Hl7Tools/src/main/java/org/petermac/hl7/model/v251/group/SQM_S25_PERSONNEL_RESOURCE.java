...
/**
 * <p>Represents a SQM_S25_PERSONNEL_RESOURCE group structure (a Group object).
...
public class SQM_S25_PERSONNEL_RESOURCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SQM_S25_PERSONNEL_RESOURCE - this is probably a bug in the source code generator.", e);
       }
    }
