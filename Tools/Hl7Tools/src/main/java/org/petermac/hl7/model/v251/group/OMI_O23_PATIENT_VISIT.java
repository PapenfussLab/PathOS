...
/**
 * <p>Represents a OMI_O23_PATIENT_VISIT group structure (a Group object).
...
public class OMI_O23_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new OMI_O23_PATIENT_VISIT group
     */
    public OMI_O23_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMI_O23_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
