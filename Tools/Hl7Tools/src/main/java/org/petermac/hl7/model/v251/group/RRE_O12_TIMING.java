...
/**
 * <p>Represents a RRE_O12_TIMING group structure (a Group object).
...
public class RRE_O12_TIMING extends AbstractGroup {

    /** 
     * Creates a new RRE_O12_TIMING group
     */
    public RRE_O12_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRE_O12_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
