 ...
 * <ul>
		                 ...
		                 * <li>4: MFN_M01_MF (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class MFN_M01 extends AbstractMessage  {
    ...
    public MFN_M01_MF getMF() { 
       return getTyped("MF", MFN_M01_MF.class);
    }
    ...
    public MFN_M01_MF getMF(int rep) { 
       return getTyped("MF", rep, MFN_M01_MF.class);
    }
     ...
     * 
     */ 
    public java.util.List<MFN_M01_MF> getMFAll() throws HL7Exception {
    	return getAllAsList("MF", MFN_M01_MF.class);
    } 
