...
/**
 * <p>Represents a BPS_O29_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: BPS_O29_PATIENT_VISIT (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class BPS_O29_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(BPS_O29_PATIENT_VISIT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating BPS_O29_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public BPS_O29_PATIENT_VISIT getPATIENT_VISIT() { 
       BPS_O29_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", BPS_O29_PATIENT_VISIT.class);
       return retVal;
    }
