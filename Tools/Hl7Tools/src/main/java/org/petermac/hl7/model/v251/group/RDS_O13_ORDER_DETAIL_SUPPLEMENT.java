...
/**
 * <p>Represents a RDS_O13_ORDER_DETAIL_SUPPLEMENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RDS_O13_COMPONENT (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RDS_O13_ORDER_DETAIL_SUPPLEMENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDS_O13_COMPONENT.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDS_O13_ORDER_DETAIL_SUPPLEMENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDS_O13_COMPONENT getCOMPONENT() { 
       RDS_O13_COMPONENT retVal = getTyped("COMPONENT", RDS_O13_COMPONENT.class);
       return retVal;
    }
    ...
    public RDS_O13_COMPONENT getCOMPONENT(int rep) { 
       RDS_O13_COMPONENT retVal = getTyped("COMPONENT", rep, RDS_O13_COMPONENT.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDS_O13_COMPONENT> getCOMPONENTAll() throws HL7Exception {
    	return getAllAsList("COMPONENT", RDS_O13_COMPONENT.class);
    } 
