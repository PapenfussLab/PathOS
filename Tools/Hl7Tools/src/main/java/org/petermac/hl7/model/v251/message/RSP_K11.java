...
/**
 * <p>Represents a RSP_K11 message structure (see chapter 5.3.1.2). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>7: RSP_K11_ROW_DEFINITION (a Group object) <b>optional </b> </li>
		                 * <li>8: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_K11 extends AbstractMessage  {

    /**
     * Creates a new RSP_K11 message with DefaultModelClassFactory. 
     */ 
    public RSP_K11() { 
    ...
    /** 
     * Creates a new RSP_K11 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RSP_K11_ROW_DEFINITION.class, false, false);
	                          this.add(DSC.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_K11 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RSP_K11_ROW_DEFINITION getROW_DEFINITION() { 
       return getTyped("ROW_DEFINITION", RSP_K11_ROW_DEFINITION.class);
    }
