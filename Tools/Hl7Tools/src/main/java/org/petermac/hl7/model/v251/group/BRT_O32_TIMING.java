...
/**
 * <p>Represents a BRT_O32_TIMING group structure (a Group object).
...
public class BRT_O32_TIMING extends AbstractGroup {

    /** 
     * Creates a new BRT_O32_TIMING group
     */
    public BRT_O32_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating BRT_O32_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
