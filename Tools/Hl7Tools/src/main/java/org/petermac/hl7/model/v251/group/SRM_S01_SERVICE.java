...
/**
 * <p>Represents a SRM_S01_SERVICE group structure (a Group object).
...
public class SRM_S01_SERVICE extends AbstractGroup {

    /** 
     * Creates a new SRM_S01_SERVICE group
     */
    public SRM_S01_SERVICE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRM_S01_SERVICE - this is probably a bug in the source code generator.", e);
       }
    }
