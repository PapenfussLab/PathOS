...
/**
 * <p>Represents a RER_RER_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: RXE (Pharmacy/Treatment Encoded Order) <b>  </b></li>
...
public class RER_RER_ORDER extends AbstractGroup {

    /** 
     * Creates a new RER_RER_ORDER group
     */
    public RER_RER_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RER_RER_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
