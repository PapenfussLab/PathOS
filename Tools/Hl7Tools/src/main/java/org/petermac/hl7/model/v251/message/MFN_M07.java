 ...
 * <ul>
		                 ...
		                 * <li>4: MFN_M07_MF_CLIN_STUDY_SCHED (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class MFN_M07 extends AbstractMessage  {
     ...
     * Returns
     * the first repetition of 
     * MF_CLIN_STUDY_SCHED (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFN_M07_MF_CLIN_STUDY_SCHED getMF_CLIN_STUDY_SCHED() { 
       return getTyped("MF_CLIN_STUDY_SCHED", MFN_M07_MF_CLIN_STUDY_SCHED.class);
    }
    ...
    public MFN_M07_MF_CLIN_STUDY_SCHED getMF_CLIN_STUDY_SCHED(int rep) { 
       return getTyped("MF_CLIN_STUDY_SCHED", rep, MFN_M07_MF_CLIN_STUDY_SCHED.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of MF_CLIN_STUDY_SCHED 
     * </p>
     * 
     */ 
    ...
    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MF_CLIN_STUDY_SCHED.
     * <p>
     * <p>
     * Note that unlike {@link #getMF_CLIN_STUDY_SCHED()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFN_M07_MF_CLIN_STUDY_SCHED> getMF_CLIN_STUDY_SCHEDAll() throws HL7Exception {
    	return getAllAsList("MF_CLIN_STUDY_SCHED", MFN_M07_MF_CLIN_STUDY_SCHED.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of MF_CLIN_STUDY_SCHED (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    public void insertMF_CLIN_STUDY_SCHED(MFN_M07_MF_CLIN_STUDY_SCHED structure, int rep) throws HL7Exception { 
       super.insertRepetition( "MF_CLIN_STUDY_SCHED", structure, rep);
    }
    ...
    /**
     * <p>
     * Removes a specific repetition of MF_CLIN_STUDY_SCHED (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
