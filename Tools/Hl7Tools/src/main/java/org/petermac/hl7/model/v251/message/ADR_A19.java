 ...
 * <ul>
		                 ...
		                 * <li>8: ADR_A19_QUERY_RESPONSE (a Group object) <b> repeating</b> </li>
...
public class ADR_A19 extends AbstractMessage  {
    ...
    public ADR_A19_QUERY_RESPONSE getQUERY_RESPONSE() { 
       return getTyped("QUERY_RESPONSE", ADR_A19_QUERY_RESPONSE.class);
    }
    ...
    public ADR_A19_QUERY_RESPONSE getQUERY_RESPONSE(int rep) { 
       return getTyped("QUERY_RESPONSE", rep, ADR_A19_QUERY_RESPONSE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADR_A19_QUERY_RESPONSE> getQUERY_RESPONSEAll() throws HL7Exception {
    	return getAllAsList("QUERY_RESPONSE", ADR_A19_QUERY_RESPONSE.class);
    } 
