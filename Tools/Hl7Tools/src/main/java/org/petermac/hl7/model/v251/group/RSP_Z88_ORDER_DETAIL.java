...
/**
 * <p>Represents a RSP_Z88_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: RSP_Z88_COMPONENT (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_Z88_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new RSP_Z88_ORDER_DETAIL group
     */
    public RSP_Z88_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RSP_Z88_COMPONENT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z88_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RSP_Z88_COMPONENT getCOMPONENT() { 
       RSP_Z88_COMPONENT retVal = getTyped("COMPONENT", RSP_Z88_COMPONENT.class);
       return retVal;
    }
