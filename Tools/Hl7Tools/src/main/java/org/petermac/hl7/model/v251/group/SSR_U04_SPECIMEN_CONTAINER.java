...
/**
 * <p>Represents a SSR_U04_SPECIMEN_CONTAINER group structure (a Group object).
...
public class SSR_U04_SPECIMEN_CONTAINER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SSR_U04_SPECIMEN_CONTAINER - this is probably a bug in the source code generator.", e);
       }
    }
