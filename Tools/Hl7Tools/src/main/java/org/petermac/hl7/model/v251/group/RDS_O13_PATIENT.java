...
/**
 * <p>Represents a RDS_O13_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: RDS_O13_PATIENT_VISIT (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RDS_O13_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RDS_O13_PATIENT group
     */
    public RDS_O13_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDS_O13_PATIENT_VISIT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDS_O13_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RDS_O13_PATIENT_VISIT getPATIENT_VISIT() { 
       RDS_O13_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", RDS_O13_PATIENT_VISIT.class);
       return retVal;
    }
