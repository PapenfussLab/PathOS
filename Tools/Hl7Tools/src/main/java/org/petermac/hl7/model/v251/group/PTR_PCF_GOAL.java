...
/**
 * <p>Represents a PTR_PCF_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PTR_PCF_GOAL_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PTR_PCF_GOAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PTR_PCF_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PTR_PCF_GOAL_ROLE.class, false, true, false);
                                  this.add(PTR_PCF_GOAL_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PTR_PCF_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PTR_PCF_GOAL_ROLE getGOAL_ROLE() { 
       PTR_PCF_GOAL_ROLE retVal = getTyped("GOAL_ROLE", PTR_PCF_GOAL_ROLE.class);
       return retVal;
    }
    ...
    public PTR_PCF_GOAL_ROLE getGOAL_ROLE(int rep) { 
       PTR_PCF_GOAL_ROLE retVal = getTyped("GOAL_ROLE", rep, PTR_PCF_GOAL_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PTR_PCF_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
    	return getAllAsList("GOAL_ROLE", PTR_PCF_GOAL_ROLE.class);
    } 
    ...
    public PTR_PCF_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
       PTR_PCF_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", PTR_PCF_GOAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public PTR_PCF_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
       PTR_PCF_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", rep, PTR_PCF_GOAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PTR_PCF_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("GOAL_OBSERVATION", PTR_PCF_GOAL_OBSERVATION.class);
    } 
