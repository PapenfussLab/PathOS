...
/**
 * <p>Represents a ORS_O06_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: ORS_O06_TIMING (a Group object) <b>optional repeating </b></li>
...
public class ORS_O06_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORS_O06_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORS_O06_TIMING getTIMING() { 
       ORS_O06_TIMING retVal = getTyped("TIMING", ORS_O06_TIMING.class);
       return retVal;
    }
    ...
    public ORS_O06_TIMING getTIMING(int rep) { 
       ORS_O06_TIMING retVal = getTyped("TIMING", rep, ORS_O06_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORS_O06_TIMING> getTIMINGAll() throws HL7Exception {
    	return getAllAsList("TIMING", ORS_O06_TIMING.class);
    } 
