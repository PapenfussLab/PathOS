...
/**
 * <p>Represents a OUL_R21_OBSERVATION group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OBX (Observation/Result) <b>optional  </b></li>
...
public class OUL_R21_OBSERVATION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R21_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
