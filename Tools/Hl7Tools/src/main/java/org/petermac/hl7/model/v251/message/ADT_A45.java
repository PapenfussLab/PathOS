...
public class ADT_A45 extends AbstractMessage  {
    ...
    public ADT_A45_MERGE_INFO getMERGE_INFO() { 
       return getTyped("MERGE_INFO", ADT_A45_MERGE_INFO.class);
    }
    ...
    public ADT_A45_MERGE_INFO getMERGE_INFO(int rep) { 
       return getTyped("MERGE_INFO", rep, ADT_A45_MERGE_INFO.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A45_MERGE_INFO> getMERGE_INFOAll() throws HL7Exception {
    	return getAllAsList("MERGE_INFO", ADT_A45_MERGE_INFO.class);
    } 
