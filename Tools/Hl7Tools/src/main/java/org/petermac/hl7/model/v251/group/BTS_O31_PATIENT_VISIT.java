...
/**
 * <p>Represents a BTS_O31_PATIENT_VISIT group structure (a Group object).
...
public class BTS_O31_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new BTS_O31_PATIENT_VISIT group
     */
    public BTS_O31_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating BTS_O31_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
