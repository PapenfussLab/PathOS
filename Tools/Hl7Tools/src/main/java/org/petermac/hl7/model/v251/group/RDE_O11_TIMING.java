...
/**
 * <p>Represents a RDE_O11_TIMING group structure (a Group object).
...
public class RDE_O11_TIMING extends AbstractGroup {

    /** 
     * Creates a new RDE_O11_TIMING group
     */
    public RDE_O11_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDE_O11_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
