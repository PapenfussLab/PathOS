...
/**
 * <p>Represents a RCI_I05_PROVIDER group structure (a Group object).
...
public class RCI_I05_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RCI_I05_PROVIDER group
     */
    public RCI_I05_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RCI_I05_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
