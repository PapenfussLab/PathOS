...
public class PRB extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Problem ID");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Problem Classification");
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "Problem Management Discipline");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Problem Persistence");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Problem Confirmation Status");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Problem Life Cycle Status");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Problem Ranking");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Certainty of Problem");
                                  this.add(NM.class, false, 1, 5, new Object[]{ getMessage() }, "Probability of Problem (0-1)");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Individual Awareness of Problem");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Problem Prognosis");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Individual Awareness of Prognosis");
                                  this.add(ST.class, false, 1, 200, new Object[]{ getMessage() }, "Family/Significant Other Awareness of Problem/Prognosis");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Security/Sensitivity");
