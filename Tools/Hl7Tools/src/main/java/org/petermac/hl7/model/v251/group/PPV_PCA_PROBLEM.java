...
/**
 * <p>Represents a PPV_PCA_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPV_PCA_PROBLEM_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPV_PCA_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PPV_PCA_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPV_PCA_PROBLEM_ROLE.class, false, true, false);
                                  this.add(PPV_PCA_PROBLEM_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPV_PCA_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPV_PCA_PROBLEM_ROLE getPROBLEM_ROLE() { 
       PPV_PCA_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", PPV_PCA_PROBLEM_ROLE.class);
       return retVal;
    }
    ...
    public PPV_PCA_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
       PPV_PCA_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", rep, PPV_PCA_PROBLEM_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_ROLE", PPV_PCA_PROBLEM_ROLE.class);
    } 
    ...
    public PPV_PCA_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       PPV_PCA_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", PPV_PCA_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPV_PCA_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       PPV_PCA_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, PPV_PCA_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_OBSERVATION", PPV_PCA_PROBLEM_OBSERVATION.class);
    } 
