...
/**
 * <p>Represents a OMP_O09_PATIENT_VISIT group structure (a Group object).
...
public class OMP_O09_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new OMP_O09_PATIENT_VISIT group
     */
    public OMP_O09_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMP_O09_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
