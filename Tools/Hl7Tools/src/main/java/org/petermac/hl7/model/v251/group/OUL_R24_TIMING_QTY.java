...
/**
 * <p>Represents a OUL_R24_TIMING_QTY group structure (a Group object).
...
public class OUL_R24_TIMING_QTY extends AbstractGroup {

    /** 
     * Creates a new OUL_R24_TIMING_QTY group
     */
    public OUL_R24_TIMING_QTY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R24_TIMING_QTY - this is probably a bug in the source code generator.", e);
       }
    }
