 ...
 * 
 * The Original Code is "OSP.java".  Description:
 * "Composite class OSP"
 * 
...
/**
 * <p>Represents an HL7 OSP (Occurrence Span Code and Date) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>Occurrence Span Code (CNE)
...
public class OSP extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public CNE getOsp1_OccurrenceSpanCode() {
       return getTyped(0, CNE.class);
    }
