...
/**
 * <p>Represents a PEX_P07_RX_ADMINISTRATION group structure (a Group object).
...
public class PEX_P07_RX_ADMINISTRATION extends AbstractGroup {

    /** 
     * Creates a new PEX_P07_RX_ADMINISTRATION group
     */
    public PEX_P07_RX_ADMINISTRATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P07_RX_ADMINISTRATION - this is probably a bug in the source code generator.", e);
       }
    }
