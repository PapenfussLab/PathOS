...
/**
 * <p>Represents a MFR_M04_MF_QUERY group structure (a Group object).
...
public class MFR_M04_MF_QUERY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFR_M04_MF_QUERY - this is probably a bug in the source code generator.", e);
       }
    }
