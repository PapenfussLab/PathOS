...
/**
 * <p>Represents a ORS_O06 message structure (see chapter 4.10.2). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORS_O06_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORS_O06 extends AbstractMessage  {

    /**
     * Creates a new ORS_O06 message with DefaultModelClassFactory. 
     */ 
    public ORS_O06() { 
    ...
    /** 
     * Creates a new ORS_O06 message with custom ModelClassFactory.
     */
    public ORS_O06(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORS_O06_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORS_O06 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORS_O06_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORS_O06_RESPONSE.class);
    }
