 ...
 * <ul>
		                 ...
		                 * <li>3: URD (Results/update Definition) <b> </b> </li>
		                 * <li>4: URS (Unsolicited Selection) <b>optional </b> </li>
		                 * <li>5: DSP (Display Data) <b> repeating</b> </li>
...
public class UDM_Q05 extends AbstractMessage  {
     ...
     * <p>
     * Returns
     * URD (Results/update Definition) - creates it if necessary
     * </p>
     * 
     *
     */
    public URD getURD() { 
       return getTyped("URD", URD.class);
    }
     ...
     * <p>
     * Returns
     * URS (Unsolicited Selection) - creates it if necessary
     * </p>
     * 
     *
     */
    public URS getURS() { 
       return getTyped("URS", URS.class);
    }
