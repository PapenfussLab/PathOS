...
/**
 * <p>Represents a RAS_O17_ORDER_DETAIL group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXO (Pharmacy/Treatment Order) <b>  </b></li>
                         * <li>2: RAS_O17_ORDER_DETAIL_SUPPLEMENT (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RAS_O17_ORDER_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RAS_O17_ORDER_DETAIL_SUPPLEMENT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RAS_O17_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RAS_O17_ORDER_DETAIL_SUPPLEMENT getORDER_DETAIL_SUPPLEMENT() { 
       RAS_O17_ORDER_DETAIL_SUPPLEMENT retVal = getTyped("ORDER_DETAIL_SUPPLEMENT", RAS_O17_ORDER_DETAIL_SUPPLEMENT.class);
       return retVal;
    }
