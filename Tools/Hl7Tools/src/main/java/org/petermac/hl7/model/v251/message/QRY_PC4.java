...
/**
 * <p>Represents a QRY_PC4 message structure (see chapter 12.3.5). This structure contains the 
...
public class QRY_PC4 extends AbstractMessage  {
    ...
    /**
     * Creates a new QRY_PC4 message with DefaultModelClassFactory. 
     */ 
    public QRY_PC4() { 
    ...
    /** 
     * Creates a new QRY_PC4 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating QRY_PC4 - this is probably a bug in the source code generator.", e);
       }
    }
