...
/**
 * <p>Represents a RSP_Z82_TREATMENT group structure (a Group object).
...
public class RSP_Z82_TREATMENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z82_TREATMENT - this is probably a bug in the source code generator.", e);
       }
    }
