...
/**
 * <p>Represents a RSP_Z90_VISIT group structure (a Group object).
...
public class RSP_Z90_VISIT extends AbstractGroup {

    /** 
     * Creates a new RSP_Z90_VISIT group
     */
    public RSP_Z90_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z90_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
