 ...
 * <ul>
		                 ...
		                 * <li>7: RSP_Z86_QUERY_RESPONSE (a Group object) <b> repeating</b> </li>
...
public class RSP_Z86 extends AbstractMessage  {
    ...
    /**
     * Creates a new RSP_Z86 message with DefaultModelClassFactory. 
     */ 
    public RSP_Z86() { 
    ...
    /** 
     * Creates a new RSP_Z86 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z86 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RSP_Z86_QUERY_RESPONSE getQUERY_RESPONSE() { 
       return getTyped("QUERY_RESPONSE", RSP_Z86_QUERY_RESPONSE.class);
    }
    ...
    public RSP_Z86_QUERY_RESPONSE getQUERY_RESPONSE(int rep) { 
       return getTyped("QUERY_RESPONSE", rep, RSP_Z86_QUERY_RESPONSE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RSP_Z86_QUERY_RESPONSE> getQUERY_RESPONSEAll() throws HL7Exception {
    	return getAllAsList("QUERY_RESPONSE", RSP_Z86_QUERY_RESPONSE.class);
    } 
