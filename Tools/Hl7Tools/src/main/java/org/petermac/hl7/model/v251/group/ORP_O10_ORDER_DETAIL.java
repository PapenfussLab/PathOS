...
/**
 * <p>Represents a ORP_O10_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: ORP_O10_COMPONENT (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORP_O10_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new ORP_O10_ORDER_DETAIL group
     */
    public ORP_O10_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ORP_O10_COMPONENT.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORP_O10_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORP_O10_COMPONENT getCOMPONENT() { 
       ORP_O10_COMPONENT retVal = getTyped("COMPONENT", ORP_O10_COMPONENT.class);
       return retVal;
    }
    ...
    public ORP_O10_COMPONENT getCOMPONENT(int rep) { 
       ORP_O10_COMPONENT retVal = getTyped("COMPONENT", rep, ORP_O10_COMPONENT.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORP_O10_COMPONENT> getCOMPONENTAll() throws HL7Exception {
    	return getAllAsList("COMPONENT", ORP_O10_COMPONENT.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertCOMPONENT(ORP_O10_COMPONENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ORP_O10_COMPONENT insertCOMPONENT(int rep) throws HL7Exception { 
       return (ORP_O10_COMPONENT)super.insertRepetition("COMPONENT", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ORP_O10_COMPONENT removeCOMPONENT(int rep) throws HL7Exception { 
       return (ORP_O10_COMPONENT)super.removeRepetition("COMPONENT", rep);
    }
