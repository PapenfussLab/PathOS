...
/**
 * <p>Represents a PRR_PC5 message structure (see chapter 12.3.6). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>7: PRR_PC5_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PRR_PC5 extends AbstractMessage  {
    ...
    public PRR_PC5_PATIENT getPATIENT() { 
       return getTyped("PATIENT", PRR_PC5_PATIENT.class);
    }
    ...
    public PRR_PC5_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, PRR_PC5_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<PRR_PC5_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", PRR_PC5_PATIENT.class);
    } 
