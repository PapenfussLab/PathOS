...
/**
 * <p>Represents a RDE_O11_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: RDE_O11_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>5: RDE_O11_INSURANCE (a Group object) <b>optional repeating </b></li>
...
public class RDE_O11_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDE_O11_PATIENT_VISIT.class, false, false, false);
                                  this.add(RDE_O11_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDE_O11_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDE_O11_PATIENT_VISIT getPATIENT_VISIT() { 
       RDE_O11_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", RDE_O11_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public RDE_O11_INSURANCE getINSURANCE() { 
       RDE_O11_INSURANCE retVal = getTyped("INSURANCE", RDE_O11_INSURANCE.class);
       return retVal;
    }
    ...
    public RDE_O11_INSURANCE getINSURANCE(int rep) { 
       RDE_O11_INSURANCE retVal = getTyped("INSURANCE", rep, RDE_O11_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDE_O11_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", RDE_O11_INSURANCE.class);
    } 
