...
/**
 * <p>Represents a PRR_PC5_GOAL_ROLE group structure (a Group object).
...
public class PRR_PC5_GOAL_ROLE extends AbstractGroup {

    /** 
     * Creates a new PRR_PC5_GOAL_ROLE group
     */
    public PRR_PC5_GOAL_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PRR_PC5_GOAL_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
