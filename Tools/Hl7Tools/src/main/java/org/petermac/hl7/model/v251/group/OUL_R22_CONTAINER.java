...
/**
 * <p>Represents a OUL_R22_CONTAINER group structure (a Group object).
...
public class OUL_R22_CONTAINER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R22_CONTAINER - this is probably a bug in the source code generator.", e);
       }
    }
