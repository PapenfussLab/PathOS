...
/**
 * <p>Represents a ORL_O36 message structure (see chapter 4.4.11). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORL_O36_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORL_O36 extends AbstractMessage  {

    /**
     * Creates a new ORL_O36 message with DefaultModelClassFactory. 
     */ 
    public ORL_O36() { 
    ...
    /** 
     * Creates a new ORL_O36 message with custom ModelClassFactory.
     */
    public ORL_O36(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORL_O36_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORL_O36 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORL_O36_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORL_O36_RESPONSE.class);
    }
