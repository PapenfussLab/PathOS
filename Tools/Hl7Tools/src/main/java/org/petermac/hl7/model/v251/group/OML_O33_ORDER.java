...
/**
 * <p>Represents a OML_O33_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: OML_O33_TIMING (a Group object) <b>optional repeating </b></li>
                         * <li>3: OML_O33_OBSERVATION_REQUEST (a Group object) <b>optional  </b></li>
                         * <li>4: FT1 (Financial Transaction) <b>optional repeating </b></li>
                         * <li>5: CTI (Clinical Trial Identification) <b>optional repeating </b></li>
                         * <li>6: BLG (Billing) <b>optional  </b></li>
 * </ul>
 */
...
public class OML_O33_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OML_O33_TIMING.class, false, true, false);
                                  this.add(OML_O33_OBSERVATION_REQUEST.class, false, false, false);
                                  this.add(FT1.class, false, true, false);
                                  this.add(CTI.class, false, true, false);
                                  this.add(BLG.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OML_O33_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OML_O33_TIMING getTIMING() { 
       OML_O33_TIMING retVal = getTyped("TIMING", OML_O33_TIMING.class);
       return retVal;
    }
    ...
    public OML_O33_TIMING getTIMING(int rep) { 
       OML_O33_TIMING retVal = getTyped("TIMING", rep, OML_O33_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OML_O33_TIMING> getTIMINGAll() throws HL7Exception {
    ...
    public OML_O33_OBSERVATION_REQUEST getOBSERVATION_REQUEST() { 
       OML_O33_OBSERVATION_REQUEST retVal = getTyped("OBSERVATION_REQUEST", OML_O33_OBSERVATION_REQUEST.class);
       return retVal;
    }
