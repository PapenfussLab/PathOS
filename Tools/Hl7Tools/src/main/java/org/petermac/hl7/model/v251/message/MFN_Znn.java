 ...
 * <ul>
		                 ...
		                 * <li>4: MFN_Znn_MF_SITE_DEFINED (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class MFN_Znn extends AbstractMessage  {

    /**
     * Creates a new MFN_Znn message with DefaultModelClassFactory. 
     */ 
    public MFN_Znn() { 
    ...
    /** 
     * Creates a new MFN_Znn message with custom ModelClassFactory.
     */
     ...
     * Returns
     * the first repetition of 
     * MF_SITE_DEFINED (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFN_Znn_MF_SITE_DEFINED getMF_SITE_DEFINED() { 
       return getTyped("MF_SITE_DEFINED", MFN_Znn_MF_SITE_DEFINED.class);
    }
    ...
    public MFN_Znn_MF_SITE_DEFINED getMF_SITE_DEFINED(int rep) { 
       return getTyped("MF_SITE_DEFINED", rep, MFN_Znn_MF_SITE_DEFINED.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of MF_SITE_DEFINED 
     * </p>
     * 
     */ 
    public int getMF_SITE_DEFINEDReps() { 
    	return getReps("MF_SITE_DEFINED");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MF_SITE_DEFINED.
     * <p>
     * <p>
     * Note that unlike {@link #getMF_SITE_DEFINED()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFN_Znn_MF_SITE_DEFINED> getMF_SITE_DEFINEDAll() throws HL7Exception {
    	return getAllAsList("MF_SITE_DEFINED", MFN_Znn_MF_SITE_DEFINED.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of MF_SITE_DEFINED (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    /**
     * <p>
     * Removes a specific repetition of MF_SITE_DEFINED (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
