 ...
 * <ul>
		                 ...
		                 * <li>4: BPS_O29_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>5: BPS_O29_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class BPS_O29 extends AbstractMessage  {

    /**
     * Creates a new BPS_O29 message with DefaultModelClassFactory. 
     */ 
    public BPS_O29() { 
    ...
    /** 
     * Creates a new BPS_O29 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating BPS_O29 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public BPS_O29_PATIENT getPATIENT() { 
       return getTyped("PATIENT", BPS_O29_PATIENT.class);
    }
    ...
    public BPS_O29_ORDER getORDER() { 
       return getTyped("ORDER", BPS_O29_ORDER.class);
    }
    ...
    public BPS_O29_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, BPS_O29_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<BPS_O29_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", BPS_O29_ORDER.class);
    } 
