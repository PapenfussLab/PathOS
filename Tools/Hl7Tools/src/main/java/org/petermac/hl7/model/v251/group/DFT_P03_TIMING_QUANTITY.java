...
/**
 * <p>Represents a DFT_P03_TIMING_QUANTITY group structure (a Group object).
...
public class DFT_P03_TIMING_QUANTITY extends AbstractGroup {

    /** 
     * Creates a new DFT_P03_TIMING_QUANTITY group
     */
    public DFT_P03_TIMING_QUANTITY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating DFT_P03_TIMING_QUANTITY - this is probably a bug in the source code generator.", e);
       }
    }
