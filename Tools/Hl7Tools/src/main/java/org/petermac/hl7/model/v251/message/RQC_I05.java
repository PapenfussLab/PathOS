 ...
 * <ul>
		                 ...
		                 * <li>5: RQC_I05_PROVIDER (a Group object) <b> repeating</b> </li>
...
public class RQC_I05 extends AbstractMessage  {
    ...
    public RQC_I05_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RQC_I05_PROVIDER.class);
    }
    ...
    public RQC_I05_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RQC_I05_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQC_I05_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", RQC_I05_PROVIDER.class);
    } 
