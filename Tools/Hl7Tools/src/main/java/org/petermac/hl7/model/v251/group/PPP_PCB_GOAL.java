...
/**
 * <p>Represents a PPP_PCB_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPP_PCB_GOAL_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPP_PCB_GOAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PPP_PCB_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCB_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCB_GOAL_ROLE getGOAL_ROLE() { 
       PPP_PCB_GOAL_ROLE retVal = getTyped("GOAL_ROLE", PPP_PCB_GOAL_ROLE.class);
       return retVal;
    }
    ...
    public PPP_PCB_GOAL_ROLE getGOAL_ROLE(int rep) { 
       PPP_PCB_GOAL_ROLE retVal = getTyped("GOAL_ROLE", rep, PPP_PCB_GOAL_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
    	return getAllAsList("GOAL_ROLE", PPP_PCB_GOAL_ROLE.class);
    } 
    ...
    public PPP_PCB_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
       PPP_PCB_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", PPP_PCB_GOAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPP_PCB_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
       PPP_PCB_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", rep, PPP_PCB_GOAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("GOAL_OBSERVATION", PPP_PCB_GOAL_OBSERVATION.class);
    } 
