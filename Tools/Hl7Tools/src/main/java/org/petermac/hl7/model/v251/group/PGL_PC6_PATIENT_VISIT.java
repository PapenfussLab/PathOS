...
/**
 * <p>Represents a PGL_PC6_PATIENT_VISIT group structure (a Group object).
...
public class PGL_PC6_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new PGL_PC6_PATIENT_VISIT group
     */
    public PGL_PC6_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PGL_PC6_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
