...
/**
 * <p>Represents a PPV_PCA message structure (see chapter 12.3.8). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>7: PPV_PCA_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PPV_PCA extends AbstractMessage  {
    ...
    public PPV_PCA_PATIENT getPATIENT() { 
       return getTyped("PATIENT", PPV_PCA_PATIENT.class);
    }
    ...
    public PPV_PCA_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, PPV_PCA_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<PPV_PCA_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", PPV_PCA_PATIENT.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATIENT(PPV_PCA_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPV_PCA_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (PPV_PCA_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPV_PCA_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (PPV_PCA_PATIENT)super.removeRepetition("PATIENT", rep);
    }
