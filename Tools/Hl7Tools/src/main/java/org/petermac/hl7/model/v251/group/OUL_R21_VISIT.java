...
/**
 * <p>Represents a OUL_R21_VISIT group structure (a Group object).
...
public class OUL_R21_VISIT extends AbstractGroup {

    /** 
     * Creates a new OUL_R21_VISIT group
     */
    public OUL_R21_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R21_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
