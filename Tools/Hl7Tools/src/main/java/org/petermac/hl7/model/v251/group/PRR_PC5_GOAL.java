...
/**
 * <p>Represents a PRR_PC5_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PRR_PC5_GOAL_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PRR_PC5_GOAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PRR_PC5_GOAL extends AbstractGroup {

    /** 
     * Creates a new PRR_PC5_GOAL group
     */
    public PRR_PC5_GOAL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PRR_PC5_GOAL_ROLE.class, false, true, false);
                                  this.add(PRR_PC5_GOAL_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PRR_PC5_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PRR_PC5_GOAL_ROLE getGOAL_ROLE() { 
       PRR_PC5_GOAL_ROLE retVal = getTyped("GOAL_ROLE", PRR_PC5_GOAL_ROLE.class);
       return retVal;
    }
    ...
    public PRR_PC5_GOAL_ROLE getGOAL_ROLE(int rep) { 
       PRR_PC5_GOAL_ROLE retVal = getTyped("GOAL_ROLE", rep, PRR_PC5_GOAL_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PRR_PC5_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
    	return getAllAsList("GOAL_ROLE", PRR_PC5_GOAL_ROLE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertGOAL_ROLE(PRR_PC5_GOAL_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PRR_PC5_GOAL_ROLE insertGOAL_ROLE(int rep) throws HL7Exception { 
       return (PRR_PC5_GOAL_ROLE)super.insertRepetition("GOAL_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PRR_PC5_GOAL_ROLE removeGOAL_ROLE(int rep) throws HL7Exception { 
       return (PRR_PC5_GOAL_ROLE)super.removeRepetition("GOAL_ROLE", rep);
    }
    ...
    public PRR_PC5_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
       PRR_PC5_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", PRR_PC5_GOAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public PRR_PC5_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
       PRR_PC5_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", rep, PRR_PC5_GOAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PRR_PC5_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("GOAL_OBSERVATION", PRR_PC5_GOAL_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertGOAL_OBSERVATION(PRR_PC5_GOAL_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PRR_PC5_GOAL_OBSERVATION insertGOAL_OBSERVATION(int rep) throws HL7Exception { 
       return (PRR_PC5_GOAL_OBSERVATION)super.insertRepetition("GOAL_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PRR_PC5_GOAL_OBSERVATION removeGOAL_OBSERVATION(int rep) throws HL7Exception { 
       return (PRR_PC5_GOAL_OBSERVATION)super.removeRepetition("GOAL_OBSERVATION", rep);
    }
