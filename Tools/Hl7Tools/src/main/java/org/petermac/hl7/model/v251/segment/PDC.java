...
/**
 *<p>Represents an HL7 PDC message segment (Product Detail Country). 
...
public class PDC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(XON.class, true, 0, 250, new Object[]{ getMessage() }, "Manufacturer/Distributor");
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Country");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Generic Name");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Product Code");
