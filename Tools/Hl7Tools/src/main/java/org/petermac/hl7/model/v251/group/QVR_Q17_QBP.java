...
/**
 * <p>Represents a QVR_Q17_QBP group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: Hxx (any HL7 segment) <b>  </b></li>
 * </ul>
 */
...
public class QVR_Q17_QBP extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating QVR_Q17_QBP - this is probably a bug in the source code generator.", e);
       }
    }
