...
/**
 * <p>Represents a MFN_M12_MF_OBS_ATTRIBUTES group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: OM7 (Additional Basic Attributes) <b>optional  </b></li>
 * </ul>
 */
...
public class MFN_M12_MF_OBS_ATTRIBUTES extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OM7.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating MFN_M12_MF_OBS_ATTRIBUTES - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * OM7 (Additional Basic Attributes) - creates it if necessary
     */
    public OM7 getOM7() { 
       OM7 retVal = getTyped("OM7", OM7.class);
       return retVal;
    }
