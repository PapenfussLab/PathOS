...
/**
 * <p>Represents a OMD_O03_PATIENT_VISIT group structure (a Group object).
...
public class OMD_O03_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new OMD_O03_PATIENT_VISIT group
     */
    public OMD_O03_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMD_O03_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
