...
/**
 * <p>Represents a PGL_PC6_PATHWAY group structure (a Group object).
...
public class PGL_PC6_PATHWAY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PGL_PC6_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
