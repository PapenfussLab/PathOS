...
/**
 * <p>Represents a REF_I12_PROCEDURE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PR1 (Procedures) <b>  </b></li>
                         * <li>2: REF_I12_AUTHORIZATION_CONTACT (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class REF_I12_PROCEDURE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(REF_I12_AUTHORIZATION_CONTACT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating REF_I12_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public REF_I12_AUTHORIZATION_CONTACT getAUTHORIZATION_CONTACT() { 
       REF_I12_AUTHORIZATION_CONTACT retVal = getTyped("AUTHORIZATION_CONTACT", REF_I12_AUTHORIZATION_CONTACT.class);
       return retVal;
    }
