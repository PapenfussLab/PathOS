...
/**
 * <p>Represents a ORL_O34_PATIENT group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PID (Patient Identification) <b>  </b></li>
                         * <li>2: ORL_O34_SPECIMEN (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class ORL_O34_PATIENT extends AbstractGroup {
    ...
    public ORL_O34_SPECIMEN getSPECIMEN() { 
       ORL_O34_SPECIMEN retVal = getTyped("SPECIMEN", ORL_O34_SPECIMEN.class);
       return retVal;
    }
    ...
    public ORL_O34_SPECIMEN getSPECIMEN(int rep) { 
       ORL_O34_SPECIMEN retVal = getTyped("SPECIMEN", rep, ORL_O34_SPECIMEN.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORL_O34_SPECIMEN> getSPECIMENAll() throws HL7Exception {
