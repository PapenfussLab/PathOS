...
/**
 * <p>Represents a RER_RER message structure (see chapter 4.13.18). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>5: RER_RER_DEFINITION (a Group object) <b> repeating</b> </li>
...
public class RER_RER extends AbstractMessage  {
    ...
    public RER_RER_DEFINITION getDEFINITION() { 
       return getTyped("DEFINITION", RER_RER_DEFINITION.class);
    }
    ...
    public RER_RER_DEFINITION getDEFINITION(int rep) { 
       return getTyped("DEFINITION", rep, RER_RER_DEFINITION.class);
    }
     ...
     * 
     */ 
    public java.util.List<RER_RER_DEFINITION> getDEFINITIONAll() throws HL7Exception {
