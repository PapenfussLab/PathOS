...
/**
 * <p>Represents a RQA_I08_GUARANTOR_INSURANCE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: GT1 (Guarantor) <b>optional repeating </b></li>
                         * <li>2: RQA_I08_INSURANCE (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RQA_I08_GUARANTOR_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new RQA_I08_GUARANTOR_INSURANCE group
     */
    public RQA_I08_GUARANTOR_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RQA_I08_INSURANCE.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RQA_I08_GUARANTOR_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RQA_I08_INSURANCE getINSURANCE() { 
       RQA_I08_INSURANCE retVal = getTyped("INSURANCE", RQA_I08_INSURANCE.class);
       return retVal;
    }
    ...
    public RQA_I08_INSURANCE getINSURANCE(int rep) { 
       RQA_I08_INSURANCE retVal = getTyped("INSURANCE", rep, RQA_I08_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RQA_I08_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", RQA_I08_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(RQA_I08_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RQA_I08_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (RQA_I08_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RQA_I08_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (RQA_I08_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
