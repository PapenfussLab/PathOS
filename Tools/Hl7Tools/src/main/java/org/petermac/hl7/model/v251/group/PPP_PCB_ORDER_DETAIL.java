...
/**
 * <p>Represents a PPP_PCB_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PPP_PCB_ORDER_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PPP_PCB_ORDER_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPP_PCB_ORDER_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPP_PCB_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCB_ORDER_OBSERVATION getORDER_OBSERVATION() { 
       PPP_PCB_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", PPP_PCB_ORDER_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPP_PCB_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) { 
       PPP_PCB_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", rep, PPP_PCB_ORDER_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("ORDER_OBSERVATION", PPP_PCB_ORDER_OBSERVATION.class);
    } 
