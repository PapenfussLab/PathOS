...
/**
 * <p>Represents a OMB_O27_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: OMB_O27_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>5: OMB_O27_INSURANCE (a Group object) <b>optional repeating </b></li>
                         * <li>6: GT1 (Guarantor) <b>optional  </b></li>
                         * <li>7: AL1 (Patient Allergy Information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMB_O27_PATIENT extends AbstractGroup {

    /** 
     * Creates a new OMB_O27_PATIENT group
     */
    public OMB_O27_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMB_O27_PATIENT_VISIT.class, false, false, false);
                                  this.add(OMB_O27_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMB_O27_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public OMB_O27_PATIENT_VISIT getPATIENT_VISIT() { 
       OMB_O27_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", OMB_O27_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public OMB_O27_INSURANCE getINSURANCE() { 
       OMB_O27_INSURANCE retVal = getTyped("INSURANCE", OMB_O27_INSURANCE.class);
       return retVal;
    }
    ...
    public OMB_O27_INSURANCE getINSURANCE(int rep) { 
       OMB_O27_INSURANCE retVal = getTyped("INSURANCE", rep, OMB_O27_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMB_O27_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", OMB_O27_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(OMB_O27_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMB_O27_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (OMB_O27_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMB_O27_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (OMB_O27_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
