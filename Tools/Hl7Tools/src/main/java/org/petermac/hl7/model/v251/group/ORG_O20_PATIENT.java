...
/**
 * <p>Represents a ORG_O20_PATIENT group structure (a Group object).
...
public class ORG_O20_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ORG_O20_PATIENT group
     */
    public ORG_O20_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORG_O20_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
