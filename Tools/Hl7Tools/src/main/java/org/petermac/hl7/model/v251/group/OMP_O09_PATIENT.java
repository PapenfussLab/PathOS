...
/**
 * <p>Represents a OMP_O09_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: OMP_O09_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>5: OMP_O09_INSURANCE (a Group object) <b>optional repeating </b></li>
                         * <li>6: GT1 (Guarantor) <b>optional  </b></li>
                         * <li>7: AL1 (Patient Allergy Information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMP_O09_PATIENT extends AbstractGroup {

    /** 
     * Creates a new OMP_O09_PATIENT group
     */
    public OMP_O09_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMP_O09_PATIENT_VISIT.class, false, false, false);
                                  this.add(OMP_O09_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMP_O09_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public OMP_O09_PATIENT_VISIT getPATIENT_VISIT() { 
       OMP_O09_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", OMP_O09_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public OMP_O09_INSURANCE getINSURANCE() { 
       OMP_O09_INSURANCE retVal = getTyped("INSURANCE", OMP_O09_INSURANCE.class);
       return retVal;
    }
    ...
    public OMP_O09_INSURANCE getINSURANCE(int rep) { 
       OMP_O09_INSURANCE retVal = getTyped("INSURANCE", rep, OMP_O09_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMP_O09_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", OMP_O09_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMP_O09_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (OMP_O09_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMP_O09_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (OMP_O09_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
