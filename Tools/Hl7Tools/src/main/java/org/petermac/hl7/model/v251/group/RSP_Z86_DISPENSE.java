...
/**
 * <p>Represents a RSP_Z86_DISPENSE group structure (a Group object).
...
public class RSP_Z86_DISPENSE extends AbstractGroup {

    /** 
     * Creates a new RSP_Z86_DISPENSE group
     */
    public RSP_Z86_DISPENSE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z86_DISPENSE - this is probably a bug in the source code generator.", e);
       }
    }
