 ...
 * <ul>
		                 ...
		                 * <li>8: RSP_K31_RESPONSE (a Group object) <b> repeating</b> </li>
...
public class RSP_K31 extends AbstractMessage  {
    ...
    /**
     * Creates a new RSP_K31 message with DefaultModelClassFactory. 
     */ 
    public RSP_K31() { 
    ...
    /** 
     * Creates a new RSP_K31 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_K31 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RSP_K31_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", RSP_K31_RESPONSE.class);
    }
    ...
    public RSP_K31_RESPONSE getRESPONSE(int rep) { 
       return getTyped("RESPONSE", rep, RSP_K31_RESPONSE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RSP_K31_RESPONSE> getRESPONSEAll() throws HL7Exception {
    	return getAllAsList("RESPONSE", RSP_K31_RESPONSE.class);
    } 
