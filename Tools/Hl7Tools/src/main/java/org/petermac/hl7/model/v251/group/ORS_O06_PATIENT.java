...
/**
 * <p>Represents a ORS_O06_PATIENT group structure (a Group object).
...
public class ORS_O06_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ORS_O06_PATIENT group
     */
    public ORS_O06_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORS_O06_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
