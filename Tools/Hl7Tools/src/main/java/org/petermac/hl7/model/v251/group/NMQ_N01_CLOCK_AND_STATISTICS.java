...
/**
 * <p>Represents a NMQ_N01_CLOCK_AND_STATISTICS group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: NCK (System Clock) <b>optional  </b></li>
                         * <li>2: NST (Application control level statistics) <b>optional  </b></li>
                         * <li>3: NSC (Application Status Change) <b>optional  </b></li>
 * </ul>
 */
...
public class NMQ_N01_CLOCK_AND_STATISTICS extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating NMQ_N01_CLOCK_AND_STATISTICS - this is probably a bug in the source code generator.", e);
       }
    }
