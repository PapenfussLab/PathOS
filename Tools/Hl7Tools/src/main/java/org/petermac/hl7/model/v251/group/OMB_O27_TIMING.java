...
/**
 * <p>Represents a OMB_O27_TIMING group structure (a Group object).
...
public class OMB_O27_TIMING extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMB_O27_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
