 ...
 * <ul>
                         ...
                         * <li>4: OUL_R22_TIMING_QTY (a Group object) <b>optional repeating </b></li>
                         * <li>5: OUL_R22_RESULT (a Group object) <b>optional repeating </b></li>
...
public class OUL_R22_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OUL_R22_TIMING_QTY.class, false, true, false);
                                  this.add(OUL_R22_RESULT.class, false, true, false);
                                  this.add(CTI.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OUL_R22_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public java.util.List<OUL_R22_TIMING_QTY> getTIMING_QTYAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public java.util.List<OUL_R22_RESULT> getRESULTAll() throws HL7Exception {
