...
/**
 * <p>Represents a BAR_P12_PROCEDURE group structure (a Group object).
...
public class BAR_P12_PROCEDURE extends AbstractGroup {

    /** 
     * Creates a new BAR_P12_PROCEDURE group
     */
    public BAR_P12_PROCEDURE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating BAR_P12_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
