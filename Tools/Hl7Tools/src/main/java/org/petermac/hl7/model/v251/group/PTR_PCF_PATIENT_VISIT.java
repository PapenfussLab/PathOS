...
/**
 * <p>Represents a PTR_PCF_PATIENT_VISIT group structure (a Group object).
...
public class PTR_PCF_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new PTR_PCF_PATIENT_VISIT group
     */
    public PTR_PCF_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PTR_PCF_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
