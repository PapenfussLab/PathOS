 ...
 * <ul>
		                 ...
		                 * <li>4: MFN_M10_MF_TEST_BATTERIES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class MFN_M10 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFN_M10 message with DefaultModelClassFactory. 
     */ 
    public MFN_M10() { 
    ...
    /** 
     * Creates a new MFN_M10 message with custom ModelClassFactory.
     */
     ...
     * Returns
     * the first repetition of 
     * MF_TEST_BATTERIES (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFN_M10_MF_TEST_BATTERIES getMF_TEST_BATTERIES() { 
       return getTyped("MF_TEST_BATTERIES", MFN_M10_MF_TEST_BATTERIES.class);
    }
    ...
    public MFN_M10_MF_TEST_BATTERIES getMF_TEST_BATTERIES(int rep) { 
       return getTyped("MF_TEST_BATTERIES", rep, MFN_M10_MF_TEST_BATTERIES.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of MF_TEST_BATTERIES 
     * </p>
     * 
     */ 
    ...
    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MF_TEST_BATTERIES.
     * <p>
     * <p>
     * Note that unlike {@link #getMF_TEST_BATTERIES()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFN_M10_MF_TEST_BATTERIES> getMF_TEST_BATTERIESAll() throws HL7Exception {
    	return getAllAsList("MF_TEST_BATTERIES", MFN_M10_MF_TEST_BATTERIES.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of MF_TEST_BATTERIES (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    public void insertMF_TEST_BATTERIES(MFN_M10_MF_TEST_BATTERIES structure, int rep) throws HL7Exception { 
       super.insertRepetition( "MF_TEST_BATTERIES", structure, rep);
    }
    ...
    /**
     * <p>
     * Removes a specific repetition of MF_TEST_BATTERIES (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
