...
/**
 * <p>Represents a PRR_PC5_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PRR_PC5_PROBLEM_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PRR_PC5_PROBLEM_PATHWAY (a Group object) <b>optional repeating </b></li>
                         * <li>6: PRR_PC5_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>7: PRR_PC5_GOAL (a Group object) <b>optional repeating </b></li>
                         * <li>8: PRR_PC5_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PRR_PC5_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PRR_PC5_PROBLEM_ROLE.class, false, true, false);
                                  this.add(PRR_PC5_PROBLEM_PATHWAY.class, false, true, false);
                                  this.add(PRR_PC5_PROBLEM_OBSERVATION.class, false, true, false);
                                  this.add(PRR_PC5_GOAL.class, false, true, false);
                                  this.add(PRR_PC5_ORDER.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PRR_PC5_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PRR_PC5_PROBLEM_ROLE getPROBLEM_ROLE() { 
       PRR_PC5_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", PRR_PC5_PROBLEM_ROLE.class);
       return retVal;
    }
    ...
    public PRR_PC5_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
       PRR_PC5_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", rep, PRR_PC5_PROBLEM_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PRR_PC5_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_ROLE", PRR_PC5_PROBLEM_ROLE.class);
    } 
     ...
     * Returns
     * the first repetition of 
     * PROBLEM_PATHWAY (a Group object) - creates it if necessary
     */
    public PRR_PC5_PROBLEM_PATHWAY getPROBLEM_PATHWAY() { 
       PRR_PC5_PROBLEM_PATHWAY retVal = getTyped("PROBLEM_PATHWAY", PRR_PC5_PROBLEM_PATHWAY.class);
       return retVal;
    }
    ...
    public PRR_PC5_PROBLEM_PATHWAY getPROBLEM_PATHWAY(int rep) { 
       PRR_PC5_PROBLEM_PATHWAY retVal = getTyped("PROBLEM_PATHWAY", rep, PRR_PC5_PROBLEM_PATHWAY.class);
       return retVal;
    }
    ...
    public int getPROBLEM_PATHWAYReps() {  
        return getReps("PROBLEM_PATHWAY");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of PROBLEM_PATHWAY.
     * <p>
     * <p>
     * Note that unlike {@link #getPROBLEM_PATHWAY()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<PRR_PC5_PROBLEM_PATHWAY> getPROBLEM_PATHWAYAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_PATHWAY", PRR_PC5_PROBLEM_PATHWAY.class);
    } 
    ...
    public PRR_PC5_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       PRR_PC5_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", PRR_PC5_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public PRR_PC5_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       PRR_PC5_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, PRR_PC5_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PRR_PC5_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_OBSERVATION", PRR_PC5_PROBLEM_OBSERVATION.class);
    } 
    ...
    public PRR_PC5_GOAL getGOAL() { 
       PRR_PC5_GOAL retVal = getTyped("GOAL", PRR_PC5_GOAL.class);
       return retVal;
    }
    ...
    public PRR_PC5_GOAL getGOAL(int rep) { 
       PRR_PC5_GOAL retVal = getTyped("GOAL", rep, PRR_PC5_GOAL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PRR_PC5_GOAL> getGOALAll() throws HL7Exception {
    	return getAllAsList("GOAL", PRR_PC5_GOAL.class);
    } 
    ...
    public PRR_PC5_ORDER getORDER() { 
       PRR_PC5_ORDER retVal = getTyped("ORDER", PRR_PC5_ORDER.class);
       return retVal;
    }
    ...
    public PRR_PC5_ORDER getORDER(int rep) { 
       PRR_PC5_ORDER retVal = getTyped("ORDER", rep, PRR_PC5_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PRR_PC5_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", PRR_PC5_ORDER.class);
    } 
