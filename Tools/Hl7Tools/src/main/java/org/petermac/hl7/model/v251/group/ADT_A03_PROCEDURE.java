...
/**
 * <p>Represents a ADT_A03_PROCEDURE group structure (a Group object).
...
public class ADT_A03_PROCEDURE extends AbstractGroup {

    /** 
     * Creates a new ADT_A03_PROCEDURE group
     */
    public ADT_A03_PROCEDURE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A03_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
