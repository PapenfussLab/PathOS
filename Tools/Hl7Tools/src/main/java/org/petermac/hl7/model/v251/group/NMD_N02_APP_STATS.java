...
/**
 * <p>Represents a NMD_N02_APP_STATS group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: NST (Application control level statistics) <b>  </b></li>
...
public class NMD_N02_APP_STATS extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(NST.class, true, false, false);
                                  this.add(NTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating NMD_N02_APP_STATS - this is probably a bug in the source code generator.", e);
       }
    }
