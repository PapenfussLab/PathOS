...
/**
 * <p>Represents a ORD_O04 message structure (see chapter 4.7.2). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORD_O04_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORD_O04 extends AbstractMessage  {

    /**
     * Creates a new ORD_O04 message with DefaultModelClassFactory. 
     */ 
    public ORD_O04() { 
    ...
    /** 
     * Creates a new ORD_O04 message with custom ModelClassFactory.
     */
    public ORD_O04(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORD_O04_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORD_O04 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORD_O04_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORD_O04_RESPONSE.class);
    }
