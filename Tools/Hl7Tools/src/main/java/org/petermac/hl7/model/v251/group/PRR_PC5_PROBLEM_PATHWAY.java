...
/**
 * <p>Represents a PRR_PC5_PROBLEM_PATHWAY group structure (a Group object).
...
public class PRR_PC5_PROBLEM_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new PRR_PC5_PROBLEM_PATHWAY group
     */
    public PRR_PC5_PROBLEM_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PRR_PC5_PROBLEM_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
