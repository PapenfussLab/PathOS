...
/**
 * <p>Represents a CSU_C09_VISIT group structure (a Group object).
...
public class CSU_C09_VISIT extends AbstractGroup {

    /** 
     * Creates a new CSU_C09_VISIT group
     */
    public CSU_C09_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CSU_C09_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
