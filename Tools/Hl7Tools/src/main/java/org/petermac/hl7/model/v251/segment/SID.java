 ...
 * <ul>
     * <li>SID-1: Application / Method Identifier (CE) <b>optional </b>
     * <li>SID-2: Substance Lot Number (ST) <b>optional </b>
     * <li>SID-3: Substance Container Identifier (ST) <b>optional </b>
     * <li>SID-4: Substance Manufacturer Identifier (CE) <b>optional </b>
 * </ul>
 */
...
public class SID extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Application / Method Identifier");
                                  this.add(ST.class, false, 1, 20, new Object[]{ getMessage() }, "Substance Lot Number");
                                  this.add(ST.class, false, 1, 200, new Object[]{ getMessage() }, "Substance Container Identifier");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Substance Manufacturer Identifier");
