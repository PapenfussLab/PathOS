...
/**
 * <p>Represents a PPG_PCG_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPG_PCG_PROBLEM_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPG_PCG_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PPG_PCG_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCG_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPG_PCG_PROBLEM_ROLE getPROBLEM_ROLE() { 
       PPG_PCG_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", PPG_PCG_PROBLEM_ROLE.class);
       return retVal;
    }
    ...
    public PPG_PCG_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
       PPG_PCG_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", rep, PPG_PCG_PROBLEM_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCG_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_ROLE", PPG_PCG_PROBLEM_ROLE.class);
    } 
    ...
    public PPG_PCG_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       PPG_PCG_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", PPG_PCG_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPG_PCG_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       PPG_PCG_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, PPG_PCG_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCG_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_OBSERVATION", PPG_PCG_PROBLEM_OBSERVATION.class);
    } 
