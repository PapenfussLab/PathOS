...
/**
 * <p>Represents a PPT_PCL_PATHWAY_ROLE group structure (a Group object).
...
public class PPT_PCL_PATHWAY_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPT_PCL_PATHWAY_ROLE group
     */
    public PPT_PCL_PATHWAY_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPT_PCL_PATHWAY_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
