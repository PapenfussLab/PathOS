 ...
 * <ul>
		                 ...
		                 * <li>3: NMD_N02_CLOCK_AND_STATS_WITH_NOTES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class NMD_N02 extends AbstractMessage  {
     ...
     * Returns
     * the first repetition of 
     * CLOCK_AND_STATS_WITH_NOTES (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public NMD_N02_CLOCK_AND_STATS_WITH_NOTES getCLOCK_AND_STATS_WITH_NOTES() { 
       return getTyped("CLOCK_AND_STATS_WITH_NOTES", NMD_N02_CLOCK_AND_STATS_WITH_NOTES.class);
    }
    ...
    public NMD_N02_CLOCK_AND_STATS_WITH_NOTES getCLOCK_AND_STATS_WITH_NOTES(int rep) { 
       return getTyped("CLOCK_AND_STATS_WITH_NOTES", rep, NMD_N02_CLOCK_AND_STATS_WITH_NOTES.class);
    }
    ...
    public int getCLOCK_AND_STATS_WITH_NOTESReps() { 
    	return getReps("CLOCK_AND_STATS_WITH_NOTES");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of CLOCK_AND_STATS_WITH_NOTES.
     * <p>
     * <p>
     * Note that unlike {@link #getCLOCK_AND_STATS_WITH_NOTES()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<NMD_N02_CLOCK_AND_STATS_WITH_NOTES> getCLOCK_AND_STATS_WITH_NOTESAll() throws HL7Exception {
    	return getAllAsList("CLOCK_AND_STATS_WITH_NOTES", NMD_N02_CLOCK_AND_STATS_WITH_NOTES.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of CLOCK_AND_STATS_WITH_NOTES (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    /**
     * <p>
     * Removes a specific repetition of CLOCK_AND_STATS_WITH_NOTES (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
