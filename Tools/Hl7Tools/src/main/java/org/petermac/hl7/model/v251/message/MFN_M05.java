...
/**
 * <p>Represents a MFN_M05 message structure (see chapter 8.9.1). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: MFI (Master File Identification) <b> </b> </li>
		                 * <li>4: MFN_M05_MF_LOCATION (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class MFN_M05 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFN_M05 message with DefaultModelClassFactory. 
     */ 
    public MFN_M05() { 
    ...
    /** 
     * Creates a new MFN_M05 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M05 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * MF_LOCATION (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFN_M05_MF_LOCATION getMF_LOCATION() { 
       return getTyped("MF_LOCATION", MFN_M05_MF_LOCATION.class);
    }
    ...
    public MFN_M05_MF_LOCATION getMF_LOCATION(int rep) { 
       return getTyped("MF_LOCATION", rep, MFN_M05_MF_LOCATION.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of MF_LOCATION 
     * </p>
     * 
     */ 
    public int getMF_LOCATIONReps() { 
    	return getReps("MF_LOCATION");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MF_LOCATION.
     * <p>
     * <p>
     * Note that unlike {@link #getMF_LOCATION()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFN_M05_MF_LOCATION> getMF_LOCATIONAll() throws HL7Exception {
    	return getAllAsList("MF_LOCATION", MFN_M05_MF_LOCATION.class);
    } 
