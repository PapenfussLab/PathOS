...
/**
 * <p>Represents a RSP_K23_QUERY_RESPONSE group structure (a Group object).
...
public class RSP_K23_QUERY_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_K23_QUERY_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
