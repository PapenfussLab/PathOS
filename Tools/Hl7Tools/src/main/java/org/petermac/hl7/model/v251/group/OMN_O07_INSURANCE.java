...
/**
 * <p>Represents a OMN_O07_INSURANCE group structure (a Group object).
...
public class OMN_O07_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new OMN_O07_INSURANCE group
     */
    public OMN_O07_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMN_O07_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
