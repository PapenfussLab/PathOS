...
/**
 * <p>Represents a ORL_O34_OBSERVATION_REQUEST_SPECIMEN group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: SPM (Specimen) <b>  </b></li>
                         * <li>2: SAC (Specimen Container detail) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORL_O34_OBSERVATION_REQUEST_SPECIMEN extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORL_O34_OBSERVATION_REQUEST_SPECIMEN - this is probably a bug in the source code generator.", e);
       }
    }
