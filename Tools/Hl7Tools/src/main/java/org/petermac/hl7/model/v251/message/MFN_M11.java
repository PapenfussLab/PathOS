 ...
 * <ul>
		                 ...
		                 * <li>4: MFN_M11_MF_TEST_CALCULATED (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class MFN_M11 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFN_M11 message with DefaultModelClassFactory. 
     */ 
    public MFN_M11() { 
    ...
    /** 
     * Creates a new MFN_M11 message with custom ModelClassFactory.
     */
     ...
     * Returns
     * the first repetition of 
     * MF_TEST_CALCULATED (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFN_M11_MF_TEST_CALCULATED getMF_TEST_CALCULATED() { 
       return getTyped("MF_TEST_CALCULATED", MFN_M11_MF_TEST_CALCULATED.class);
    }
    ...
    public MFN_M11_MF_TEST_CALCULATED getMF_TEST_CALCULATED(int rep) { 
       return getTyped("MF_TEST_CALCULATED", rep, MFN_M11_MF_TEST_CALCULATED.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of MF_TEST_CALCULATED 
     * </p>
     * 
     */ 
    public int getMF_TEST_CALCULATEDReps() { 
    	return getReps("MF_TEST_CALCULATED");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MF_TEST_CALCULATED.
     * <p>
     * <p>
     * Note that unlike {@link #getMF_TEST_CALCULATED()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFN_M11_MF_TEST_CALCULATED> getMF_TEST_CALCULATEDAll() throws HL7Exception {
    	return getAllAsList("MF_TEST_CALCULATED", MFN_M11_MF_TEST_CALCULATED.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of MF_TEST_CALCULATED (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    /**
     * <p>
     * Removes a specific repetition of MF_TEST_CALCULATED (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
