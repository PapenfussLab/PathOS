...
public class FAC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 20, new Object[]{ getMessage() }, "Facility ID-FAC");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(331) }, "Facility Type");
                                  this.add(XAD.class, true, 0, 250, new Object[]{ getMessage() }, "Facility Address");
                                  this.add(XTN.class, true, 1, 250, new Object[]{ getMessage() }, "Facility Telecommunication");
                                  this.add(XCN.class, false, 0, 250, new Object[]{ getMessage() }, "Contact Person");
                                  this.add(ST.class, false, 0, 60, new Object[]{ getMessage() }, "Contact Title");
                                  this.add(XAD.class, false, 0, 250, new Object[]{ getMessage() }, "Contact Address");
                                  this.add(XTN.class, false, 0, 250, new Object[]{ getMessage() }, "Contact Telecommunication");
                                  this.add(XCN.class, true, 0, 250, new Object[]{ getMessage() }, "Signature Authority");
                                  this.add(ST.class, false, 1, 60, new Object[]{ getMessage() }, "Signature Authority Title");
                                  this.add(XAD.class, false, 0, 250, new Object[]{ getMessage() }, "Signature Authority Address");
                                  this.add(XTN.class, false, 1, 250, new Object[]{ getMessage() }, "Signature Authority Telecommunication");
