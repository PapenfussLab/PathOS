...
/**
 * <p>Represents a OMG_O19_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: OMG_O19_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>6: OMG_O19_INSURANCE (a Group object) <b>optional repeating </b></li>
                         * <li>7: GT1 (Guarantor) <b>optional  </b></li>
                         * <li>8: AL1 (Patient Allergy Information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMG_O19_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMG_O19_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OMG_O19_PATIENT_VISIT getPATIENT_VISIT() { 
       OMG_O19_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", OMG_O19_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public OMG_O19_INSURANCE getINSURANCE() { 
       OMG_O19_INSURANCE retVal = getTyped("INSURANCE", OMG_O19_INSURANCE.class);
       return retVal;
    }
    ...
    public OMG_O19_INSURANCE getINSURANCE(int rep) { 
       OMG_O19_INSURANCE retVal = getTyped("INSURANCE", rep, OMG_O19_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMG_O19_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", OMG_O19_INSURANCE.class);
    } 
