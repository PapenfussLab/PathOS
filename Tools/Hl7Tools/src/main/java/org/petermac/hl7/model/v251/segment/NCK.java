...
/**
 *<p>Represents an HL7 NCK message segment (System Clock). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>NCK-1: System Date/Time (TS) <b> </b>
 * </ul>
 */
...
public class NCK extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(TS.class, true, 1, 26, new Object[]{ getMessage() }, "System Date/Time");
