...
/**
 * <p>Represents a OUL_R21 message structure (see chapter 7.3.2). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: NTE (Notes and Comments) <b>optional </b> </li>
		                 * <li>4: OUL_R21_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>5: OUL_R21_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>6: OUL_R21_ORDER_OBSERVATION (a Group object) <b> repeating</b> </li>
...
public class OUL_R21 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R21 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OUL_R21_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) { 
       return getTyped("ORDER_OBSERVATION", rep, OUL_R21_ORDER_OBSERVATION.class);
    }
     ...
     * 
     */ 
    public java.util.List<OUL_R21_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
