...
/**
 * <p>Represents a PRR_PC5_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PRR_PC5_ORDER_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PRR_PC5_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new PRR_PC5_ORDER_DETAIL group
     */
    public PRR_PC5_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PRR_PC5_ORDER_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PRR_PC5_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PRR_PC5_ORDER_OBSERVATION getORDER_OBSERVATION() { 
       PRR_PC5_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", PRR_PC5_ORDER_OBSERVATION.class);
       return retVal;
    }
    ...
    public PRR_PC5_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) { 
       PRR_PC5_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", rep, PRR_PC5_ORDER_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PRR_PC5_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("ORDER_OBSERVATION", PRR_PC5_ORDER_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER_OBSERVATION(PRR_PC5_ORDER_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PRR_PC5_ORDER_OBSERVATION insertORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (PRR_PC5_ORDER_OBSERVATION)super.insertRepetition("ORDER_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PRR_PC5_ORDER_OBSERVATION removeORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (PRR_PC5_ORDER_OBSERVATION)super.removeRepetition("ORDER_OBSERVATION", rep);
    }
