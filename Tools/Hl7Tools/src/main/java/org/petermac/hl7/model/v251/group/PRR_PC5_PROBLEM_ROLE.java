...
/**
 * <p>Represents a PRR_PC5_PROBLEM_ROLE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ROL (Role) <b>  </b></li>
                         * <li>2: VAR (Variance) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PRR_PC5_PROBLEM_ROLE extends AbstractGroup {

    /** 
     * Creates a new PRR_PC5_PROBLEM_ROLE group
     */
    public PRR_PC5_PROBLEM_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PRR_PC5_PROBLEM_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
