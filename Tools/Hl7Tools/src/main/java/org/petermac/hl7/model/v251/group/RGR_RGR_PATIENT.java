...
/**
 * <p>Represents a RGR_RGR_PATIENT group structure (a Group object).
...
public class RGR_RGR_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RGR_RGR_PATIENT group
     */
    public RGR_RGR_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGR_RGR_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
