 ...
 * <ul>
		                 ...
		                 * <li>5: RGR_RGR_DEFINITION (a Group object) <b> repeating</b> </li>
...
public class RGR_RGR extends AbstractMessage  {
    ...
    public RGR_RGR_DEFINITION getDEFINITION() { 
       return getTyped("DEFINITION", RGR_RGR_DEFINITION.class);
    }
    ...
    public RGR_RGR_DEFINITION getDEFINITION(int rep) { 
       return getTyped("DEFINITION", rep, RGR_RGR_DEFINITION.class);
    }
     ...
     * 
     */ 
    public java.util.List<RGR_RGR_DEFINITION> getDEFINITIONAll() throws HL7Exception {
    	return getAllAsList("DEFINITION", RGR_RGR_DEFINITION.class);
    } 
