...
/**
 * <p>Represents a PPT_PCL_PATIENT_VISIT group structure (a Group object).
...
public class PPT_PCL_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new PPT_PCL_PATIENT_VISIT group
     */
    public PPT_PCL_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPT_PCL_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
