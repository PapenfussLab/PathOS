 ...
 * <ul>
		                 ...
		                 * <li>7: Hxx (any HL7 segment) <b>optional </b> </li>
		                 * <li>8: Hxx (any HL7 segment) <b>optional </b> </li>
...
public class RTB_Knn extends AbstractMessage  {
    ...
    /**
     * Creates a new RTB_Knn message with DefaultModelClassFactory. 
     */ 
    public RTB_Knn() { 
    ...
    /** 
     * Creates a new RTB_Knn message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RTB_Knn - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * <p>
     * Returns
     * Hxx2 (any HL7 segment) - creates it if necessary
     * </p>
     * 
     *
     */
    public Hxx getHxx2() { 
       return getTyped("Hxx2", Hxx.class);
    }
