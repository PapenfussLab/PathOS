...
/**
 * <p>Represents a ADT_A16 message structure (see chapter 3.3.16). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>16: ADT_A16_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>17: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>18: ADT_A16_INSURANCE (a Group object) <b>optional repeating</b> </li>
		                 * <li>19: ACC (Accident) <b>optional </b> </li>
 * </ul>
 */
...
public class ADT_A16 extends AbstractMessage  {
    ...
    /**
     * Creates a new ADT_A16 message with DefaultModelClassFactory. 
     */ 
    public ADT_A16() { 
    ...
    /** 
     * Creates a new ADT_A16 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A16_PROCEDURE.class, false, true);
	                          this.add(GT1.class, false, true);
	                          this.add(ADT_A16_INSURANCE.class, false, true);
	                          this.add(ACC.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ADT_A16 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ADT_A16_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", ADT_A16_PROCEDURE.class);
    }
    ...
    public ADT_A16_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, ADT_A16_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A16_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", ADT_A16_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(ADT_A16_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A16_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A16_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A16_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A16_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public ADT_A16_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", ADT_A16_INSURANCE.class);
    }
    ...
    public ADT_A16_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, ADT_A16_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A16_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", ADT_A16_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(ADT_A16_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A16_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A16_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A16_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A16_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
