...
/**
 * <p>Represents a OUL_R23_SPECIMEN group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: OUL_R23_CONTAINER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class OUL_R23_SPECIMEN extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OUL_R23_CONTAINER.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OUL_R23_SPECIMEN - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OUL_R23_CONTAINER getCONTAINER() { 
       OUL_R23_CONTAINER retVal = getTyped("CONTAINER", OUL_R23_CONTAINER.class);
       return retVal;
    }
    ...
    public OUL_R23_CONTAINER getCONTAINER(int rep) { 
       OUL_R23_CONTAINER retVal = getTyped("CONTAINER", rep, OUL_R23_CONTAINER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OUL_R23_CONTAINER> getCONTAINERAll() throws HL7Exception {
    	return getAllAsList("CONTAINER", OUL_R23_CONTAINER.class);
    } 
