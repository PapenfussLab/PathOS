...
/**
 * <p>Represents a PPV_PCA_GOAL_ROLE group structure (a Group object).
...
public class PPV_PCA_GOAL_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPV_PCA_GOAL_ROLE group
     */
    public PPV_PCA_GOAL_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPV_PCA_GOAL_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
