...
public class FHS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(HD.class, false, 1, 227, new Object[]{ getMessage() }, "File Sending Application");
                                  this.add(HD.class, false, 1, 227, new Object[]{ getMessage() }, "File Sending Facility");
                                  this.add(HD.class, false, 1, 227, new Object[]{ getMessage() }, "File Receiving Application");
                                  this.add(HD.class, false, 1, 227, new Object[]{ getMessage() }, "File Receiving Facility");
