...
/**
 * <p>Represents a SQR_S25_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: DG1 (Diagnosis) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class SQR_S25_PATIENT extends AbstractGroup {

    /** 
     * Creates a new SQR_S25_PATIENT group
     */
    public SQR_S25_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DG1.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating SQR_S25_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
