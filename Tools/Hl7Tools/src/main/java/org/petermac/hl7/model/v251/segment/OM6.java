...
/**
 *<p>Represents an HL7 OM6 message segment (Observations that are Calculated from Other Observations). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>OM6-1: Sequence Number - Test/Observation Master File (NM) <b>optional </b>
     * <li>OM6-2: Derivation Rule (TX) <b>optional </b>
 * </ul>
 */
...
public class OM6 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(TX.class, false, 1, 10240, new Object[]{ getMessage() }, "Derivation Rule");
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OM6 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * OM6-1: "Sequence Number - Test/Observation Master File" - creates it if necessary
     */
    ...
    /**
     * Returns
     * OM6-2: "Derivation Rule" - creates it if necessary
     */
