...
/**
 * <p>Represents a RRG_O16_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: RRG_O16_TIMING (a Group object) <b>optional repeating </b></li>
                         * <li>3: RRG_O16_GIVE (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RRG_O16_ORDER extends AbstractGroup {
    ...
    public RRG_O16_TIMING getTIMING() { 
       RRG_O16_TIMING retVal = getTyped("TIMING", RRG_O16_TIMING.class);
       return retVal;
    }
    ...
    public RRG_O16_TIMING getTIMING(int rep) { 
       RRG_O16_TIMING retVal = getTyped("TIMING", rep, RRG_O16_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RRG_O16_TIMING> getTIMINGAll() throws HL7Exception {
    	return getAllAsList("TIMING", RRG_O16_TIMING.class);
    } 
    ...
    public RRG_O16_GIVE getGIVE() { 
       RRG_O16_GIVE retVal = getTyped("GIVE", RRG_O16_GIVE.class);
       return retVal;
    }
