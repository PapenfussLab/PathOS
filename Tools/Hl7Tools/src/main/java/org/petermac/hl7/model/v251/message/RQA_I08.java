 ...
 * <ul>
		                 ...
		                 * <li>3: RF1 (Referral Information) <b>optional </b> </li>
		                 * <li>4: RQA_I08_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>5: RQA_I08_PROVIDER (a Group object) <b> repeating</b> </li>
		                 * <li>6: PID (Patient Identification) <b> </b> </li>
		                 * <li>7: NK1 (Next of Kin / Associated Parties) <b>optional repeating</b> </li>
		                 * <li>8: RQA_I08_GUARANTOR_INSURANCE (a Group object) <b>optional </b> </li>
		                 ...
		                 * <li>13: RQA_I08_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: RQA_I08_OBSERVATION (a Group object) <b>optional repeating</b> </li>
		                 * <li>15: RQA_I08_VISIT (a Group object) <b>optional </b> </li>
...
public class RQA_I08 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQA_I08 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I08_PROVIDER> getPROVIDERAll() throws HL7Exception {
     ...
     * 
     */ 
    public java.util.List<RQA_I08_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
     ...
     * 
     */ 
    public java.util.List<RQA_I08_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
