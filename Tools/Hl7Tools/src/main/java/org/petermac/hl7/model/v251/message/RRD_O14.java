...
/**
 * <p>Represents a RRD_O14 message structure (see chapter 4.13.8). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: RRD_O14_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RRD_O14 extends AbstractMessage  {

    /**
     * Creates a new RRD_O14 message with DefaultModelClassFactory. 
     */ 
    public RRD_O14() { 
    ...
    /** 
     * Creates a new RRD_O14 message with custom ModelClassFactory.
     */
    public RRD_O14(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RRD_O14_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRD_O14 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RRD_O14_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", RRD_O14_RESPONSE.class);
    }
