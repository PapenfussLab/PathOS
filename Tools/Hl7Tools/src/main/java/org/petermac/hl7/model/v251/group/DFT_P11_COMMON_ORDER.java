...
public class DFT_P11_COMMON_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DFT_P11_TIMING_QUANTITY.class, false, true, false);
                                  this.add(DFT_P11_ORDER.class, false, false, false);
                                  this.add(DFT_P11_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating DFT_P11_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public DFT_P11_TIMING_QUANTITY getTIMING_QUANTITY() { 
       DFT_P11_TIMING_QUANTITY retVal = getTyped("TIMING_QUANTITY", DFT_P11_TIMING_QUANTITY.class);
       return retVal;
    }
    ...
    public DFT_P11_TIMING_QUANTITY getTIMING_QUANTITY(int rep) { 
       DFT_P11_TIMING_QUANTITY retVal = getTyped("TIMING_QUANTITY", rep, DFT_P11_TIMING_QUANTITY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<DFT_P11_TIMING_QUANTITY> getTIMING_QUANTITYAll() throws HL7Exception {
    	return getAllAsList("TIMING_QUANTITY", DFT_P11_TIMING_QUANTITY.class);
    } 
    ...
    public DFT_P11_ORDER getORDER() { 
       DFT_P11_ORDER retVal = getTyped("ORDER", DFT_P11_ORDER.class);
       return retVal;
    }
    ...
    public DFT_P11_OBSERVATION getOBSERVATION() { 
       DFT_P11_OBSERVATION retVal = getTyped("OBSERVATION", DFT_P11_OBSERVATION.class);
       return retVal;
    }
    ...
    public DFT_P11_OBSERVATION getOBSERVATION(int rep) { 
       DFT_P11_OBSERVATION retVal = getTyped("OBSERVATION", rep, DFT_P11_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<DFT_P11_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", DFT_P11_OBSERVATION.class);
    } 
