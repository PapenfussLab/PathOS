...
public class CSU_C09_STUDY_PHARM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CSU_C09_RX_ADMIN.class, true, true, false);
    ...
    public CSU_C09_RX_ADMIN getRX_ADMIN() { 
       CSU_C09_RX_ADMIN retVal = getTyped("RX_ADMIN", CSU_C09_RX_ADMIN.class);
       return retVal;
    }
    ...
    public CSU_C09_RX_ADMIN getRX_ADMIN(int rep) { 
       CSU_C09_RX_ADMIN retVal = getTyped("RX_ADMIN", rep, CSU_C09_RX_ADMIN.class);
       return retVal;
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getRX_ADMIN()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<CSU_C09_RX_ADMIN> getRX_ADMINAll() throws HL7Exception {
    	return getAllAsList("RX_ADMIN", CSU_C09_RX_ADMIN.class);
    } 
