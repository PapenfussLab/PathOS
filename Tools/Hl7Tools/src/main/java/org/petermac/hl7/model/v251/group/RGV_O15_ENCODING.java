...
/**
 * <p>Represents a RGV_O15_ENCODING group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXE (Pharmacy/Treatment Encoded Order) <b>  </b></li>
                         * <li>2: RGV_O15_TIMING_ENCODED (a Group object) <b> repeating </b></li>
...
public class RGV_O15_ENCODING extends AbstractGroup {

    /** 
     * Creates a new RGV_O15_ENCODING group
     */
    public RGV_O15_ENCODING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGV_O15_TIMING_ENCODED.class, true, true, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGV_O15_ENCODING - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RGV_O15_TIMING_ENCODED getTIMING_ENCODED() { 
       RGV_O15_TIMING_ENCODED retVal = getTyped("TIMING_ENCODED", RGV_O15_TIMING_ENCODED.class);
       return retVal;
    }
    ...
    public RGV_O15_TIMING_ENCODED getTIMING_ENCODED(int rep) { 
       RGV_O15_TIMING_ENCODED retVal = getTyped("TIMING_ENCODED", rep, RGV_O15_TIMING_ENCODED.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RGV_O15_TIMING_ENCODED> getTIMING_ENCODEDAll() throws HL7Exception {
    	return getAllAsList("TIMING_ENCODED", RGV_O15_TIMING_ENCODED.class);
    } 
     ...
     */
    public void insertTIMING_ENCODED(RGV_O15_TIMING_ENCODED structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RGV_O15_TIMING_ENCODED insertTIMING_ENCODED(int rep) throws HL7Exception { 
       return (RGV_O15_TIMING_ENCODED)super.insertRepetition("TIMING_ENCODED", rep);
    }
     ...
     */
    public RGV_O15_TIMING_ENCODED removeTIMING_ENCODED(int rep) throws HL7Exception { 
       return (RGV_O15_TIMING_ENCODED)super.removeRepetition("TIMING_ENCODED", rep);
    }
