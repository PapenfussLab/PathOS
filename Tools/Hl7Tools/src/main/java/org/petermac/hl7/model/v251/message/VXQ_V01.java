...
/**
 * <p>Represents a VXQ_V01 message structure (see chapter 4.17.3). This structure contains the 
...
public class VXQ_V01 extends AbstractMessage  {

    /**
     * Creates a new VXQ_V01 message with DefaultModelClassFactory. 
     */ 
    public VXQ_V01() { 
    ...
    /** 
     * Creates a new VXQ_V01 message with custom ModelClassFactory.
     */
    public VXQ_V01(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating VXQ_V01 - this is probably a bug in the source code generator.", e);
       }
    }
