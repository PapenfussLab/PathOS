...
/**
 * <p>Represents a MFQ_M01 message structure (see chapter 8.4.4). This structure contains the 
...
public class MFQ_M01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFQ_M01 - this is probably a bug in the source code generator.", e);
       }
    }
