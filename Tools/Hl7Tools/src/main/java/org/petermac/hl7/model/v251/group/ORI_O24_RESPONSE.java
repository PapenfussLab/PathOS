...
public class ORI_O24_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ORI_O24_PATIENT.class, false, false, false);
                                  this.add(ORI_O24_ORDER.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORI_O24_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public java.util.List<ORI_O24_ORDER> getORDERAll() throws HL7Exception {
