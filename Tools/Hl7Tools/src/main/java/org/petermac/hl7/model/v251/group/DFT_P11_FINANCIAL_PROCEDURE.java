...
/**
 * <p>Represents a DFT_P11_FINANCIAL_PROCEDURE group structure (a Group object).
...
public class DFT_P11_FINANCIAL_PROCEDURE extends AbstractGroup {

    /** 
     * Creates a new DFT_P11_FINANCIAL_PROCEDURE group
     */
    public DFT_P11_FINANCIAL_PROCEDURE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating DFT_P11_FINANCIAL_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
