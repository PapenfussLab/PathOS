 ...
 * <ul>
     * <li>RMI-1: Risk Management Incident Code (CE) <b>optional </b>
     * <li>RMI-2: Date/Time Incident (TS) <b>optional </b>
     * <li>RMI-3: Incident Type Code (CE) <b>optional </b>
 * </ul>
 */
...
public class RMI extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Risk Management Incident Code");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Date/Time Incident");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Incident Type Code");
