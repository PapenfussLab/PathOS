...
/**
 * <p>Represents a RQP_I04_PROVIDER group structure (a Group object).
...
public class RQP_I04_PROVIDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQP_I04_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
