...
/**
 * <p>Represents a PMU_B07_CERTIFICATE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: CER (Certificate Detail) <b>  </b></li>
                         * <li>2: ROL (Role) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PMU_B07_CERTIFICATE extends AbstractGroup {

    /** 
     * Creates a new PMU_B07_CERTIFICATE group
     */
    public PMU_B07_CERTIFICATE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CER.class, true, false, false);
                                  this.add(ROL.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PMU_B07_CERTIFICATE - this is probably a bug in the source code generator.", e);
       }
    }
