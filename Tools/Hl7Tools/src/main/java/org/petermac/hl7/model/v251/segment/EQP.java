 ...
 * <ul>
     * <li>EQP-1: Event type (CE) <b> </b>
     * <li>EQP-2: File Name (ST) <b>optional </b>
     * <li>EQP-3: Start Date/Time (TS) <b> </b>
     * <li>EQP-4: End Date/Time (TS) <b>optional </b>
...
public class EQP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Event type");
                                  this.add(ST.class, false, 1, 20, new Object[]{ getMessage() }, "File Name");
                                  this.add(TS.class, true, 1, 26, new Object[]{ getMessage() }, "Start Date/Time");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "End Date/Time");
                                  this.add(FT.class, true, 1, 65536, new Object[]{ getMessage() }, "Transaction Data");
