...
/**
 * <p>Represents a RSP_Z88_TIMING group structure (a Group object).
...
public class RSP_Z88_TIMING extends AbstractGroup {

    /** 
     * Creates a new RSP_Z88_TIMING group
     */
    public RSP_Z88_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z88_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
