...
/**
 * <p>Represents a OMG_O19_PATIENT_VISIT_PRIOR group structure (a Group object).
...
public class OMG_O19_PATIENT_VISIT_PRIOR extends AbstractGroup {

    /** 
     * Creates a new OMG_O19_PATIENT_VISIT_PRIOR group
     */
    public OMG_O19_PATIENT_VISIT_PRIOR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMG_O19_PATIENT_VISIT_PRIOR - this is probably a bug in the source code generator.", e);
       }
    }
