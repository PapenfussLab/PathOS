...
/**
 * <p>Represents a PPG_PCG message structure (see chapter 12.3.4). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: PID (Patient Identification) <b> </b> </li>
		                 * <li>4: PPG_PCG_PATIENT_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>5: PPG_PCG_PATHWAY (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PPG_PCG extends AbstractMessage  {
    ...
    public PPG_PCG_PATIENT_VISIT getPATIENT_VISIT() { 
       return getTyped("PATIENT_VISIT", PPG_PCG_PATIENT_VISIT.class);
    }
    ...
    public PPG_PCG_PATHWAY getPATHWAY() { 
       return getTyped("PATHWAY", PPG_PCG_PATHWAY.class);
    }
    ...
    public PPG_PCG_PATHWAY getPATHWAY(int rep) { 
       return getTyped("PATHWAY", rep, PPG_PCG_PATHWAY.class);
    }
     ...
     * 
     */ 
    public java.util.List<PPG_PCG_PATHWAY> getPATHWAYAll() throws HL7Exception {
    	return getAllAsList("PATHWAY", PPG_PCG_PATHWAY.class);
    } 
