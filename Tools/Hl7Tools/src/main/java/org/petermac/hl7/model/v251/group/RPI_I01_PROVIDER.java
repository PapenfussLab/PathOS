...
/**
 * <p>Represents a RPI_I01_PROVIDER group structure (a Group object).
...
public class RPI_I01_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RPI_I01_PROVIDER group
     */
    public RPI_I01_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPI_I01_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
