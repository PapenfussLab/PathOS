...
/**
 * <p>Represents a RQI_I01_GUARANTOR_INSURANCE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: GT1 (Guarantor) <b>optional repeating </b></li>
                         * <li>2: RQI_I01_INSURANCE (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RQI_I01_GUARANTOR_INSURANCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RQI_I01_INSURANCE.class, true, true, false);
    ...
    public RQI_I01_INSURANCE getINSURANCE() { 
       RQI_I01_INSURANCE retVal = getTyped("INSURANCE", RQI_I01_INSURANCE.class);
       return retVal;
    }
    ...
    public RQI_I01_INSURANCE getINSURANCE(int rep) { 
       RQI_I01_INSURANCE retVal = getTyped("INSURANCE", rep, RQI_I01_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RQI_I01_INSURANCE> getINSURANCEAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(RQI_I01_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RQI_I01_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (RQI_I01_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RQI_I01_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (RQI_I01_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
