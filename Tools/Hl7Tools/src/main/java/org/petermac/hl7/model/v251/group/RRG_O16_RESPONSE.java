...
public class RRG_O16_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(RRG_O16_PATIENT.class, false, false, false);
                                  this.add(RRG_O16_ORDER.class, true, true, false);
     ...
     * </p>
     */ 
    public java.util.List<RRG_O16_ORDER> getORDERAll() throws HL7Exception {
