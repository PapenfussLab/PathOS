...
/**
 * <p>Represents a OSR_Q06_TIMING group structure (a Group object).
...
public class OSR_Q06_TIMING extends AbstractGroup {

    /** 
     * Creates a new OSR_Q06_TIMING group
     */
    public OSR_Q06_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OSR_Q06_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
