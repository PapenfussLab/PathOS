...
/**
 * <p>Represents a MFR_M07 message structure (see chapter 8.11.1). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: MSA (Message Acknowledgment) <b> </b> </li>
		                 * <li>4: ERR (Error) <b>optional repeating</b> </li>
		                 * <li>5: QAK (Query Acknowledgment) <b>optional </b> </li>
		                 * <li>6: QRD (Original-Style Query Definition) <b> </b> </li>
		                 * <li>7: QRF (Original style query filter) <b>optional </b> </li>
		                 * <li>8: MFI (Master File Identification) <b> </b> </li>
		                 * <li>9: MFR_M07_MF_QUERY (a Group object) <b> repeating</b> </li>
		                 * <li>10: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class MFR_M07 extends AbstractMessage  {

    /**
     * Creates a new MFR_M07 message with DefaultModelClassFactory. 
     */ 
    public MFR_M07() { 
    ...
    /** 
     * Creates a new MFR_M07 message with custom ModelClassFactory.
     */
    public MFR_M07(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(MFR_M07_MF_QUERY.class, true, true);
	                          this.add(DSC.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating MFR_M07 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * MF_QUERY (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFR_M07_MF_QUERY getMF_QUERY() { 
       return getTyped("MF_QUERY", MFR_M07_MF_QUERY.class);
    }
    ...
    public MFR_M07_MF_QUERY getMF_QUERY(int rep) { 
       return getTyped("MF_QUERY", rep, MFR_M07_MF_QUERY.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of MF_QUERY 
     * </p>
     * 
     */ 
    public int getMF_QUERYReps() { 
    	return getReps("MF_QUERY");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MF_QUERY.
     * <p>
     * <p>
     * Note that unlike {@link #getMF_QUERY()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFR_M07_MF_QUERY> getMF_QUERYAll() throws HL7Exception {
    	return getAllAsList("MF_QUERY", MFR_M07_MF_QUERY.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertMF_QUERY(MFR_M07_MF_QUERY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public MFR_M07_MF_QUERY insertMF_QUERY(int rep) throws HL7Exception { 
       return (MFR_M07_MF_QUERY)super.insertRepetition("MF_QUERY", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public MFR_M07_MF_QUERY removeMF_QUERY(int rep) throws HL7Exception { 
       return (MFR_M07_MF_QUERY)super.removeRepetition("MF_QUERY", rep);
    }
