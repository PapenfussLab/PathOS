...
/**
 * <p>Represents a RGR_RGR_ENCODING group structure (a Group object).
...
public class RGR_RGR_ENCODING extends AbstractGroup {

    /** 
     * Creates a new RGR_RGR_ENCODING group
     */
    public RGR_RGR_ENCODING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGR_RGR_ENCODING - this is probably a bug in the source code generator.", e);
       }
    }
