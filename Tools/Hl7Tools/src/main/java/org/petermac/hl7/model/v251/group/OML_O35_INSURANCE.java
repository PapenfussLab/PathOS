...
/**
 * <p>Represents a OML_O35_INSURANCE group structure (a Group object).
...
public class OML_O35_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new OML_O35_INSURANCE group
     */
    public OML_O35_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OML_O35_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
