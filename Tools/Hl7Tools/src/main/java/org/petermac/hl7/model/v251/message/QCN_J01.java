 ...
 * <ul>
		                 ...
		                 * <li>3: QID (Query Identification) <b> </b> </li>
 * </ul>
 */
...
public class QCN_J01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating QCN_J01 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * <p>
     * Returns
     * QID (Query Identification) - creates it if necessary
     * </p>
     * 
     *
     */
    public QID getQID() { 
       return getTyped("QID", QID.class);
    }
