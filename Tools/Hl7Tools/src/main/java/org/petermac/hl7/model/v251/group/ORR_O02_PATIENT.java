...
/**
 * <p>Represents a ORR_O02_PATIENT group structure (a Group object).
...
public class ORR_O02_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORR_O02_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
