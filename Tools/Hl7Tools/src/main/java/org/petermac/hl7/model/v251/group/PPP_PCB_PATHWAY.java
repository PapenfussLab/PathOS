...
/**
 * <p>Represents a PPP_PCB_PATHWAY group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPP_PCB_PATHWAY_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPP_PCB_PROBLEM (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PPP_PCB_PATHWAY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPP_PCB_PATHWAY_ROLE.class, false, true, false);
                                  this.add(PPP_PCB_PROBLEM.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPP_PCB_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCB_PATHWAY_ROLE getPATHWAY_ROLE() { 
       PPP_PCB_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", PPP_PCB_PATHWAY_ROLE.class);
       return retVal;
    }
    ...
    public PPP_PCB_PATHWAY_ROLE getPATHWAY_ROLE(int rep) { 
       PPP_PCB_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", rep, PPP_PCB_PATHWAY_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_PATHWAY_ROLE> getPATHWAY_ROLEAll() throws HL7Exception {
    	return getAllAsList("PATHWAY_ROLE", PPP_PCB_PATHWAY_ROLE.class);
    } 
    ...
    public PPP_PCB_PROBLEM getPROBLEM() { 
       PPP_PCB_PROBLEM retVal = getTyped("PROBLEM", PPP_PCB_PROBLEM.class);
       return retVal;
    }
    ...
    public PPP_PCB_PROBLEM getPROBLEM(int rep) { 
       PPP_PCB_PROBLEM retVal = getTyped("PROBLEM", rep, PPP_PCB_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_PROBLEM> getPROBLEMAll() throws HL7Exception {
    	return getAllAsList("PROBLEM", PPP_PCB_PROBLEM.class);
    } 
