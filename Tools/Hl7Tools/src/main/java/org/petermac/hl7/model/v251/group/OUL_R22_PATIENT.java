...
/**
 * <p>Represents a OUL_R22_PATIENT group structure (a Group object).
...
public class OUL_R22_PATIENT extends AbstractGroup {

    /** 
     * Creates a new OUL_R22_PATIENT group
     */
    public OUL_R22_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R22_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
