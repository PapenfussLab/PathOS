...
/**
 * <p>Represents a ESR_U02 message structure (see chapter 13.3.2). This structure contains the 
...
public class ESR_U02 extends AbstractMessage  {
    ...
    /**
     * Creates a new ESR_U02 message with DefaultModelClassFactory. 
     */ 
    public ESR_U02() { 
    ...
    /** 
     * Creates a new ESR_U02 message with custom ModelClassFactory.
     */
    public ESR_U02(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
