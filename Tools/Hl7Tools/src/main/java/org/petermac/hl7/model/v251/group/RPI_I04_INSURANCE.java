...
/**
 * <p>Represents a RPI_I04_INSURANCE group structure (a Group object).
...
public class RPI_I04_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new RPI_I04_INSURANCE group
     */
    public RPI_I04_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPI_I04_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
