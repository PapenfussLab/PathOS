...
/**
 * <p>Represents a ADT_A52 message structure (see chapter 3.3.52). This structure contains the 
...
public class ADT_A52 extends AbstractMessage  {

    /**
     * Creates a new ADT_A52 message with DefaultModelClassFactory. 
     */ 
    public ADT_A52() { 
    ...
    /** 
     * Creates a new ADT_A52 message with custom ModelClassFactory.
     */
    public ADT_A52(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A52 - this is probably a bug in the source code generator.", e);
       }
    }
