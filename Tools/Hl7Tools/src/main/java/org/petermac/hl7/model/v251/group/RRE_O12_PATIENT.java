...
/**
 * <p>Represents a RRE_O12_PATIENT group structure (a Group object).
...
public class RRE_O12_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RRE_O12_PATIENT group
     */
    public RRE_O12_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRE_O12_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
