...
/**
 * <p>Represents a REF_I12_OBSERVATION group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: REF_I12_RESULTS_NOTES (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class REF_I12_OBSERVATION extends AbstractGroup {
     ...
     * Returns
     * the first repetition of 
     * RESULTS_NOTES (a Group object) - creates it if necessary
     */
    public REF_I12_RESULTS_NOTES getRESULTS_NOTES() { 
       REF_I12_RESULTS_NOTES retVal = getTyped("RESULTS_NOTES", REF_I12_RESULTS_NOTES.class);
       return retVal;
    }
    ...
    public REF_I12_RESULTS_NOTES getRESULTS_NOTES(int rep) { 
       REF_I12_RESULTS_NOTES retVal = getTyped("RESULTS_NOTES", rep, REF_I12_RESULTS_NOTES.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of RESULTS_NOTES 
     */ 
    ...
    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of RESULTS_NOTES.
     * <p>
     * <p>
     * Note that unlike {@link #getRESULTS_NOTES()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<REF_I12_RESULTS_NOTES> getRESULTS_NOTESAll() throws HL7Exception {
    	return getAllAsList("RESULTS_NOTES", REF_I12_RESULTS_NOTES.class);
    } 

    /**
     * Inserts a specific repetition of RESULTS_NOTES (a Group object)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    ...
    /**
     * Removes a specific repetition of RESULTS_NOTES (a Group object)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
