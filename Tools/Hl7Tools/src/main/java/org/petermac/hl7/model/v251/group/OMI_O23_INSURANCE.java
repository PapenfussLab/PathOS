...
/**
 * <p>Represents a OMI_O23_INSURANCE group structure (a Group object).
...
public class OMI_O23_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new OMI_O23_INSURANCE group
     */
    public OMI_O23_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMI_O23_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
