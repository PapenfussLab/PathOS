...
/**
 * <p>Represents a OMD_O03_TIMING_TRAY group structure (a Group object).
...
public class OMD_O03_TIMING_TRAY extends AbstractGroup {

    /** 
     * Creates a new OMD_O03_TIMING_TRAY group
     */
    public OMD_O03_TIMING_TRAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMD_O03_TIMING_TRAY - this is probably a bug in the source code generator.", e);
       }
    }
