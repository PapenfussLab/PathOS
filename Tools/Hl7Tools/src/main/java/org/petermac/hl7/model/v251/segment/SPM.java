 ...
 * <ul>
     ...
     * <li>SPM-18: Specimen Received Date/Time (TS) <b>optional </b>
...
public class SPM extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(EIP.class, false, 1, 80, new Object[]{ getMessage() }, "Specimen ID");
                                  this.add(EIP.class, false, 0, 80, new Object[]{ getMessage() }, "Specimen Parent IDs");
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Specimen Type");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Specimen Type Modifier");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Specimen Additives");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Specimen Collection Method");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Specimen Source Site");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Specimen Source Site Modifier");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Specimen Collection Site");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Specimen Role");
                                  this.add(CQ.class, false, 1, 20, new Object[]{ getMessage() }, "Specimen Collection Amount");
                                  this.add(NM.class, false, 1, 6, new Object[]{ getMessage() }, "Grouped Specimen Count");
                                  this.add(ST.class, false, 0, 250, new Object[]{ getMessage() }, "Specimen Description");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Specimen Handling Code");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Specimen Risk Code");
                                  this.add(DR.class, false, 1, 26, new Object[]{ getMessage() }, "Specimen Collection Date/Time");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Specimen Received Date/Time");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Specimen Expiration Date/Time");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(136) }, "Specimen Availability");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Specimen Reject Reason");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Specimen Quality");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Specimen Appropriateness");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Specimen Condition");
                                  this.add(CQ.class, false, 1, 20, new Object[]{ getMessage() }, "Specimen Current Quantity");
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "Number of Specimen Containers");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Container Type");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Container Condition");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Specimen Child Role");
