...
/**
 * <p>Represents a RRE_O12 message structure (see chapter 4.13.6). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: RRE_O12_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RRE_O12 extends AbstractMessage  {

    /**
     * Creates a new RRE_O12 message with DefaultModelClassFactory. 
     */ 
    public RRE_O12() { 
    ...
    /** 
     * Creates a new RRE_O12 message with custom ModelClassFactory.
     */
    public RRE_O12(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RRE_O12_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRE_O12 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RRE_O12_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", RRE_O12_RESPONSE.class);
    }
