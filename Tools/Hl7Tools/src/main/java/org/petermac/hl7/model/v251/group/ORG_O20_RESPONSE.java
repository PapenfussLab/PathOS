...
/**
 * <p>Represents a ORG_O20_RESPONSE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORG_O20_PATIENT (a Group object) <b>optional  </b></li>
                         * <li>2: ORG_O20_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class ORG_O20_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ORG_O20_PATIENT.class, false, false, false);
                                  this.add(ORG_O20_ORDER.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORG_O20_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORG_O20_PATIENT getPATIENT() { 
       ORG_O20_PATIENT retVal = getTyped("PATIENT", ORG_O20_PATIENT.class);
       return retVal;
    }
    ...
    public ORG_O20_ORDER getORDER() { 
       ORG_O20_ORDER retVal = getTyped("ORDER", ORG_O20_ORDER.class);
       return retVal;
    }
    ...
    public ORG_O20_ORDER getORDER(int rep) { 
       ORG_O20_ORDER retVal = getTyped("ORDER", rep, ORG_O20_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORG_O20_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", ORG_O20_ORDER.class);
    } 
