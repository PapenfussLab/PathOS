...
/**
 * <p>Represents a PTR_PCF_GOAL_ROLE group structure (a Group object).
...
public class PTR_PCF_GOAL_ROLE extends AbstractGroup {

    /** 
     * Creates a new PTR_PCF_GOAL_ROLE group
     */
    public PTR_PCF_GOAL_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PTR_PCF_GOAL_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
