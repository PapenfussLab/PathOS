...
public class AUT extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Authorizing Payor, Plan ID");
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Authorizing Payor, Company ID");
