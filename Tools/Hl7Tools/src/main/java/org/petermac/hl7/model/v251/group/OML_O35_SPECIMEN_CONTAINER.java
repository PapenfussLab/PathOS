...
/**
 * <p>Represents a OML_O35_SPECIMEN_CONTAINER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: SAC (Specimen Container detail) <b>  </b></li>
                         * <li>2: OML_O35_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class OML_O35_SPECIMEN_CONTAINER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OML_O35_ORDER.class, true, true, false);
    ...
    public OML_O35_ORDER getORDER() { 
       OML_O35_ORDER retVal = getTyped("ORDER", OML_O35_ORDER.class);
       return retVal;
    }
    ...
    public OML_O35_ORDER getORDER(int rep) { 
       OML_O35_ORDER retVal = getTyped("ORDER", rep, OML_O35_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OML_O35_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", OML_O35_ORDER.class);
    } 
