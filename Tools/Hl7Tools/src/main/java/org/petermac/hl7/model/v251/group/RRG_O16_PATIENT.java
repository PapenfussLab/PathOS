...
/**
 * <p>Represents a RRG_O16_PATIENT group structure (a Group object).
...
public class RRG_O16_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RRG_O16_PATIENT group
     */
    public RRG_O16_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRG_O16_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
