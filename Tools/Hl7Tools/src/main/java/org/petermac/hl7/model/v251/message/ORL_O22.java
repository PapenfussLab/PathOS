...
/**
 * <p>Represents a ORL_O22 message structure (see chapter 4.4.7). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORL_O22_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
...
public class ORL_O22 extends AbstractMessage  {
    ...
    /**
     * Creates a new ORL_O22 message with DefaultModelClassFactory. 
     */ 
    public ORL_O22() { 
    ...
    /** 
     * Creates a new ORL_O22 message with custom ModelClassFactory.
     */
    public ORL_O22(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORL_O22_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORL_O22 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORL_O22_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORL_O22_RESPONSE.class);
    }
