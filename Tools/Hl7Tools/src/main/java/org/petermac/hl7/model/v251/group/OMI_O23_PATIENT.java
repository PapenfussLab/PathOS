...
/**
 * <p>Represents a OMI_O23_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: OMI_O23_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>5: OMI_O23_INSURANCE (a Group object) <b>optional repeating </b></li>
                         * <li>6: GT1 (Guarantor) <b>optional  </b></li>
                         * <li>7: AL1 (Patient Allergy Information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMI_O23_PATIENT extends AbstractGroup {

    /** 
     * Creates a new OMI_O23_PATIENT group
     */
    public OMI_O23_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMI_O23_PATIENT_VISIT.class, false, false, false);
                                  this.add(OMI_O23_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMI_O23_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public OMI_O23_PATIENT_VISIT getPATIENT_VISIT() { 
       OMI_O23_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", OMI_O23_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public OMI_O23_INSURANCE getINSURANCE() { 
       OMI_O23_INSURANCE retVal = getTyped("INSURANCE", OMI_O23_INSURANCE.class);
       return retVal;
    }
    ...
    public OMI_O23_INSURANCE getINSURANCE(int rep) { 
       OMI_O23_INSURANCE retVal = getTyped("INSURANCE", rep, OMI_O23_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMI_O23_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", OMI_O23_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(OMI_O23_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMI_O23_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (OMI_O23_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMI_O23_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (OMI_O23_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
