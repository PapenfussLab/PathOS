...
/**
 * <p>Represents a OMB_O27_INSURANCE group structure (a Group object).
...
public class OMB_O27_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new OMB_O27_INSURANCE group
     */
    public OMB_O27_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMB_O27_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
