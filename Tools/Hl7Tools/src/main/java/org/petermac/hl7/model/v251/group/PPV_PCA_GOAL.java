...
/**
 * <p>Represents a PPV_PCA_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPV_PCA_GOAL_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPV_PCA_GOAL_PATHWAY (a Group object) <b>optional repeating </b></li>
                         * <li>6: PPV_PCA_GOAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>7: PPV_PCA_PROBLEM (a Group object) <b>optional repeating </b></li>
                         * <li>8: PPV_PCA_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PPV_PCA_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPV_PCA_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPV_PCA_GOAL_ROLE getGOAL_ROLE() { 
       PPV_PCA_GOAL_ROLE retVal = getTyped("GOAL_ROLE", PPV_PCA_GOAL_ROLE.class);
       return retVal;
    }
    ...
    public PPV_PCA_GOAL_ROLE getGOAL_ROLE(int rep) { 
       PPV_PCA_GOAL_ROLE retVal = getTyped("GOAL_ROLE", rep, PPV_PCA_GOAL_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
    	return getAllAsList("GOAL_ROLE", PPV_PCA_GOAL_ROLE.class);
    } 
     ...
     * Returns
     * the first repetition of 
     * GOAL_PATHWAY (a Group object) - creates it if necessary
     */
    public PPV_PCA_GOAL_PATHWAY getGOAL_PATHWAY() { 
       PPV_PCA_GOAL_PATHWAY retVal = getTyped("GOAL_PATHWAY", PPV_PCA_GOAL_PATHWAY.class);
       return retVal;
    }
    ...
    public PPV_PCA_GOAL_PATHWAY getGOAL_PATHWAY(int rep) { 
       PPV_PCA_GOAL_PATHWAY retVal = getTyped("GOAL_PATHWAY", rep, PPV_PCA_GOAL_PATHWAY.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of GOAL_PATHWAY 
     */ 
    public int getGOAL_PATHWAYReps() {  
        return getReps("GOAL_PATHWAY");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of GOAL_PATHWAY.
     * <p>
     * <p>
     * Note that unlike {@link #getGOAL_PATHWAY()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<PPV_PCA_GOAL_PATHWAY> getGOAL_PATHWAYAll() throws HL7Exception {
    	return getAllAsList("GOAL_PATHWAY", PPV_PCA_GOAL_PATHWAY.class);
    } 

    /**
     * Inserts a specific repetition of GOAL_PATHWAY (a Group object)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    ...
    /**
     * Removes a specific repetition of GOAL_PATHWAY (a Group object)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    ...
    public PPV_PCA_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
       PPV_PCA_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", PPV_PCA_GOAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPV_PCA_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
       PPV_PCA_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", rep, PPV_PCA_GOAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("GOAL_OBSERVATION", PPV_PCA_GOAL_OBSERVATION.class);
    } 
    ...
    public PPV_PCA_PROBLEM getPROBLEM() { 
       PPV_PCA_PROBLEM retVal = getTyped("PROBLEM", PPV_PCA_PROBLEM.class);
       return retVal;
    }
    ...
    public PPV_PCA_PROBLEM getPROBLEM(int rep) { 
       PPV_PCA_PROBLEM retVal = getTyped("PROBLEM", rep, PPV_PCA_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_PROBLEM> getPROBLEMAll() throws HL7Exception {
    	return getAllAsList("PROBLEM", PPV_PCA_PROBLEM.class);
    } 
    ...
    public PPV_PCA_ORDER getORDER() { 
       PPV_PCA_ORDER retVal = getTyped("ORDER", PPV_PCA_ORDER.class);
       return retVal;
    }
    ...
    public PPV_PCA_ORDER getORDER(int rep) { 
       PPV_PCA_ORDER retVal = getTyped("ORDER", rep, PPV_PCA_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", PPV_PCA_ORDER.class);
    } 
