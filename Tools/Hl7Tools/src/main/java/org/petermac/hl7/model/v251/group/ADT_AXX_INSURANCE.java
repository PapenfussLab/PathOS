...
/**
 * <p>Represents a ADT_AXX_INSURANCE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: IN1 () <b>  </b></li>
                         * <li>2: IN2 () <b>optional  </b></li>
                         * <li>3: IN3 () <b>optional repeating </b></li>
                         * <li>4: ROL () <b>optional repeating </b></li>
 * </ul>
 */
...
public class ADT_AXX_INSURANCE extends AbstractGroup {
     ...
     */
    public ADT_AXX_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_AXX_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
