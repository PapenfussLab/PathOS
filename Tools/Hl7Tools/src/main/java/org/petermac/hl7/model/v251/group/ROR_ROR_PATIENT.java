...
/**
 * <p>Represents a ROR_ROR_PATIENT group structure (a Group object).
...
public class ROR_ROR_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ROR_ROR_PATIENT group
     */
    public ROR_ROR_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ROR_ROR_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
