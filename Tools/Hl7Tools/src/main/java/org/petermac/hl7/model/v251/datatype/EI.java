 ...
 * 
 * The Original Code is "EI.java".  Description:
 * "Composite class EI"
 * 
...
/**
 * <p>Represents an HL7 EI (Entity Identifier) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>Entity Identifier (ST)
 * <li>Namespace ID (IS)
 * <li>Universal ID (ST)
...
public class EI extends AbstractComposite {
    ...
    private void init() {
        ...
        data[1] = new IS(getMessage(), 363);
        data[2] = new ST(getMessage());
        data[3] = new ID(getMessage(), 301);
    }
    ...
    /**
     * Returns Entity Identifier (component 1).  This is a convenience method that saves you from 
    ...
    /**
     * Returns Namespace ID (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    ...
    /**
     * Returns Universal ID (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    ...
    /**
     * Returns Universal ID Type (component 4).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
