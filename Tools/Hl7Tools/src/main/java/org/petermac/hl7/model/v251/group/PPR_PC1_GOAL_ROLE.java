...
/**
 * <p>Represents a PPR_PC1_GOAL_ROLE group structure (a Group object).
...
public class PPR_PC1_GOAL_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPR_PC1_GOAL_ROLE group
     */
    public PPR_PC1_GOAL_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPR_PC1_GOAL_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
