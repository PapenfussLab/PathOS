...
/**
 * <p>Represents a ORS_O06_TIMING group structure (a Group object).
...
public class ORS_O06_TIMING extends AbstractGroup {

    /** 
     * Creates a new ORS_O06_TIMING group
     */
    public ORS_O06_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORS_O06_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
