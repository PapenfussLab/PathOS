 ...
 * <ul>
     * <li>PES-1: Sender Organization Name (XON) <b>optional repeating</b>
...
public class PES extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(XON.class, false, 0, 250, new Object[]{ getMessage() }, "Sender Organization Name");
                                  this.add(XCN.class, false, 0, 250, new Object[]{ getMessage() }, "Sender Individual Name");
                                  this.add(XAD.class, false, 0, 250, new Object[]{ getMessage() }, "Sender Address");
                                  this.add(XTN.class, false, 0, 250, new Object[]{ getMessage() }, "Sender Telephone");
                                  this.add(EI.class, false, 1, 75, new Object[]{ getMessage() }, "Sender Event Identifier");
