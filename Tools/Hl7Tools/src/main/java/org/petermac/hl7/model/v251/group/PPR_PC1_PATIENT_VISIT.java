...
/**
 * <p>Represents a PPR_PC1_PATIENT_VISIT group structure (a Group object).
...
public class PPR_PC1_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new PPR_PC1_PATIENT_VISIT group
     */
    public PPR_PC1_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPR_PC1_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
