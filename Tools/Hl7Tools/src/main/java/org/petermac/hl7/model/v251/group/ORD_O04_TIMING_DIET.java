...
/**
 * <p>Represents a ORD_O04_TIMING_DIET group structure (a Group object).
...
public class ORD_O04_TIMING_DIET extends AbstractGroup {

    /** 
     * Creates a new ORD_O04_TIMING_DIET group
     */
    public ORD_O04_TIMING_DIET(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORD_O04_TIMING_DIET - this is probably a bug in the source code generator.", e);
       }
    }
