...
/**
 * <p>Represents a ORP_O10_PATIENT group structure (a Group object).
...
public class ORP_O10_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ORP_O10_PATIENT group
     */
    public ORP_O10_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORP_O10_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
