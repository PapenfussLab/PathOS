...
/**
 * <p>Represents a OML_O35_ORDER_PRIOR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: OML_O35_TIMING_PRIOR (a Group object) <b>optional repeating </b></li>
                         * <li>5: OML_O35_OBSERVATION_PRIOR (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OML_O35_ORDER_PRIOR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OML_O35_TIMING_PRIOR.class, false, true, false);
                                  this.add(OML_O35_OBSERVATION_PRIOR.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OML_O35_ORDER_PRIOR - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OML_O35_TIMING_PRIOR getTIMING_PRIOR() { 
       OML_O35_TIMING_PRIOR retVal = getTyped("TIMING_PRIOR", OML_O35_TIMING_PRIOR.class);
       return retVal;
    }
    ...
    public OML_O35_TIMING_PRIOR getTIMING_PRIOR(int rep) { 
       OML_O35_TIMING_PRIOR retVal = getTyped("TIMING_PRIOR", rep, OML_O35_TIMING_PRIOR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OML_O35_TIMING_PRIOR> getTIMING_PRIORAll() throws HL7Exception {
    	return getAllAsList("TIMING_PRIOR", OML_O35_TIMING_PRIOR.class);
    } 
    ...
    public OML_O35_OBSERVATION_PRIOR getOBSERVATION_PRIOR() { 
       OML_O35_OBSERVATION_PRIOR retVal = getTyped("OBSERVATION_PRIOR", OML_O35_OBSERVATION_PRIOR.class);
       return retVal;
    }
    ...
    public OML_O35_OBSERVATION_PRIOR getOBSERVATION_PRIOR(int rep) { 
       OML_O35_OBSERVATION_PRIOR retVal = getTyped("OBSERVATION_PRIOR", rep, OML_O35_OBSERVATION_PRIOR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OML_O35_OBSERVATION_PRIOR> getOBSERVATION_PRIORAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION_PRIOR", OML_O35_OBSERVATION_PRIOR.class);
    } 
