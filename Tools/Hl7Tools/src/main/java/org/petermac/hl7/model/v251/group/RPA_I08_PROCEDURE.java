...
/**
 * <p>Represents a RPA_I08_PROCEDURE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PR1 (Procedures) <b>  </b></li>
                         * <li>2: RPA_I08_AUTHORIZATION (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RPA_I08_PROCEDURE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RPA_I08_AUTHORIZATION.class, false, false, false);
    ...
    public RPA_I08_AUTHORIZATION getAUTHORIZATION() { 
       RPA_I08_AUTHORIZATION retVal = getTyped("AUTHORIZATION", RPA_I08_AUTHORIZATION.class);
       return retVal;
    }
