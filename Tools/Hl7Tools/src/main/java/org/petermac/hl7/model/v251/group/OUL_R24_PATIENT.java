...
/**
 * <p>Represents a OUL_R24_PATIENT group structure (a Group object).
...
public class OUL_R24_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R24_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
