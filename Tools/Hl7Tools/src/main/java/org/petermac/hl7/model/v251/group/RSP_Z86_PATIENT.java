...
/**
 * <p>Represents a RSP_Z86_PATIENT group structure (a Group object).
...
public class RSP_Z86_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RSP_Z86_PATIENT group
     */
    public RSP_Z86_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z86_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
