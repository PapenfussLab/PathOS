 ...
 * <ul>
		                 ...
		                 * <li>4: EAC_U07_COMMAND (a Group object) <b> repeating</b> </li>
...
public class EAC_U07 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating EAC_U07 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * COMMAND (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public EAC_U07_COMMAND getCOMMAND() { 
       return getTyped("COMMAND", EAC_U07_COMMAND.class);
    }
    ...
    public EAC_U07_COMMAND getCOMMAND(int rep) { 
       return getTyped("COMMAND", rep, EAC_U07_COMMAND.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of COMMAND 
     * </p>
     * 
     */ 
    public int getCOMMANDReps() { 
    	return getReps("COMMAND");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of COMMAND.
     * <p>
     * <p>
     * Note that unlike {@link #getCOMMAND()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<EAC_U07_COMMAND> getCOMMANDAll() throws HL7Exception {
    	return getAllAsList("COMMAND", EAC_U07_COMMAND.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of COMMAND (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    /**
     * <p>
     * Removes a specific repetition of COMMAND (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
