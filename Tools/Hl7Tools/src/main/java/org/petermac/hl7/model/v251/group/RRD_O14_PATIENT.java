...
/**
 * <p>Represents a RRD_O14_PATIENT group structure (a Group object).
...
public class RRD_O14_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RRD_O14_PATIENT group
     */
    public RRD_O14_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRD_O14_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
