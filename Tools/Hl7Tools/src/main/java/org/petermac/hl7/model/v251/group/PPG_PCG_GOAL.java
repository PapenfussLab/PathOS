...
/**
 * <p>Represents a PPG_PCG_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPG_PCG_GOAL_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPG_PCG_GOAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>6: PPG_PCG_PROBLEM (a Group object) <b>optional repeating </b></li>
                         * <li>7: PPG_PCG_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PPG_PCG_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPG_PCG_GOAL_ROLE.class, false, true, false);
                                  this.add(PPG_PCG_GOAL_OBSERVATION.class, false, true, false);
                                  this.add(PPG_PCG_PROBLEM.class, false, true, false);
                                  this.add(PPG_PCG_ORDER.class, false, true, false);
    ...
    public PPG_PCG_GOAL_ROLE getGOAL_ROLE() { 
       PPG_PCG_GOAL_ROLE retVal = getTyped("GOAL_ROLE", PPG_PCG_GOAL_ROLE.class);
       return retVal;
    }
    ...
    public PPG_PCG_GOAL_ROLE getGOAL_ROLE(int rep) { 
       PPG_PCG_GOAL_ROLE retVal = getTyped("GOAL_ROLE", rep, PPG_PCG_GOAL_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCG_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
    ...
    public PPG_PCG_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
       PPG_PCG_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", PPG_PCG_GOAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPG_PCG_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
       PPG_PCG_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", rep, PPG_PCG_GOAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCG_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
    ...
    public PPG_PCG_PROBLEM getPROBLEM() { 
       PPG_PCG_PROBLEM retVal = getTyped("PROBLEM", PPG_PCG_PROBLEM.class);
       return retVal;
    }
    ...
    public PPG_PCG_PROBLEM getPROBLEM(int rep) { 
       PPG_PCG_PROBLEM retVal = getTyped("PROBLEM", rep, PPG_PCG_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCG_PROBLEM> getPROBLEMAll() throws HL7Exception {
    ...
    public PPG_PCG_ORDER getORDER() { 
       PPG_PCG_ORDER retVal = getTyped("ORDER", PPG_PCG_ORDER.class);
       return retVal;
    }
    ...
    public PPG_PCG_ORDER getORDER(int rep) { 
       PPG_PCG_ORDER retVal = getTyped("ORDER", rep, PPG_PCG_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCG_ORDER> getORDERAll() throws HL7Exception {
