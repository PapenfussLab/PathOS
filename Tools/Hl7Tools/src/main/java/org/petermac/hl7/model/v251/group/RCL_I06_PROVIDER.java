...
/**
 * <p>Represents a RCL_I06_PROVIDER group structure (a Group object).
...
public class RCL_I06_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RCL_I06_PROVIDER group
     */
    public RCL_I06_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RCL_I06_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
