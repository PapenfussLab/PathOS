...
/**
 * <p>Represents a SRM_S01_LOCATION_RESOURCE group structure (a Group object).
...
public class SRM_S01_LOCATION_RESOURCE extends AbstractGroup {

    /** 
     * Creates a new SRM_S01_LOCATION_RESOURCE group
     */
    public SRM_S01_LOCATION_RESOURCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRM_S01_LOCATION_RESOURCE - this is probably a bug in the source code generator.", e);
       }
    }
