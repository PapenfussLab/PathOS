...
/**
 * <p>Represents a RSP_K31_TIMING_ENCODED group structure (a Group object).
...
public class RSP_K31_TIMING_ENCODED extends AbstractGroup {

    /** 
     * Creates a new RSP_K31_TIMING_ENCODED group
     */
    public RSP_K31_TIMING_ENCODED(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_K31_TIMING_ENCODED - this is probably a bug in the source code generator.", e);
       }
    }
