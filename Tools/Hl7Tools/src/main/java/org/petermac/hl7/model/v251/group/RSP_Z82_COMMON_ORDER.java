...
/**
 * <p>Represents a RSP_Z82_COMMON_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: RSP_Z82_TIMING (a Group object) <b>optional repeating </b></li>
                         * <li>3: RSP_Z82_ORDER_DETAIL (a Group object) <b>optional  </b></li>
                         * <li>4: RSP_Z82_ENCODED_ORDER (a Group object) <b>optional  </b></li>
                         ...
                         * <li>8: RSP_Z82_OBSERVATION (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RSP_Z82_COMMON_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RSP_Z82_TIMING.class, false, true, false);
                                  this.add(RSP_Z82_ORDER_DETAIL.class, false, false, false);
                                  this.add(RSP_Z82_ENCODED_ORDER.class, false, false, false);
                                  this.add(RXD.class, true, false, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
                                  this.add(RSP_Z82_OBSERVATION.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z82_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RSP_Z82_TIMING getTIMING() { 
       RSP_Z82_TIMING retVal = getTyped("TIMING", RSP_Z82_TIMING.class);
       return retVal;
    }
    ...
    public RSP_Z82_TIMING getTIMING(int rep) { 
       RSP_Z82_TIMING retVal = getTyped("TIMING", rep, RSP_Z82_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RSP_Z82_TIMING> getTIMINGAll() throws HL7Exception {
    	return getAllAsList("TIMING", RSP_Z82_TIMING.class);
    } 
    ...
    public RSP_Z82_ORDER_DETAIL getORDER_DETAIL() { 
       RSP_Z82_ORDER_DETAIL retVal = getTyped("ORDER_DETAIL", RSP_Z82_ORDER_DETAIL.class);
       return retVal;
    }
    ...
    public RSP_Z82_ENCODED_ORDER getENCODED_ORDER() { 
       RSP_Z82_ENCODED_ORDER retVal = getTyped("ENCODED_ORDER", RSP_Z82_ENCODED_ORDER.class);
       return retVal;
    }
    ...
    public RSP_Z82_OBSERVATION getOBSERVATION() { 
       RSP_Z82_OBSERVATION retVal = getTyped("OBSERVATION", RSP_Z82_OBSERVATION.class);
       return retVal;
    }
    ...
    public RSP_Z82_OBSERVATION getOBSERVATION(int rep) { 
       RSP_Z82_OBSERVATION retVal = getTyped("OBSERVATION", rep, RSP_Z82_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RSP_Z82_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", RSP_Z82_OBSERVATION.class);
    } 
