...
/**
 * <p>Represents a OML_O33_PATIENT_PRIOR group structure (a Group object).
...
public class OML_O33_PATIENT_PRIOR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OML_O33_PATIENT_PRIOR - this is probably a bug in the source code generator.", e);
       }
    }
