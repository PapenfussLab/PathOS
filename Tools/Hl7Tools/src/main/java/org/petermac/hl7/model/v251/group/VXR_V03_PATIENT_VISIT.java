...
/**
 * <p>Represents a VXR_V03_PATIENT_VISIT group structure (a Group object).
...
public class VXR_V03_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new VXR_V03_PATIENT_VISIT group
     */
    public VXR_V03_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating VXR_V03_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
