...
/**
 * <p>Represents a RSP_Z86_GIVE group structure (a Group object).
...
public class RSP_Z86_GIVE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z86_GIVE - this is probably a bug in the source code generator.", e);
       }
    }
