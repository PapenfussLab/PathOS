...
/**
 * <p>Represents a MFN_M10_MF_TEST_BATT_DETAIL group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OM5 (Observation Batteries (Sets)) <b>  </b></li>
                         * <li>2: OM4 (Observations that Require Specimens) <b>optional repeating </b></li>
 * </ul>
 */
...
public class MFN_M10_MF_TEST_BATT_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(OM5.class, true, false, false);
                                  this.add(OM4.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating MFN_M10_MF_TEST_BATT_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * OM5 (Observation Batteries (Sets)) - creates it if necessary
     */
    public OM5 getOM5() { 
       OM5 retVal = getTyped("OM5", OM5.class);
       return retVal;
    }
