...
/**
 * <p>Represents a OMS_O05_PATIENT_VISIT group structure (a Group object).
...
public class OMS_O05_PATIENT_VISIT extends AbstractGroup {
     ...
     */
    public OMS_O05_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMS_O05_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
