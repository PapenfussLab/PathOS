...
/**
 * <p>Represents a RRA_O18_PATIENT group structure (a Group object).
...
public class RRA_O18_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RRA_O18_PATIENT group
     */
    public RRA_O18_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRA_O18_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
