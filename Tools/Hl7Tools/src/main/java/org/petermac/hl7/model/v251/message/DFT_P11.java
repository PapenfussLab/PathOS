...
/**
 * <p>Represents a DFT_P11 message structure (see chapter 6.4.8). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>11: DFT_P11_COMMON_ORDER (a Group object) <b>optional repeating</b> </li>
		                 * <li>12: DG1 (Diagnosis) <b>optional repeating</b> </li>
		                 * <li>13: DRG (Diagnosis Related Group) <b>optional </b> </li>
		                 * <li>14: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>15: DFT_P11_INSURANCE (a Group object) <b>optional repeating</b> </li>
		                 * <li>16: ACC (Accident) <b>optional </b> </li>
		                 * <li>17: DFT_P11_FINANCIAL (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class DFT_P11 extends AbstractMessage  {

    /**
     * Creates a new DFT_P11 message with DefaultModelClassFactory. 
     */ 
    public DFT_P11() { 
    ...
    /** 
     * Creates a new DFT_P11 message with custom ModelClassFactory.
     */
    public DFT_P11(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(DFT_P11_COMMON_ORDER.class, false, true);
	                          this.add(DG1.class, false, true);
	                          this.add(DRG.class, false, false);
	                          this.add(GT1.class, false, true);
	                          this.add(DFT_P11_INSURANCE.class, false, true);
	                          this.add(ACC.class, false, false);
	                          this.add(DFT_P11_FINANCIAL.class, true, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating DFT_P11 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public DFT_P11_COMMON_ORDER getCOMMON_ORDER() { 
       return getTyped("COMMON_ORDER", DFT_P11_COMMON_ORDER.class);
    }
    ...
    public DFT_P11_COMMON_ORDER getCOMMON_ORDER(int rep) { 
       return getTyped("COMMON_ORDER", rep, DFT_P11_COMMON_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<DFT_P11_COMMON_ORDER> getCOMMON_ORDERAll() throws HL7Exception {
    	return getAllAsList("COMMON_ORDER", DFT_P11_COMMON_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertCOMMON_ORDER(DFT_P11_COMMON_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public DFT_P11_COMMON_ORDER insertCOMMON_ORDER(int rep) throws HL7Exception { 
       return (DFT_P11_COMMON_ORDER)super.insertRepetition("COMMON_ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public DFT_P11_COMMON_ORDER removeCOMMON_ORDER(int rep) throws HL7Exception { 
       return (DFT_P11_COMMON_ORDER)super.removeRepetition("COMMON_ORDER", rep);
    }
    ...
    public DFT_P11_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", DFT_P11_INSURANCE.class);
    }
    ...
    public DFT_P11_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, DFT_P11_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<DFT_P11_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", DFT_P11_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(DFT_P11_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public DFT_P11_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (DFT_P11_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public DFT_P11_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (DFT_P11_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
    ...
    public DFT_P11_FINANCIAL getFINANCIAL() { 
       return getTyped("FINANCIAL", DFT_P11_FINANCIAL.class);
    }
    ...
    public DFT_P11_FINANCIAL getFINANCIAL(int rep) { 
       return getTyped("FINANCIAL", rep, DFT_P11_FINANCIAL.class);
    }
     ...
     * 
     */ 
    public java.util.List<DFT_P11_FINANCIAL> getFINANCIALAll() throws HL7Exception {
    	return getAllAsList("FINANCIAL", DFT_P11_FINANCIAL.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertFINANCIAL(DFT_P11_FINANCIAL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public DFT_P11_FINANCIAL insertFINANCIAL(int rep) throws HL7Exception { 
       return (DFT_P11_FINANCIAL)super.insertRepetition("FINANCIAL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public DFT_P11_FINANCIAL removeFINANCIAL(int rep) throws HL7Exception { 
       return (DFT_P11_FINANCIAL)super.removeRepetition("FINANCIAL", rep);
    }
