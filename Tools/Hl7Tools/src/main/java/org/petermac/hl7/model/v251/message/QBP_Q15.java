...
/**
 * <p>Represents a QBP_Q15 message structure (see chapter 5.3.3.3). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: QPD (Query Parameter Definition) <b> </b> </li>
		                 * <li>4: RCP (Response Control Parameter) <b> </b> </li>
		                 * <li>5: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class QBP_Q15 extends AbstractMessage  {

    /**
     * Creates a new QBP_Q15 message with DefaultModelClassFactory. 
     */ 
    public QBP_Q15() { 
    ...
    /** 
     * Creates a new QBP_Q15 message with custom ModelClassFactory.
     */
    public QBP_Q15(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating QBP_Q15 - this is probably a bug in the source code generator.", e);
       }
    }
