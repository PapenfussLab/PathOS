...
public class EAR_U08 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating EAR_U08 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public EAR_U08_COMMAND_RESPONSE getCOMMAND_RESPONSE() { 
       return getTyped("COMMAND_RESPONSE", EAR_U08_COMMAND_RESPONSE.class);
    }
    ...
    public EAR_U08_COMMAND_RESPONSE getCOMMAND_RESPONSE(int rep) { 
       return getTyped("COMMAND_RESPONSE", rep, EAR_U08_COMMAND_RESPONSE.class);
    }
    ...
    public int getCOMMAND_RESPONSEReps() { 
    	return getReps("COMMAND_RESPONSE");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of COMMAND_RESPONSE.
     * <p>
     * <p>
     * Note that unlike {@link #getCOMMAND_RESPONSE()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<EAR_U08_COMMAND_RESPONSE> getCOMMAND_RESPONSEAll() throws HL7Exception {
    	return getAllAsList("COMMAND_RESPONSE", EAR_U08_COMMAND_RESPONSE.class);
    } 
