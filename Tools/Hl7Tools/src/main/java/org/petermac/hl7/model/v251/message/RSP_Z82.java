...
/**
 * <p>Represents a RSP_Z82 message structure (see chapter 5.9.1.1.1). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>8: RSP_Z82_QUERY_RESPONSE (a Group object) <b> repeating</b> </li>
...
public class RSP_Z82 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RSP_Z82_QUERY_RESPONSE.class, true, true);
	                          this.add(DSC.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z82 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RSP_Z82_QUERY_RESPONSE getQUERY_RESPONSE() { 
       return getTyped("QUERY_RESPONSE", RSP_Z82_QUERY_RESPONSE.class);
    }
    ...
    public RSP_Z82_QUERY_RESPONSE getQUERY_RESPONSE(int rep) { 
       return getTyped("QUERY_RESPONSE", rep, RSP_Z82_QUERY_RESPONSE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RSP_Z82_QUERY_RESPONSE> getQUERY_RESPONSEAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertQUERY_RESPONSE(RSP_Z82_QUERY_RESPONSE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RSP_Z82_QUERY_RESPONSE insertQUERY_RESPONSE(int rep) throws HL7Exception { 
       return (RSP_Z82_QUERY_RESPONSE)super.insertRepetition("QUERY_RESPONSE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RSP_Z82_QUERY_RESPONSE removeQUERY_RESPONSE(int rep) throws HL7Exception { 
       return (RSP_Z82_QUERY_RESPONSE)super.removeRepetition("QUERY_RESPONSE", rep);
    }
