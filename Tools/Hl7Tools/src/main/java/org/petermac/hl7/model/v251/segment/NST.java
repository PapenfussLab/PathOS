    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, false, 1, 30, new Object[]{ getMessage() }, "Source Identifier");
                                              this.add(ID.class, false, 1, 3, new Object[]{ getMessage(), new Integer(332) }, "Source Type");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Statistics Start");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Statistics End");
                                  ...
                                  this.add(NM.class, false, 1, 10, new Object[]{ getMessage() }, "Application control-level Errors");
