...
/**
 * <p>Represents a QRY_R02 message structure (see chapter 7.3.3). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: QRD (Original-Style Query Definition) <b> </b> </li>
		                 * <li>4: QRF (Original style query filter) <b> </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class QRY_R02 extends AbstractMessage  {

    /**
     * Creates a new QRY_R02 message with DefaultModelClassFactory. 
     */ 
    public QRY_R02() { 
    ...
    /** 
     * Creates a new QRY_R02 message with custom ModelClassFactory.
     */
    public QRY_R02(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
