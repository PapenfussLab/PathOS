...
/**
 * <p>Represents a RER_RER_PATIENT group structure (a Group object).
...
public class RER_RER_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RER_RER_PATIENT group
     */
    public RER_RER_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RER_RER_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
