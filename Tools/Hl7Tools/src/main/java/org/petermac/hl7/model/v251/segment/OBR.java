    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Universal Service Identifier");
                                              this.add(ID.class, false, 1, 2, new Object[]{ getMessage(), new Integer(0) }, "Priority - OBR");
                                  ...
                                  this.add(XTN.class, false, 2, 250, new Object[]{ getMessage() }, "Order Callback Phone Number");
