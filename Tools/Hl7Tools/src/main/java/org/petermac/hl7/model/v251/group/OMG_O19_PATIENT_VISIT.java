...
/**
 * <p>Represents a OMG_O19_PATIENT_VISIT group structure (a Group object).
...
public class OMG_O19_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new OMG_O19_PATIENT_VISIT group
     */
    public OMG_O19_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMG_O19_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
