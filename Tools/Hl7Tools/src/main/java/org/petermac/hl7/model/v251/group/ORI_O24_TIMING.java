...
/**
 * <p>Represents a ORI_O24_TIMING group structure (a Group object).
...
public class ORI_O24_TIMING extends AbstractGroup {

    /** 
     * Creates a new ORI_O24_TIMING group
     */
    public ORI_O24_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORI_O24_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
