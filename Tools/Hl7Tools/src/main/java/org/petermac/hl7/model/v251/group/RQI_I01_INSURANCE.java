...
/**
 * <p>Represents a RQI_I01_INSURANCE group structure (a Group object).
...
public class RQI_I01_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new RQI_I01_INSURANCE group
     */
    public RQI_I01_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQI_I01_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
