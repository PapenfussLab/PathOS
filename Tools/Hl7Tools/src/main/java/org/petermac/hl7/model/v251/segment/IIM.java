 ...
 * <ul>
     ...
     * <li>IIM-4: Inventory Expiration Date (TS) <b>optional </b>
     * <li>IIM-5: Inventory Manufacturer Name (CWE) <b>optional </b>
     * <li>IIM-6: Inventory Location (CWE) <b>optional </b>
     * <li>IIM-7: Inventory Received Date (TS) <b>optional </b>
     ...
     * <li>IIM-11: Inventory On Hand Date (TS) <b>optional </b>
     * <li>IIM-12: Inventory On Hand Quantity (NM) <b>optional </b>
     * <li>IIM-13: Inventory On Hand Quantity Unit (CWE) <b>optional </b>
     * <li>IIM-14: Procedure Code (CE) <b>optional </b>
     * <li>IIM-15: Procedure Code Modifier (CE) <b>optional repeating</b>
 * </ul>
 */
...
public class IIM extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Primary Key Value - IIM");
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Service Item Code");
                                  this.add(ST.class, false, 1, 250, new Object[]{ getMessage() }, "Inventory Lot Number");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Inventory Expiration Date");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Inventory Manufacturer Name");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Inventory Location");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Inventory Received Date");
                                  this.add(NM.class, false, 1, 12, new Object[]{ getMessage() }, "Inventory Received Quantity");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Inventory Received Quantity Unit");
                                  this.add(MO.class, false, 1, 12, new Object[]{ getMessage() }, "Inventory Received Item Cost");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Inventory On Hand Date");
                                  this.add(NM.class, false, 1, 12, new Object[]{ getMessage() }, "Inventory On Hand Quantity");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Inventory On Hand Quantity Unit");
    ...
    public TS getInventoryOnHandDate() { 
		TS retVal = this.getTypedField(11, 0);
		return retVal;
    }
