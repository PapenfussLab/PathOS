...
/**
 * <p>Represents a RSP_K31_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: AL1 (Patient Allergy Information) <b>optional repeating </b></li>
                         * <li>5: RSP_K31_PATIENT_VISIT (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_K31_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RSP_K31_PATIENT group
     */
    public RSP_K31_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RSP_K31_PATIENT_VISIT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_K31_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RSP_K31_PATIENT_VISIT getPATIENT_VISIT() { 
       RSP_K31_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", RSP_K31_PATIENT_VISIT.class);
       return retVal;
    }
