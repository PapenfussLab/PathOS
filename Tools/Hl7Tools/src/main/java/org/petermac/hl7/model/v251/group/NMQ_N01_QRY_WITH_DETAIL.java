...
/**
 * <p>Represents a NMQ_N01_QRY_WITH_DETAIL group structure (a Group object).
...
public class NMQ_N01_QRY_WITH_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating NMQ_N01_QRY_WITH_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
