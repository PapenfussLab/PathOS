...
/**
 * <p>Represents a RDS_O13_TIMING_ENCODED group structure (a Group object).
...
public class RDS_O13_TIMING_ENCODED extends AbstractGroup {

    /** 
     * Creates a new RDS_O13_TIMING_ENCODED group
     */
    public RDS_O13_TIMING_ENCODED(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDS_O13_TIMING_ENCODED - this is probably a bug in the source code generator.", e);
       }
    }
