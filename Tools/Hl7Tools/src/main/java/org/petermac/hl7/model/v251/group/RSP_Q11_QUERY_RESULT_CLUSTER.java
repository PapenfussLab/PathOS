...
/**
 * <p>Represents a RSP_Q11_QUERY_RESULT_CLUSTER group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: RSP_Q11_MF_LOC_DEPT (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RSP_Q11_QUERY_RESULT_CLUSTER extends AbstractGroup {
    ...
    public RSP_Q11_MF_LOC_DEPT getMF_LOC_DEPT() { 
       RSP_Q11_MF_LOC_DEPT retVal = getTyped("MF_LOC_DEPT", RSP_Q11_MF_LOC_DEPT.class);
       return retVal;
    }
    ...
    public RSP_Q11_MF_LOC_DEPT getMF_LOC_DEPT(int rep) { 
       RSP_Q11_MF_LOC_DEPT retVal = getTyped("MF_LOC_DEPT", rep, RSP_Q11_MF_LOC_DEPT.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RSP_Q11_MF_LOC_DEPT> getMF_LOC_DEPTAll() throws HL7Exception {
    	return getAllAsList("MF_LOC_DEPT", RSP_Q11_MF_LOC_DEPT.class);
    } 
