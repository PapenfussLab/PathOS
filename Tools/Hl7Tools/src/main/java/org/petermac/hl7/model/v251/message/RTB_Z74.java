 ...
 * <ul>
		                 ...
		                 * <li>7: RTB_Z74_ROW_DEFINITION (a Group object) <b>optional </b> </li>
		                 * <li>8: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RTB_Z74 extends AbstractMessage  {

    /**
     * Creates a new RTB_Z74 message with DefaultModelClassFactory. 
     */ 
    public RTB_Z74() { 
    ...
    /** 
     * Creates a new RTB_Z74 message with custom ModelClassFactory.
     */
    public RTB_Z74(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RTB_Z74_ROW_DEFINITION.class, false, false);
	                          this.add(DSC.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RTB_Z74 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RTB_Z74_ROW_DEFINITION getROW_DEFINITION() { 
       return getTyped("ROW_DEFINITION", RTB_Z74_ROW_DEFINITION.class);
    }
