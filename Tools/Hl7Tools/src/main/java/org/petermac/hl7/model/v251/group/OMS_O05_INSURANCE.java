...
/**
 * <p>Represents a OMS_O05_INSURANCE group structure (a Group object).
...
public class OMS_O05_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new OMS_O05_INSURANCE group
     */
    public OMS_O05_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMS_O05_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
