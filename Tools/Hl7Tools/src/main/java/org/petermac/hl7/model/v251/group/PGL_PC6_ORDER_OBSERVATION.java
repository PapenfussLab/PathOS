...
/**
 * <p>Represents a PGL_PC6_ORDER_OBSERVATION group structure (a Group object).
...
public class PGL_PC6_ORDER_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new PGL_PC6_ORDER_OBSERVATION group
     */
    public PGL_PC6_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PGL_PC6_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
