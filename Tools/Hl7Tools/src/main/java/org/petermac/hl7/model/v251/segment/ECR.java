 ...
 * <ul>
     * <li>ECR-1: Command Response (CE) <b> </b>
     * <li>ECR-2: Date/Time Completed (TS) <b> </b>
...
public class ECR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Command Response");
                                  this.add(TS.class, true, 1, 26, new Object[]{ getMessage() }, "Date/Time Completed");
