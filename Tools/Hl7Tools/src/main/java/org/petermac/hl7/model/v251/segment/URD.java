...
public class URD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, true, 0, 250, new Object[]{ getMessage() }, "R/U Who Subject Definition");
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "R/U What Subject Definition");
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "R/U What Department Code");
