...
/**
 * <p>Represents a QRY_Q01 message structure (see chapter 4.13.15). This structure contains the 
...
public class QRY_Q01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating QRY_Q01 - this is probably a bug in the source code generator.", e);
       }
    }
