...
/**
 * <p>Represents a RAR_RAR_PATIENT group structure (a Group object).
...
public class RAR_RAR_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RAR_RAR_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
