...
/**
 * <p>Represents a BPS_O29_PATIENT_VISIT group structure (a Group object).
...
public class BPS_O29_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new BPS_O29_PATIENT_VISIT group
     */
    public BPS_O29_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating BPS_O29_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
