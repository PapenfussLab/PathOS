...
/**
 * <p>Represents a ADT_A05 message structure (see chapter 3.3.5). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>16: ADT_A05_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>17: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>18: ADT_A05_INSURANCE (a Group object) <b>optional repeating</b> </li>
		                 * <li>19: ACC (Accident) <b>optional </b> </li>
		                 * <li>20: UB1 (UB82) <b>optional </b> </li>
		                 * <li>21: UB2 (UB92 Data) <b>optional </b> </li>
 * </ul>
 */
...
public class ADT_A05 extends AbstractMessage  {
    ...
    public ADT_A05_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", ADT_A05_PROCEDURE.class);
    }
    ...
    public ADT_A05_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, ADT_A05_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A05_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", ADT_A05_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(ADT_A05_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A05_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A05_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A05_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A05_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public ADT_A05_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", ADT_A05_INSURANCE.class);
    }
    ...
    public ADT_A05_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, ADT_A05_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A05_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", ADT_A05_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A05_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A05_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A05_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A05_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
