...
/**
 * <p>Represents a ORR_O02_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: OBR (Observation Request) <b>  choice</b></li>
                         * <li>3: RQD (Requisition Detail) <b>  choice</b></li>
                         * <li>4: RQ1 (Requisition Detail-1) <b>  choice</b></li>
                         * <li>5: RXO (Pharmacy/Treatment Order) <b>  choice</b></li>
                         * <li>6: ODS (Dietary Orders, Supplements, and Preferences) <b>  choice</b></li>
                         * <li>7: ODT (Diet Tray Instructions) <b>  choice</b></li>
...
public class ORR_O02_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORR_O02_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
