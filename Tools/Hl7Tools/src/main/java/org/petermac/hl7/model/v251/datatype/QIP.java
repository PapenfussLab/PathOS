 ...
 * 
 * The Original Code is "QIP.java".  Description:
 * "Composite class QIP"
 * 
...
/**
 * <p>Represents an HL7 QIP (Query Input Parameter List) data type. 
...
public class QIP extends AbstractComposite {
    ...
    /**
     * Returns Values (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public ST getValues() {
