 ...
 * <ul>
		                 ...
		                 * <li>6: ORG_O20_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
...
public class ORG_O20 extends AbstractMessage  {
    ...
    /**
     * Creates a new ORG_O20 message with DefaultModelClassFactory. 
     */ 
    public ORG_O20() { 
    ...
    /** 
     * Creates a new ORG_O20 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORG_O20 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORG_O20_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORG_O20_RESPONSE.class);
    }
