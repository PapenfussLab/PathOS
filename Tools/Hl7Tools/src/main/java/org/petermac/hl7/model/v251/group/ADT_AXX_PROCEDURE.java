...
/**
 * <p>Represents a ADT_AXX_PROCEDURE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PR1 () <b>  </b></li>
                         * <li>2: ROL () <b>optional repeating </b></li>
 * </ul>
 */
...
public class ADT_AXX_PROCEDURE extends AbstractGroup {
    ...
    /** 
     * Creates a new ADT_AXX_PROCEDURE group
     */
    public ADT_AXX_PROCEDURE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_AXX_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
