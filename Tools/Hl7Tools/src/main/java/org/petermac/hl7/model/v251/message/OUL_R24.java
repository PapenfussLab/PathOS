...
/**
 * <p>Represents a OUL_R24 message structure (see chapter 7.3.9). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: NTE (Notes and Comments) <b>optional </b> </li>
		                 * <li>4: OUL_R24_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>5: OUL_R24_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>6: OUL_R24_ORDER (a Group object) <b> repeating</b> </li>
		                 * <li>7: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OUL_R24 extends AbstractMessage  {

    /**
     * Creates a new OUL_R24 message with DefaultModelClassFactory. 
     */ 
    public OUL_R24() { 
    ...
    /** 
     * Creates a new OUL_R24 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R24 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OUL_R24_PATIENT getPATIENT() { 
       return getTyped("PATIENT", OUL_R24_PATIENT.class);
    }
    ...
    public OUL_R24_VISIT getVISIT() { 
       return getTyped("VISIT", OUL_R24_VISIT.class);
    }
    ...
    public OUL_R24_ORDER getORDER() { 
       return getTyped("ORDER", OUL_R24_ORDER.class);
    }
    ...
    public OUL_R24_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, OUL_R24_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<OUL_R24_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", OUL_R24_ORDER.class);
    } 
