...
/**
 * <p>Represents a RSP_Z88_COMPONENT group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXC (Pharmacy/Treatment Component Order) <b> repeating </b></li>
                         * <li>2: NTE (Notes and Comments) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_Z88_COMPONENT extends AbstractGroup {

    /** 
     * Creates a new RSP_Z88_COMPONENT group
     */
    public RSP_Z88_COMPONENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(RXC.class, true, true, false);
                                  this.add(NTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z88_COMPONENT - this is probably a bug in the source code generator.", e);
       }
    }
