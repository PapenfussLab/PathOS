 ...
 * <ul>
		                 ...
		                 * <li>6: ERQ (Event replay query) <b> </b> </li>
...
public class ERP_R09 extends AbstractMessage  {
    ...
    /**
     * Creates a new ERP_R09 message with DefaultModelClassFactory. 
     */ 
    public ERP_R09() { 
    ...
    /** 
     * Creates a new ERP_R09 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ERP_R09 - this is probably a bug in the source code generator.", e);
       }
    }
