...
/**
 * <p>Represents a RDS_O13_ENCODING group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RDS_O13_TIMING_ENCODED (a Group object) <b> repeating </b></li>
...
public class RDS_O13_ENCODING extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDS_O13_TIMING_ENCODED.class, true, true, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDS_O13_ENCODING - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDS_O13_TIMING_ENCODED getTIMING_ENCODED() { 
       RDS_O13_TIMING_ENCODED retVal = getTyped("TIMING_ENCODED", RDS_O13_TIMING_ENCODED.class);
       return retVal;
    }
    ...
    public RDS_O13_TIMING_ENCODED getTIMING_ENCODED(int rep) { 
       RDS_O13_TIMING_ENCODED retVal = getTyped("TIMING_ENCODED", rep, RDS_O13_TIMING_ENCODED.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDS_O13_TIMING_ENCODED> getTIMING_ENCODEDAll() throws HL7Exception {
    	return getAllAsList("TIMING_ENCODED", RDS_O13_TIMING_ENCODED.class);
    } 
