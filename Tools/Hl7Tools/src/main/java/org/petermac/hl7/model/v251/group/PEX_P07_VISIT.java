...
/**
 * <p>Represents a PEX_P07_VISIT group structure (a Group object).
...
public class PEX_P07_VISIT extends AbstractGroup {

    /** 
     * Creates a new PEX_P07_VISIT group
     */
    public PEX_P07_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P07_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
