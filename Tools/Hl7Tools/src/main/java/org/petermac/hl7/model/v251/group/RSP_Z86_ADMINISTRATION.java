...
/**
 * <p>Represents a RSP_Z86_ADMINISTRATION group structure (a Group object).
...
public class RSP_Z86_ADMINISTRATION extends AbstractGroup {
     ...
     */
    public RSP_Z86_ADMINISTRATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z86_ADMINISTRATION - this is probably a bug in the source code generator.", e);
       }
    }
