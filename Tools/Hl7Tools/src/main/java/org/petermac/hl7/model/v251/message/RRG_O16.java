...
/**
 * <p>Represents a RRG_O16 message structure (see chapter 4.13.10). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: RRG_O16_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RRG_O16 extends AbstractMessage  {

    /**
     * Creates a new RRG_O16 message with DefaultModelClassFactory. 
     */ 
    public RRG_O16() { 
    ...
    /** 
     * Creates a new RRG_O16 message with custom ModelClassFactory.
     */
    public RRG_O16(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RRG_O16_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRG_O16 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RRG_O16_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", RRG_O16_RESPONSE.class);
    }
