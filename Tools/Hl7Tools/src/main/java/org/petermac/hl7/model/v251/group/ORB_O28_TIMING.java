...
/**
 * <p>Represents a ORB_O28_TIMING group structure (a Group object).
...
public class ORB_O28_TIMING extends AbstractGroup {

    /** 
     * Creates a new ORB_O28_TIMING group
     */
    public ORB_O28_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORB_O28_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
