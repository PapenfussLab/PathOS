 ...
 * <ul>
		                 ...
		                 * <li>4: SSR_U04_SPECIMEN_CONTAINER (a Group object) <b> repeating</b> </li>
...
public class SSR_U04 extends AbstractMessage  {
    ...
    public SSR_U04_SPECIMEN_CONTAINER getSPECIMEN_CONTAINER() { 
       return getTyped("SPECIMEN_CONTAINER", SSR_U04_SPECIMEN_CONTAINER.class);
    }
    ...
    public SSR_U04_SPECIMEN_CONTAINER getSPECIMEN_CONTAINER(int rep) { 
       return getTyped("SPECIMEN_CONTAINER", rep, SSR_U04_SPECIMEN_CONTAINER.class);
    }
     ...
     * 
     */ 
    public java.util.List<SSR_U04_SPECIMEN_CONTAINER> getSPECIMEN_CONTAINERAll() throws HL7Exception {
    	return getAllAsList("SPECIMEN_CONTAINER", SSR_U04_SPECIMEN_CONTAINER.class);
    } 
