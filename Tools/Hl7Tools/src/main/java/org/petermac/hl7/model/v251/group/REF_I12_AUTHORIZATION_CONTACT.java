...
/**
 * <p>Represents a REF_I12_AUTHORIZATION_CONTACT group structure (a Group object).
...
public class REF_I12_AUTHORIZATION_CONTACT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating REF_I12_AUTHORIZATION_CONTACT - this is probably a bug in the source code generator.", e);
       }
    }
