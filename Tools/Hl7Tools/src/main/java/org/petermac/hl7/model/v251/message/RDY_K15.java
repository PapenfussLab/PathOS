...
/**
 * <p>Represents a RDY_K15 message structure (see chapter 5.3.2.5). This structure contains the 
...
public class RDY_K15 extends AbstractMessage  {

    /**
     * Creates a new RDY_K15 message with DefaultModelClassFactory. 
     */ 
    public RDY_K15() { 
    ...
    /** 
     * Creates a new RDY_K15 message with custom ModelClassFactory.
     */
    public RDY_K15(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDY_K15 - this is probably a bug in the source code generator.", e);
       }
    }
