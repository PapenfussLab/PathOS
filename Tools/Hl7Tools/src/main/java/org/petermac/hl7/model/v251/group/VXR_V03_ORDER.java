...
/**
 * <p>Represents a VXR_V03_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: VXR_V03_TIMING (a Group object) <b>optional repeating </b></li>
                         * <li>3: RXA (Pharmacy/Treatment Administration) <b>  </b></li>
                         * <li>4: RXR (Pharmacy/Treatment Route) <b>optional  </b></li>
                         * <li>5: VXR_V03_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class VXR_V03_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating VXR_V03_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public VXR_V03_TIMING getTIMING() { 
       VXR_V03_TIMING retVal = getTyped("TIMING", VXR_V03_TIMING.class);
       return retVal;
    }
    ...
    public VXR_V03_TIMING getTIMING(int rep) { 
       VXR_V03_TIMING retVal = getTyped("TIMING", rep, VXR_V03_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<VXR_V03_TIMING> getTIMINGAll() throws HL7Exception {
    	return getAllAsList("TIMING", VXR_V03_TIMING.class);
    } 
    ...
    public VXR_V03_OBSERVATION getOBSERVATION() { 
       VXR_V03_OBSERVATION retVal = getTyped("OBSERVATION", VXR_V03_OBSERVATION.class);
       return retVal;
    }
    ...
    public VXR_V03_OBSERVATION getOBSERVATION(int rep) { 
       VXR_V03_OBSERVATION retVal = getTyped("OBSERVATION", rep, VXR_V03_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<VXR_V03_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", VXR_V03_OBSERVATION.class);
    } 
