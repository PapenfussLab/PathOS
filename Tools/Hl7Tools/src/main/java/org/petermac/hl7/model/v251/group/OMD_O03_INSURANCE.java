...
/**
 * <p>Represents a OMD_O03_INSURANCE group structure (a Group object).
...
public class OMD_O03_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new OMD_O03_INSURANCE group
     */
    public OMD_O03_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMD_O03_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
