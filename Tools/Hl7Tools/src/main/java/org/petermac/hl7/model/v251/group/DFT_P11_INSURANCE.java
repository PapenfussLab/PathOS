...
/**
 * <p>Represents a DFT_P11_INSURANCE group structure (a Group object).
...
public class DFT_P11_INSURANCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating DFT_P11_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
