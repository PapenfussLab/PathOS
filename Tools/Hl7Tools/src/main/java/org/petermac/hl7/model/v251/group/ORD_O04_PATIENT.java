...
/**
 * <p>Represents a ORD_O04_PATIENT group structure (a Group object).
...
public class ORD_O04_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ORD_O04_PATIENT group
     */
    public ORD_O04_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORD_O04_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
