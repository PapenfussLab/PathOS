...
/**
 * <p>Represents a SQR_S25_LOCATION_RESOURCE group structure (a Group object).
...
public class SQR_S25_LOCATION_RESOURCE extends AbstractGroup {

    /** 
     * Creates a new SQR_S25_LOCATION_RESOURCE group
     */
    public SQR_S25_LOCATION_RESOURCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SQR_S25_LOCATION_RESOURCE - this is probably a bug in the source code generator.", e);
       }
    }
