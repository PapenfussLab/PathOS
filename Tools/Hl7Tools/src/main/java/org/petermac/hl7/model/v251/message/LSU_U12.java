 ...
 * <ul>
		                 ...
		                 * <li>4: EQP (Equipment/log Service) <b> repeating</b> </li>
...
public class LSU_U12 extends AbstractMessage  {
    ...
    public EQP getEQP(int rep) { 
       return getTyped("EQP", rep, EQP.class);
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getEQP()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<EQP> getEQPAll() throws HL7Exception {
