...
/**
 * <p>Represents a RSP_K31_RESPONSE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RSP_K31_PATIENT (a Group object) <b>optional  </b></li>
                         * <li>2: RSP_K31_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RSP_K31_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(RSP_K31_PATIENT.class, false, false, false);
                                  this.add(RSP_K31_ORDER.class, true, true, false);
    ...
    public RSP_K31_PATIENT getPATIENT() { 
       RSP_K31_PATIENT retVal = getTyped("PATIENT", RSP_K31_PATIENT.class);
       return retVal;
    }
    ...
    public RSP_K31_ORDER getORDER() { 
       RSP_K31_ORDER retVal = getTyped("ORDER", RSP_K31_ORDER.class);
       return retVal;
    }
    ...
    public RSP_K31_ORDER getORDER(int rep) { 
       RSP_K31_ORDER retVal = getTyped("ORDER", rep, RSP_K31_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RSP_K31_ORDER> getORDERAll() throws HL7Exception {
     ...
     */
    public void insertORDER(RSP_K31_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RSP_K31_ORDER insertORDER(int rep) throws HL7Exception { 
       return (RSP_K31_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     */
    public RSP_K31_ORDER removeORDER(int rep) throws HL7Exception { 
       return (RSP_K31_ORDER)super.removeRepetition("ORDER", rep);
    }
