...
/**
 * <p>Represents a RRG_O16_TIMING_GIVE group structure (a Group object).
...
public class RRG_O16_TIMING_GIVE extends AbstractGroup {

    /** 
     * Creates a new RRG_O16_TIMING_GIVE group
     */
    public RRG_O16_TIMING_GIVE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRG_O16_TIMING_GIVE - this is probably a bug in the source code generator.", e);
       }
    }
