 ...
 * 
 * The Original Code is "QSC.java".  Description:
 * "Composite class QSC"
 * 
...
/**
 * <p>Represents an HL7 QSC (Query Selection Criteria) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>Segment Field Name (ST)
 * <li>Relational Operator (ID)
 * <li>Value (ST)
 * <li>Relational Conjunction (ID)
 * </ul>
 */
...
public class QSC extends AbstractComposite {
    ...
    private void init() {
        ...
        data[1] = new ID(getMessage(), 209);
        data[2] = new ST(getMessage());
        data[3] = new ID(getMessage(), 210);
    }
    ...
    /**
     * Returns Relational Operator (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    ...
    /**
     * Returns Value (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public ST getValue() {
    ...
    /**
     * Returns Relational Conjunction (component 4).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
