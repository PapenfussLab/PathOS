...
/**
 * <p>Represents a QCK_Q02 message structure (see chapter ?). This structure contains the 
...
public class QCK_Q02 extends AbstractMessage  {
    ...
    /**
     * Creates a new QCK_Q02 message with DefaultModelClassFactory. 
     */ 
    public QCK_Q02() { 
    ...
    /** 
     * Creates a new QCK_Q02 message with custom ModelClassFactory.
     */
    public QCK_Q02(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
