...
/**
 * <p>Represents a DFT_P11_FINANCIAL_INSURANCE group structure (a Group object).
...
public class DFT_P11_FINANCIAL_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new DFT_P11_FINANCIAL_INSURANCE group
     */
    public DFT_P11_FINANCIAL_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating DFT_P11_FINANCIAL_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
