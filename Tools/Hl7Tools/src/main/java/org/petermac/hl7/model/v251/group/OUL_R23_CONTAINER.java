...
/**
 * <p>Represents a OUL_R23_CONTAINER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: SAC (Specimen Container detail) <b>  </b></li>
                         * <li>2: INV (Inventory Detail) <b>optional  </b></li>
                         * <li>3: OUL_R23_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class OUL_R23_CONTAINER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R23_CONTAINER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public INV getINV() { 
       INV retVal = getTyped("INV", INV.class);
       return retVal;
    }
    ...
    public OUL_R23_ORDER getORDER() { 
       OUL_R23_ORDER retVal = getTyped("ORDER", OUL_R23_ORDER.class);
       return retVal;
    }
    ...
    public OUL_R23_ORDER getORDER(int rep) { 
       OUL_R23_ORDER retVal = getTyped("ORDER", rep, OUL_R23_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OUL_R23_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", OUL_R23_ORDER.class);
    } 
