...
public class QRY extends AbstractMessage  {

    /**
     * Creates a new QRY message with DefaultModelClassFactory. 
     */ 
    public QRY() { 
    ...
    /** 
     * Creates a new QRY message with custom ModelClassFactory.
     */
    public QRY(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating QRY - this is probably a bug in the source code generator.", e);
       }
    }
