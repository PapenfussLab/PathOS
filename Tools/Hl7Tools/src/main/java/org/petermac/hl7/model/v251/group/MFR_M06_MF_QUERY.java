...
public class MFR_M06_MF_QUERY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CM1.class, false, true, false);
                                  this.add(CM2.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating MFR_M06_MF_QUERY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CM1 getCM1(int rep) { 
       CM1 retVal = getTyped("CM1", rep, CM1.class);
       return retVal;
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getCM1()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<CM1> getCM1All() throws HL7Exception {
    	return getAllAsList("CM1", CM1.class);
    } 
