...
/**
 * <p>Represents a RSP_Z90_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: NK1 (Next of Kin / Associated Parties) <b>optional repeating </b></li>
                         * <li>4: NTE (Notes and Comments) <b>optional repeating </b></li>
                         * <li>5: RSP_Z90_VISIT (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_Z90_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RSP_Z90_PATIENT group
     */
    public RSP_Z90_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RSP_Z90_VISIT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z90_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RSP_Z90_VISIT getVISIT() { 
       RSP_Z90_VISIT retVal = getTyped("VISIT", RSP_Z90_VISIT.class);
       return retVal;
    }
