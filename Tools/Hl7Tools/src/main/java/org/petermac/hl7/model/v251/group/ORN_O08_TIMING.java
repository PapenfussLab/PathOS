...
/**
 * <p>Represents a ORN_O08_TIMING group structure (a Group object).
...
public class ORN_O08_TIMING extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORN_O08_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
