...
/**
 * <p>Represents a PPV_PCA_PROBLEM_ROLE group structure (a Group object).
...
public class PPV_PCA_PROBLEM_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPV_PCA_PROBLEM_ROLE group
     */
    public PPV_PCA_PROBLEM_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPV_PCA_PROBLEM_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
