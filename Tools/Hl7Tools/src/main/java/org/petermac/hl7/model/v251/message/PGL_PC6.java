 ...
 * <ul>
		                 ...
		                 * <li>4: PGL_PC6_PATIENT_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>5: PGL_PC6_GOAL (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PGL_PC6 extends AbstractMessage  {
    ...
    /**
     * Creates a new PGL_PC6 message with DefaultModelClassFactory. 
     */ 
    public PGL_PC6() { 
    ...
    /** 
     * Creates a new PGL_PC6 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PGL_PC6 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PGL_PC6_PATIENT_VISIT getPATIENT_VISIT() { 
       return getTyped("PATIENT_VISIT", PGL_PC6_PATIENT_VISIT.class);
    }
    ...
    public PGL_PC6_GOAL getGOAL() { 
       return getTyped("GOAL", PGL_PC6_GOAL.class);
    }
    ...
    public PGL_PC6_GOAL getGOAL(int rep) { 
       return getTyped("GOAL", rep, PGL_PC6_GOAL.class);
    }
     ...
     * 
     */ 
    public java.util.List<PGL_PC6_GOAL> getGOALAll() throws HL7Exception {
    	return getAllAsList("GOAL", PGL_PC6_GOAL.class);
    } 
