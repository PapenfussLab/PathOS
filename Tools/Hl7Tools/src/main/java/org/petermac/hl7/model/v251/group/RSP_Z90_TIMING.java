...
/**
 * <p>Represents a RSP_Z90_TIMING group structure (a Group object).
...
public class RSP_Z90_TIMING extends AbstractGroup {

    /** 
     * Creates a new RSP_Z90_TIMING group
     */
    public RSP_Z90_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z90_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
