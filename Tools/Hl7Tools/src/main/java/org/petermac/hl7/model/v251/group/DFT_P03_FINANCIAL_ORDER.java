...
/**
 * <p>Represents a DFT_P03_FINANCIAL_ORDER group structure (a Group object).
...
public class DFT_P03_FINANCIAL_ORDER extends AbstractGroup {

    /** 
     * Creates a new DFT_P03_FINANCIAL_ORDER group
     */
    public DFT_P03_FINANCIAL_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating DFT_P03_FINANCIAL_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
