...
public class TCU_U10_TEST_CONFIGURATION extends AbstractGroup {
     ...
     */
    public TCC getTCC() { 
       TCC retVal = getTyped("TCC", TCC.class);
       return retVal;
    }
    ...
    public TCC getTCC(int rep) { 
       TCC retVal = getTyped("TCC", rep, TCC.class);
       return retVal;
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getTCC()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<TCC> getTCCAll() throws HL7Exception {
