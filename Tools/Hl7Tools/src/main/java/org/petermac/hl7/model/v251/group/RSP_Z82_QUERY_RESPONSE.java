...
/**
 * <p>Represents a RSP_Z82_QUERY_RESPONSE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RSP_Z82_PATIENT (a Group object) <b>optional  </b></li>
                         * <li>2: RSP_Z82_COMMON_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RSP_Z82_QUERY_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(RSP_Z82_PATIENT.class, false, false, false);
                                  this.add(RSP_Z82_COMMON_ORDER.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z82_QUERY_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RSP_Z82_PATIENT getPATIENT() { 
       RSP_Z82_PATIENT retVal = getTyped("PATIENT", RSP_Z82_PATIENT.class);
       return retVal;
    }
    ...
    public RSP_Z82_COMMON_ORDER getCOMMON_ORDER() { 
       RSP_Z82_COMMON_ORDER retVal = getTyped("COMMON_ORDER", RSP_Z82_COMMON_ORDER.class);
       return retVal;
    }
    ...
    public RSP_Z82_COMMON_ORDER getCOMMON_ORDER(int rep) { 
       RSP_Z82_COMMON_ORDER retVal = getTyped("COMMON_ORDER", rep, RSP_Z82_COMMON_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RSP_Z82_COMMON_ORDER> getCOMMON_ORDERAll() throws HL7Exception {
    	return getAllAsList("COMMON_ORDER", RSP_Z82_COMMON_ORDER.class);
    } 
