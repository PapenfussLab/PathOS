...
/**
 * <p>Represents a MFR_M04 message structure (see chapter 8.10.1). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>9: MFR_M04_MF_QUERY (a Group object) <b> repeating</b> </li>
...
public class MFR_M04 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFR_M04 message with DefaultModelClassFactory. 
     */ 
    public MFR_M04() { 
    ...
    /** 
     * Creates a new MFR_M04 message with custom ModelClassFactory.
     */
    public MFR_M04(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(MFR_M04_MF_QUERY.class, true, true);
	                          this.add(DSC.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating MFR_M04 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public MFR_M04_MF_QUERY getMF_QUERY() { 
       return getTyped("MF_QUERY", MFR_M04_MF_QUERY.class);
    }
    ...
    public MFR_M04_MF_QUERY getMF_QUERY(int rep) { 
       return getTyped("MF_QUERY", rep, MFR_M04_MF_QUERY.class);
    }
     ...
     * 
     */ 
    public java.util.List<MFR_M04_MF_QUERY> getMF_QUERYAll() throws HL7Exception {
    	return getAllAsList("MF_QUERY", MFR_M04_MF_QUERY.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertMF_QUERY(MFR_M04_MF_QUERY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public MFR_M04_MF_QUERY insertMF_QUERY(int rep) throws HL7Exception { 
       return (MFR_M04_MF_QUERY)super.insertRepetition("MF_QUERY", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public MFR_M04_MF_QUERY removeMF_QUERY(int rep) throws HL7Exception { 
       return (MFR_M04_MF_QUERY)super.removeRepetition("MF_QUERY", rep);
    }
