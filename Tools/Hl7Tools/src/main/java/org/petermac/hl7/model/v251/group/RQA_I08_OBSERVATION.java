...
/**
 * <p>Represents a RQA_I08_OBSERVATION group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RQA_I08_RESULTS (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RQA_I08_OBSERVATION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQA_I08_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RQA_I08_RESULTS getRESULTS() { 
       RQA_I08_RESULTS retVal = getTyped("RESULTS", RQA_I08_RESULTS.class);
       return retVal;
    }
    ...
    public RQA_I08_RESULTS getRESULTS(int rep) { 
       RQA_I08_RESULTS retVal = getTyped("RESULTS", rep, RQA_I08_RESULTS.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RQA_I08_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", RQA_I08_RESULTS.class);
    } 
