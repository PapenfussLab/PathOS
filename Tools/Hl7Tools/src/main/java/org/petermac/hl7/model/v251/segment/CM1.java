 ...
 * <ul>
     ...
     * <li>CM1-2: Study Phase Identifier (CE) <b> </b>
...
public class CM1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, true, 1, 300, new Object[]{ getMessage() }, "Description of Study Phase");
     ...
     * CM1-2: "Study Phase Identifier" - creates it if necessary
     */
    public CE getCm12_StudyPhaseIdentifier() { 
		CE retVal = this.getTypedField(2, 0);
		return retVal;
    }
