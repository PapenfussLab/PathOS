 ...
 * <ul>
     ...
     * <li>LCH-4: Location Characteristic ID (CE) <b> </b>
     * <li>LCH-5: Location Characteristic Value-LCH (CE) <b> </b>
 * </ul>
 */
...
public class LCH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Location Characteristic ID");
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Location Characteristic Value-LCH");
