 ...
 * <ul>
		                 ...
		                 * <li>7: RSP_K21_QUERY_RESPONSE (a Group object) <b>optional repeating</b> </li>
...
public class RSP_K21 extends AbstractMessage  {
    ...
    /**
     * Creates a new RSP_K21 message with DefaultModelClassFactory. 
     */ 
    public RSP_K21() { 
    ...
    /** 
     * Creates a new RSP_K21 message with custom ModelClassFactory.
     */
    ...
    public RSP_K21_QUERY_RESPONSE getQUERY_RESPONSE() { 
       return getTyped("QUERY_RESPONSE", RSP_K21_QUERY_RESPONSE.class);
    }
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertQUERY_RESPONSE(RSP_K21_QUERY_RESPONSE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RSP_K21_QUERY_RESPONSE insertQUERY_RESPONSE(int rep) throws HL7Exception { 
       return (RSP_K21_QUERY_RESPONSE)super.insertRepetition("QUERY_RESPONSE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RSP_K21_QUERY_RESPONSE removeQUERY_RESPONSE(int rep) throws HL7Exception { 
       return (RSP_K21_QUERY_RESPONSE)super.removeRepetition("QUERY_RESPONSE", rep);
    }
