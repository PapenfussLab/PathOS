...
public class PEX_P07_PEX_CAUSE extends AbstractGroup {
    ...
    public PEX_P07_RX_ORDER getRX_ORDER() { 
       PEX_P07_RX_ORDER retVal = getTyped("RX_ORDER", PEX_P07_RX_ORDER.class);
       return retVal;
    }
    ...
    public PEX_P07_RX_ADMINISTRATION getRX_ADMINISTRATION() { 
       PEX_P07_RX_ADMINISTRATION retVal = getTyped("RX_ADMINISTRATION", PEX_P07_RX_ADMINISTRATION.class);
       return retVal;
    }
    ...
    public PEX_P07_RX_ADMINISTRATION getRX_ADMINISTRATION(int rep) { 
       PEX_P07_RX_ADMINISTRATION retVal = getTyped("RX_ADMINISTRATION", rep, PEX_P07_RX_ADMINISTRATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PEX_P07_RX_ADMINISTRATION> getRX_ADMINISTRATIONAll() throws HL7Exception {
    ...
    public PEX_P07_ASSOCIATED_PERSON getASSOCIATED_PERSON() { 
       PEX_P07_ASSOCIATED_PERSON retVal = getTyped("ASSOCIATED_PERSON", PEX_P07_ASSOCIATED_PERSON.class);
       return retVal;
    }
    ...
    public PEX_P07_STUDY getSTUDY() { 
       PEX_P07_STUDY retVal = getTyped("STUDY", PEX_P07_STUDY.class);
       return retVal;
    }
    ...
    public PEX_P07_STUDY getSTUDY(int rep) { 
       PEX_P07_STUDY retVal = getTyped("STUDY", rep, PEX_P07_STUDY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PEX_P07_STUDY> getSTUDYAll() throws HL7Exception {
