...
/**
 * <p>Represents a OMG_O19_PATIENT_PRIOR group structure (a Group object).
...
public class OMG_O19_PATIENT_PRIOR extends AbstractGroup {

    /** 
     * Creates a new OMG_O19_PATIENT_PRIOR group
     */
    public OMG_O19_PATIENT_PRIOR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMG_O19_PATIENT_PRIOR - this is probably a bug in the source code generator.", e);
       }
    }
