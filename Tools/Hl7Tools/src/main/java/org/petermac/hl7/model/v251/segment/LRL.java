 ...
 * <ul>
     ...
     * <li>LRL-4: Location Relationship ID (CE) <b> </b>
...
public class LRL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(PL.class, true, 1, 200, new Object[]{ getMessage() }, "Primary Key Value - LRL");
                                  ...
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Location Relationship ID");
                                  this.add(XON.class, false, 0, 250, new Object[]{ getMessage() }, "Organizational Location Relationship Value");
