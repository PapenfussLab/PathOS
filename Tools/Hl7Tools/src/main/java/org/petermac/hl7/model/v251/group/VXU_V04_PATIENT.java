...
/**
 * <p>Represents a VXU_V04_PATIENT group structure (a Group object).
...
public class VXU_V04_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating VXU_V04_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
