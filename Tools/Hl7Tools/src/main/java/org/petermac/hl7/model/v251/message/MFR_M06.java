...
/**
 * <p>Represents a MFR_M06 message structure (see chapter 8.11.1). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>9: MFR_M06_MF_QUERY (a Group object) <b> repeating</b> </li>
		                 * <li>10: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class MFR_M06 extends AbstractMessage  {

    /**
     * Creates a new MFR_M06 message with DefaultModelClassFactory. 
     */ 
    public MFR_M06() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFR_M06 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public MFR_M06_MF_QUERY getMF_QUERY() { 
       return getTyped("MF_QUERY", MFR_M06_MF_QUERY.class);
    }
    ...
    public MFR_M06_MF_QUERY getMF_QUERY(int rep) { 
       return getTyped("MF_QUERY", rep, MFR_M06_MF_QUERY.class);
    }
     ...
     * 
     */ 
    public java.util.List<MFR_M06_MF_QUERY> getMF_QUERYAll() throws HL7Exception {
    	return getAllAsList("MF_QUERY", MFR_M06_MF_QUERY.class);
    } 
