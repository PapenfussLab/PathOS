...
/**
 * <p>Represents a PTR_PCF message structure (see chapter 12.3.10). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>7: PTR_PCF_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PTR_PCF extends AbstractMessage  {
    ...
    /**
     * Creates a new PTR_PCF message with DefaultModelClassFactory. 
     */ 
    public PTR_PCF() { 
    ...
    /** 
     * Creates a new PTR_PCF message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PTR_PCF - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PTR_PCF_PATIENT getPATIENT() { 
       return getTyped("PATIENT", PTR_PCF_PATIENT.class);
    }
    ...
    public PTR_PCF_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, PTR_PCF_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<PTR_PCF_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", PTR_PCF_PATIENT.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATIENT(PTR_PCF_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PTR_PCF_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (PTR_PCF_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PTR_PCF_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (PTR_PCF_PATIENT)super.removeRepetition("PATIENT", rep);
    }
