...
/**
 * <p>Represents a PRR_PC5_ORDER_OBSERVATION group structure (a Group object).
...
public class PRR_PC5_ORDER_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new PRR_PC5_ORDER_OBSERVATION group
     */
    public PRR_PC5_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PRR_PC5_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
