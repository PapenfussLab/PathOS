...
/**
 * <p>Represents a SQR_S25_RESOURCES group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RGS (Resource Group) <b>  </b></li>
                         * <li>2: SQR_S25_SERVICE (a Group object) <b>optional repeating </b></li>
                         * <li>3: SQR_S25_GENERAL_RESOURCE (a Group object) <b>optional repeating </b></li>
                         * <li>4: SQR_S25_PERSONNEL_RESOURCE (a Group object) <b>optional repeating </b></li>
                         * <li>5: SQR_S25_LOCATION_RESOURCE (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class SQR_S25_RESOURCES extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SQR_S25_RESOURCES - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SQR_S25_SERVICE getSERVICE() { 
       SQR_S25_SERVICE retVal = getTyped("SERVICE", SQR_S25_SERVICE.class);
       return retVal;
    }
    ...
    public SQR_S25_SERVICE getSERVICE(int rep) { 
       SQR_S25_SERVICE retVal = getTyped("SERVICE", rep, SQR_S25_SERVICE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQR_S25_SERVICE> getSERVICEAll() throws HL7Exception {
    	return getAllAsList("SERVICE", SQR_S25_SERVICE.class);
    } 
    ...
    public SQR_S25_GENERAL_RESOURCE getGENERAL_RESOURCE() { 
       SQR_S25_GENERAL_RESOURCE retVal = getTyped("GENERAL_RESOURCE", SQR_S25_GENERAL_RESOURCE.class);
       return retVal;
    }
    ...
    public SQR_S25_GENERAL_RESOURCE getGENERAL_RESOURCE(int rep) { 
       SQR_S25_GENERAL_RESOURCE retVal = getTyped("GENERAL_RESOURCE", rep, SQR_S25_GENERAL_RESOURCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQR_S25_GENERAL_RESOURCE> getGENERAL_RESOURCEAll() throws HL7Exception {
    	return getAllAsList("GENERAL_RESOURCE", SQR_S25_GENERAL_RESOURCE.class);
    } 
    ...
    public SQR_S25_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE() { 
       SQR_S25_PERSONNEL_RESOURCE retVal = getTyped("PERSONNEL_RESOURCE", SQR_S25_PERSONNEL_RESOURCE.class);
       return retVal;
    }
    ...
    public SQR_S25_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE(int rep) { 
       SQR_S25_PERSONNEL_RESOURCE retVal = getTyped("PERSONNEL_RESOURCE", rep, SQR_S25_PERSONNEL_RESOURCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQR_S25_PERSONNEL_RESOURCE> getPERSONNEL_RESOURCEAll() throws HL7Exception {
    	return getAllAsList("PERSONNEL_RESOURCE", SQR_S25_PERSONNEL_RESOURCE.class);
    } 
    ...
    public SQR_S25_LOCATION_RESOURCE getLOCATION_RESOURCE() { 
       SQR_S25_LOCATION_RESOURCE retVal = getTyped("LOCATION_RESOURCE", SQR_S25_LOCATION_RESOURCE.class);
       return retVal;
    }
    ...
    public SQR_S25_LOCATION_RESOURCE getLOCATION_RESOURCE(int rep) { 
       SQR_S25_LOCATION_RESOURCE retVal = getTyped("LOCATION_RESOURCE", rep, SQR_S25_LOCATION_RESOURCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQR_S25_LOCATION_RESOURCE> getLOCATION_RESOURCEAll() throws HL7Exception {
    	return getAllAsList("LOCATION_RESOURCE", SQR_S25_LOCATION_RESOURCE.class);
    } 
