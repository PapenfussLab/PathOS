...
/**
 * <p>Represents a ORG_O20_TIMING group structure (a Group object).
...
public class ORG_O20_TIMING extends AbstractGroup {

    /** 
     * Creates a new ORG_O20_TIMING group
     */
    public ORG_O20_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORG_O20_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
