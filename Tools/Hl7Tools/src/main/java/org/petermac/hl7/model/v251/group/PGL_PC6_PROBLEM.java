...
/**
 * <p>Represents a PGL_PC6_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PGL_PC6_PROBLEM_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PGL_PC6_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PGL_PC6_PROBLEM extends AbstractGroup {

    /** 
     * Creates a new PGL_PC6_PROBLEM group
     */
    public PGL_PC6_PROBLEM(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PGL_PC6_PROBLEM_ROLE.class, false, true, false);
                                  this.add(PGL_PC6_PROBLEM_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PGL_PC6_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PGL_PC6_PROBLEM_ROLE getPROBLEM_ROLE() { 
       PGL_PC6_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", PGL_PC6_PROBLEM_ROLE.class);
       return retVal;
    }
    ...
    public PGL_PC6_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
       PGL_PC6_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", rep, PGL_PC6_PROBLEM_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_ROLE", PGL_PC6_PROBLEM_ROLE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM_ROLE(PGL_PC6_PROBLEM_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_PROBLEM_ROLE insertPROBLEM_ROLE(int rep) throws HL7Exception { 
       return (PGL_PC6_PROBLEM_ROLE)super.insertRepetition("PROBLEM_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_PROBLEM_ROLE removePROBLEM_ROLE(int rep) throws HL7Exception { 
       return (PGL_PC6_PROBLEM_ROLE)super.removeRepetition("PROBLEM_ROLE", rep);
    }
    ...
    public PGL_PC6_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       PGL_PC6_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", PGL_PC6_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public PGL_PC6_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       PGL_PC6_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, PGL_PC6_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_OBSERVATION", PGL_PC6_PROBLEM_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM_OBSERVATION(PGL_PC6_PROBLEM_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_PROBLEM_OBSERVATION insertPROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (PGL_PC6_PROBLEM_OBSERVATION)super.insertRepetition("PROBLEM_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_PROBLEM_OBSERVATION removePROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (PGL_PC6_PROBLEM_OBSERVATION)super.removeRepetition("PROBLEM_OBSERVATION", rep);
    }
