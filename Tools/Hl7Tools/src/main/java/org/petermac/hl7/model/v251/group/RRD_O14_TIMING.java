...
/**
 * <p>Represents a RRD_O14_TIMING group structure (a Group object).
...
public class RRD_O14_TIMING extends AbstractGroup {

    /** 
     * Creates a new RRD_O14_TIMING group
     */
    public RRD_O14_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRD_O14_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
