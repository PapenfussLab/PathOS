...
/**
 * <p>Represents a ADT_A05_INSURANCE group structure (a Group object).
...
public class ADT_A05_INSURANCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A05_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
