...
/**
 * <p>Represents a PPG_PCG_PATIENT_VISIT group structure (a Group object).
...
public class PPG_PCG_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new PPG_PCG_PATIENT_VISIT group
     */
    public PPG_PCG_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCG_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
