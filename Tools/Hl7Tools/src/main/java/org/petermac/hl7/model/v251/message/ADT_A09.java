...
/**
 * <p>Represents a ADT_A09 message structure (see chapter 3.3.9). This structure contains the 
...
public class ADT_A09 extends AbstractMessage  {
    ...
    /**
     * Creates a new ADT_A09 message with DefaultModelClassFactory. 
     */ 
    public ADT_A09() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A09 - this is probably a bug in the source code generator.", e);
       }
    }
