...
/**
 * <p>Represents a BRT_O32 message structure (see chapter 4.20.6). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: BRT_O32_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class BRT_O32 extends AbstractMessage  {

    /**
     * Creates a new BRT_O32 message with DefaultModelClassFactory. 
     */ 
    public BRT_O32() { 
    ...
    /** 
     * Creates a new BRT_O32 message with custom ModelClassFactory.
     */
    public BRT_O32(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(BRT_O32_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating BRT_O32 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public BRT_O32_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", BRT_O32_RESPONSE.class);
    }
