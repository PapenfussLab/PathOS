...
/**
 * <p>Represents a ORB_O28 message structure (see chapter 4.20.2). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORB_O28_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORB_O28 extends AbstractMessage  {

    /**
     * Creates a new ORB_O28 message with DefaultModelClassFactory. 
     */ 
    public ORB_O28() { 
    ...
    /** 
     * Creates a new ORB_O28 message with custom ModelClassFactory.
     */
    public ORB_O28(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORB_O28_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORB_O28 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORB_O28_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORB_O28_RESPONSE.class);
    }
