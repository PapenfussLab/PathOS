...
/**
 * <p>Represents a OML_O35_OBSERVATION group structure (a Group object).
...
public class OML_O35_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new OML_O35_OBSERVATION group
     */
    public OML_O35_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OML_O35_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
