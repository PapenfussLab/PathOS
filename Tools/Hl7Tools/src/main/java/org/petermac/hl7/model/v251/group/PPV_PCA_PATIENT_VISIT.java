...
/**
 * <p>Represents a PPV_PCA_PATIENT_VISIT group structure (a Group object).
...
public class PPV_PCA_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new PPV_PCA_PATIENT_VISIT group
     */
    public PPV_PCA_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPV_PCA_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
