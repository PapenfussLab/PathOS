...
/**
 * <p>Represents a RRI_I12_OBSERVATION group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RRI_I12_RESULTS_NOTES (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RRI_I12_OBSERVATION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RRI_I12_RESULTS_NOTES.class, false, true, false);
    ...
    public RRI_I12_RESULTS_NOTES getRESULTS_NOTES() { 
       RRI_I12_RESULTS_NOTES retVal = getTyped("RESULTS_NOTES", RRI_I12_RESULTS_NOTES.class);
       return retVal;
    }
    ...
    public RRI_I12_RESULTS_NOTES getRESULTS_NOTES(int rep) { 
       RRI_I12_RESULTS_NOTES retVal = getTyped("RESULTS_NOTES", rep, RRI_I12_RESULTS_NOTES.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RRI_I12_RESULTS_NOTES> getRESULTS_NOTESAll() throws HL7Exception {
