...
public class PEO extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "Event Identifiers Used");
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "Event Symptom/Diagnosis Code");
                                  ...
                                  this.add(XAD.class, false, 0, 250, new Object[]{ getMessage() }, "Event Location Occurred Address");
                                  ...
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "Cause Of Death");
                                  this.add(XPN.class, false, 0, 250, new Object[]{ getMessage() }, "Primary Observer Name");
                                  this.add(XAD.class, false, 0, 250, new Object[]{ getMessage() }, "Primary Observer Address");
                                  this.add(XTN.class, false, 0, 250, new Object[]{ getMessage() }, "Primary Observer Telephone");
