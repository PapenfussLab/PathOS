...
/**
 * <p>Represents a OML_O33_PATIENT_VISIT group structure (a Group object).
...
public class OML_O33_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new OML_O33_PATIENT_VISIT group
     */
    public OML_O33_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OML_O33_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
