...
/**
 * <p>Represents a BAR_P05_INSURANCE group structure (a Group object).
...
public class BAR_P05_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new BAR_P05_INSURANCE group
     */
    public BAR_P05_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating BAR_P05_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
