...
/**
 * <p>Represents a ADT_A39 message structure (see chapter 3.3.39). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: EVN (Event Type) <b> </b> </li>
		                 * <li>4: ADT_A39_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class ADT_A39 extends AbstractMessage  {
    ...
    /**
     * Creates a new ADT_A39 message with DefaultModelClassFactory. 
     */ 
    public ADT_A39() { 
    ...
    /** 
     * Creates a new ADT_A39 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A39 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ADT_A39_PATIENT getPATIENT() { 
       return getTyped("PATIENT", ADT_A39_PATIENT.class);
    }
    ...
    public ADT_A39_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, ADT_A39_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A39_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", ADT_A39_PATIENT.class);
    } 
