...
/**
 * <p>Represents a PPT_PCL_ORDER_OBSERVATION group structure (a Group object).
...
public class PPT_PCL_ORDER_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new PPT_PCL_ORDER_OBSERVATION group
     */
    public PPT_PCL_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPT_PCL_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
