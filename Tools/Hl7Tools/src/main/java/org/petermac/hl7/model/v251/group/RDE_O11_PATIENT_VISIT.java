...
/**
 * <p>Represents a RDE_O11_PATIENT_VISIT group structure (a Group object).
...
public class RDE_O11_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new RDE_O11_PATIENT_VISIT group
     */
    public RDE_O11_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDE_O11_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
