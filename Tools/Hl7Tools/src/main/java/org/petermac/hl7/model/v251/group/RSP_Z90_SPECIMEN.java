...
/**
 * <p>Represents a RSP_Z90_SPECIMEN group structure (a Group object).
...
public class RSP_Z90_SPECIMEN extends AbstractGroup {

    /** 
     * Creates a new RSP_Z90_SPECIMEN group
     */
    public RSP_Z90_SPECIMEN(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Z90_SPECIMEN - this is probably a bug in the source code generator.", e);
       }
    }
