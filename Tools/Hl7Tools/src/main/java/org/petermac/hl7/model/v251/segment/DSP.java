...
public class DSP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(TX.class, true, 1, 300, new Object[]{ getMessage() }, "Data Line");
                                  this.add(ST.class, false, 1, 2, new Object[]{ getMessage() }, "Logical Break Point");
                                  this.add(TX.class, false, 1, 20, new Object[]{ getMessage() }, "Result ID");
