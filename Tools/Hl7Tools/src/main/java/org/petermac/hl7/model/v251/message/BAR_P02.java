...
/**
 * <p>Represents a BAR_P02 message structure (see chapter 6.4.2). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: EVN (Event Type) <b> </b> </li>
		                 * <li>4: BAR_P02_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class BAR_P02 extends AbstractMessage  {
    ...
    public BAR_P02_PATIENT getPATIENT() { 
       return getTyped("PATIENT", BAR_P02_PATIENT.class);
    }
    ...
    public BAR_P02_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, BAR_P02_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<BAR_P02_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", BAR_P02_PATIENT.class);
    } 
