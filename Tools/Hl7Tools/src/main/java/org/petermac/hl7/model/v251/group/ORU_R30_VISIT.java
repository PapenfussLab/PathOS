...
/**
 * <p>Represents a ORU_R30_VISIT group structure (a Group object).
...
public class ORU_R30_VISIT extends AbstractGroup {

    /** 
     * Creates a new ORU_R30_VISIT group
     */
    public ORU_R30_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORU_R30_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
