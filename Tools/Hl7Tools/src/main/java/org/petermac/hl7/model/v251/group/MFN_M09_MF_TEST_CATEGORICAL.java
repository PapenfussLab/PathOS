...
/**
 * <p>Represents a MFN_M09_MF_TEST_CATEGORICAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: MFN_M09_MF_TEST_CAT_DETAIL (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class MFN_M09_MF_TEST_CATEGORICAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(MFN_M09_MF_TEST_CAT_DETAIL.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating MFN_M09_MF_TEST_CATEGORICAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * MF_TEST_CAT_DETAIL (a Group object) - creates it if necessary
     */
    public MFN_M09_MF_TEST_CAT_DETAIL getMF_TEST_CAT_DETAIL() { 
       MFN_M09_MF_TEST_CAT_DETAIL retVal = getTyped("MF_TEST_CAT_DETAIL", MFN_M09_MF_TEST_CAT_DETAIL.class);
       return retVal;
    }
