 ...
 * <ul>
		                 ...
		                 * <li>4: MFN_M03_MF_TEST (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class MFN_M03 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFN_M03 message with DefaultModelClassFactory. 
     */ 
    public MFN_M03() { 
    ...
    /** 
     * Creates a new MFN_M03 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M03 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * MF_TEST (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFN_M03_MF_TEST getMF_TEST() { 
       return getTyped("MF_TEST", MFN_M03_MF_TEST.class);
    }
    ...
    public MFN_M03_MF_TEST getMF_TEST(int rep) { 
       return getTyped("MF_TEST", rep, MFN_M03_MF_TEST.class);
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getMF_TEST()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFN_M03_MF_TEST> getMF_TESTAll() throws HL7Exception {
    	return getAllAsList("MF_TEST", MFN_M03_MF_TEST.class);
    } 
    ...
    public void insertMF_TEST(MFN_M03_MF_TEST structure, int rep) throws HL7Exception { 
       super.insertRepetition( "MF_TEST", structure, rep);
    }
