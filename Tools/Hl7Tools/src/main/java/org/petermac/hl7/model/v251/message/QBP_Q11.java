...
/**
 * <p>Represents a QBP_Q11 message structure (see chapter 4.13.20). This structure contains the 
...
public class QBP_Q11 extends AbstractMessage  {

    /**
     * Creates a new QBP_Q11 message with DefaultModelClassFactory. 
     */ 
    public QBP_Q11() { 
    ...
    /** 
     * Creates a new QBP_Q11 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating QBP_Q11 - this is probably a bug in the source code generator.", e);
       }
    }
