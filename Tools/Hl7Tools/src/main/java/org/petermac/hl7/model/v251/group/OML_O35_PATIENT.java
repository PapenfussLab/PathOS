...
/**
 * <p>Represents a OML_O35_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: OML_O35_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>6: OML_O35_INSURANCE (a Group object) <b>optional repeating </b></li>
...
public class OML_O35_PATIENT extends AbstractGroup {
     ...
     */
    public OML_O35_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OML_O35_PATIENT_VISIT.class, false, false, false);
                                  this.add(OML_O35_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OML_O35_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OML_O35_PATIENT_VISIT getPATIENT_VISIT() { 
       OML_O35_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", OML_O35_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public OML_O35_INSURANCE getINSURANCE() { 
       OML_O35_INSURANCE retVal = getTyped("INSURANCE", OML_O35_INSURANCE.class);
       return retVal;
    }
    ...
    public OML_O35_INSURANCE getINSURANCE(int rep) { 
       OML_O35_INSURANCE retVal = getTyped("INSURANCE", rep, OML_O35_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OML_O35_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", OML_O35_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(OML_O35_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OML_O35_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (OML_O35_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OML_O35_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (OML_O35_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
