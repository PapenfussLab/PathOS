...
/**
 * <p>Represents a RSP_K21_QUERY_RESPONSE group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: QRI (Query Response Instance) <b>  </b></li>
 * </ul>
 */
...
public class RSP_K21_QUERY_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_K21_QUERY_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * QRI (Query Response Instance) - creates it if necessary
     */
    public QRI getQRI() { 
       QRI retVal = getTyped("QRI", QRI.class);
       return retVal;
    }
