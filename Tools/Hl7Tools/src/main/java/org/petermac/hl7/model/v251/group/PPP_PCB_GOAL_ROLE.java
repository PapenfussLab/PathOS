...
/**
 * <p>Represents a PPP_PCB_GOAL_ROLE group structure (a Group object).
...
public class PPP_PCB_GOAL_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPP_PCB_GOAL_ROLE group
     */
    public PPP_PCB_GOAL_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCB_GOAL_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
