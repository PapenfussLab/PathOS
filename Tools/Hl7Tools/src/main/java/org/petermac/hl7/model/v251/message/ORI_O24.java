...
/**
 * <p>Represents a ORI_O24 message structure (see chapter 4.4.13). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORI_O24_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORI_O24 extends AbstractMessage  {

    /**
     * Creates a new ORI_O24 message with DefaultModelClassFactory. 
     */ 
    public ORI_O24() { 
    ...
    /** 
     * Creates a new ORI_O24 message with custom ModelClassFactory.
     */
    public ORI_O24(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORI_O24_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORI_O24 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORI_O24_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORI_O24_RESPONSE.class);
    }
