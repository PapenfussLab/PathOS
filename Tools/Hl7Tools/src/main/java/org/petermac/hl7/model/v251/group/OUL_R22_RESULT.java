...
/**
 * <p>Represents a OUL_R22_RESULT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: SID (Substance Identifier) <b>optional repeating </b></li>
                         * <li>4: NTE (Notes and Comments) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OUL_R22_RESULT extends AbstractGroup {

    /** 
     * Creates a new OUL_R22_RESULT group
     */
    public OUL_R22_RESULT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R22_RESULT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * SID (Substance Identifier) - creates it if necessary
     */
    public SID getSID() { 
       SID retVal = getTyped("SID", SID.class);
       return retVal;
    }
    ...
    public SID getSID(int rep) { 
       SID retVal = getTyped("SID", rep, SID.class);
       return retVal;
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getSID()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<SID> getSIDAll() throws HL7Exception {
    	return getAllAsList("SID", SID.class);
    } 
    ...
    public void insertSID(SID structure, int rep) throws HL7Exception { 
       super.insertRepetition("SID", structure, rep);
    }
