...
/**
 * <p>Represents a ORL_O22_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: ORL_O22_TIMING (a Group object) <b>optional repeating </b></li>
                         * <li>3: ORL_O22_OBSERVATION_REQUEST (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class ORL_O22_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ORL_O22_TIMING.class, false, true, false);
                                  this.add(ORL_O22_OBSERVATION_REQUEST.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORL_O22_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORL_O22_TIMING getTIMING() { 
       ORL_O22_TIMING retVal = getTyped("TIMING", ORL_O22_TIMING.class);
       return retVal;
    }
    ...
    public ORL_O22_TIMING getTIMING(int rep) { 
       ORL_O22_TIMING retVal = getTyped("TIMING", rep, ORL_O22_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORL_O22_TIMING> getTIMINGAll() throws HL7Exception {
    	return getAllAsList("TIMING", ORL_O22_TIMING.class);
    } 
    ...
    public ORL_O22_OBSERVATION_REQUEST getOBSERVATION_REQUEST() { 
       ORL_O22_OBSERVATION_REQUEST retVal = getTyped("OBSERVATION_REQUEST", ORL_O22_OBSERVATION_REQUEST.class);
       return retVal;
    }
