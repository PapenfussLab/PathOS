...
/**
 * <p>Represents a ORP_O10_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: ORP_O10_TIMING (a Group object) <b>optional repeating </b></li>
                         * <li>3: ORP_O10_ORDER_DETAIL (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class ORP_O10_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ORP_O10_TIMING.class, false, true, false);
                                  this.add(ORP_O10_ORDER_DETAIL.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORP_O10_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORP_O10_TIMING getTIMING() { 
       ORP_O10_TIMING retVal = getTyped("TIMING", ORP_O10_TIMING.class);
       return retVal;
    }
    ...
    public ORP_O10_TIMING getTIMING(int rep) { 
       ORP_O10_TIMING retVal = getTyped("TIMING", rep, ORP_O10_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORP_O10_TIMING> getTIMINGAll() throws HL7Exception {
    ...
    public ORP_O10_ORDER_DETAIL getORDER_DETAIL() { 
       ORP_O10_ORDER_DETAIL retVal = getTyped("ORDER_DETAIL", ORP_O10_ORDER_DETAIL.class);
       return retVal;
    }
