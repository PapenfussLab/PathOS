...
/**
 * <p>Represents a SRR_S01_PATIENT group structure (a Group object).
...
public class SRR_S01_PATIENT extends AbstractGroup {

    /** 
     * Creates a new SRR_S01_PATIENT group
     */
    public SRR_S01_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRR_S01_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
