...
public class OML_O35_PRIOR_RESULT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(OML_O35_PATIENT_PRIOR.class, false, false, false);
                                  this.add(OML_O35_PATIENT_VISIT_PRIOR.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
                                  this.add(OML_O35_ORDER_PRIOR.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OML_O35_PRIOR_RESULT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OML_O35_PATIENT_PRIOR getPATIENT_PRIOR() { 
       OML_O35_PATIENT_PRIOR retVal = getTyped("PATIENT_PRIOR", OML_O35_PATIENT_PRIOR.class);
       return retVal;
    }
    ...
    public OML_O35_PATIENT_VISIT_PRIOR getPATIENT_VISIT_PRIOR() { 
       OML_O35_PATIENT_VISIT_PRIOR retVal = getTyped("PATIENT_VISIT_PRIOR", OML_O35_PATIENT_VISIT_PRIOR.class);
       return retVal;
    }
    ...
    public OML_O35_ORDER_PRIOR getORDER_PRIOR() { 
       OML_O35_ORDER_PRIOR retVal = getTyped("ORDER_PRIOR", OML_O35_ORDER_PRIOR.class);
       return retVal;
    }
    ...
    public OML_O35_ORDER_PRIOR getORDER_PRIOR(int rep) { 
       OML_O35_ORDER_PRIOR retVal = getTyped("ORDER_PRIOR", rep, OML_O35_ORDER_PRIOR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OML_O35_ORDER_PRIOR> getORDER_PRIORAll() throws HL7Exception {
    	return getAllAsList("ORDER_PRIOR", OML_O35_ORDER_PRIOR.class);
    } 
