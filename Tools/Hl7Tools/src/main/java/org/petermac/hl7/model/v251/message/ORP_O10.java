...
/**
 * <p>Represents a ORP_O10 message structure (see chapter 4.13.4). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORP_O10_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORP_O10 extends AbstractMessage  {

    /**
     * Creates a new ORP_O10 message with DefaultModelClassFactory. 
     */ 
    public ORP_O10() { 
    ...
    /** 
     * Creates a new ORP_O10 message with custom ModelClassFactory.
     */
    public ORP_O10(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORP_O10_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORP_O10 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORP_O10_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORP_O10_RESPONSE.class);
    }
