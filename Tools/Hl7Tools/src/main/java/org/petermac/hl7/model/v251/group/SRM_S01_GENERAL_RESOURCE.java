...
/**
 * <p>Represents a SRM_S01_GENERAL_RESOURCE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: AIG (Appointment Information - General Resource) <b>  </b></li>
                         * <li>2: APR (Appointment Preferences) <b>optional  </b></li>
                         * <li>3: NTE (Notes and Comments) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class SRM_S01_GENERAL_RESOURCE extends AbstractGroup {

    /** 
     * Creates a new SRM_S01_GENERAL_RESOURCE group
     */
    public SRM_S01_GENERAL_RESOURCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(AIG.class, true, false, false);
                                  this.add(APR.class, false, false, false);
                                  this.add(NTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating SRM_S01_GENERAL_RESOURCE - this is probably a bug in the source code generator.", e);
       }
    }
