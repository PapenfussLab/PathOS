...
/**
 * <p>Represents a RSP_Z82_ENCODED_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXE (Pharmacy/Treatment Encoded Order) <b>  </b></li>
                         * <li>2: RSP_Z82_TIMING_ENCODED (a Group object) <b>optional repeating </b></li>
...
public class RSP_Z82_ENCODED_ORDER extends AbstractGroup {

    /** 
     * Creates a new RSP_Z82_ENCODED_ORDER group
     */
    public RSP_Z82_ENCODED_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RSP_Z82_TIMING_ENCODED.class, false, true, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z82_ENCODED_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RSP_Z82_TIMING_ENCODED getTIMING_ENCODED() { 
       RSP_Z82_TIMING_ENCODED retVal = getTyped("TIMING_ENCODED", RSP_Z82_TIMING_ENCODED.class);
       return retVal;
    }
    ...
    public RSP_Z82_TIMING_ENCODED getTIMING_ENCODED(int rep) { 
       RSP_Z82_TIMING_ENCODED retVal = getTyped("TIMING_ENCODED", rep, RSP_Z82_TIMING_ENCODED.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RSP_Z82_TIMING_ENCODED> getTIMING_ENCODEDAll() throws HL7Exception {
    	return getAllAsList("TIMING_ENCODED", RSP_Z82_TIMING_ENCODED.class);
    } 
     ...
     */
    public void insertTIMING_ENCODED(RSP_Z82_TIMING_ENCODED structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RSP_Z82_TIMING_ENCODED insertTIMING_ENCODED(int rep) throws HL7Exception { 
       return (RSP_Z82_TIMING_ENCODED)super.insertRepetition("TIMING_ENCODED", rep);
    }
     ...
     */
    public RSP_Z82_TIMING_ENCODED removeTIMING_ENCODED(int rep) throws HL7Exception { 
       return (RSP_Z82_TIMING_ENCODED)super.removeRepetition("TIMING_ENCODED", rep);
    }
