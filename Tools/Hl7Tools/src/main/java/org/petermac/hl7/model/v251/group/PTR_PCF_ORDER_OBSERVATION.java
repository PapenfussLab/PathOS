...
/**
 * <p>Represents a PTR_PCF_ORDER_OBSERVATION group structure (a Group object).
...
public class PTR_PCF_ORDER_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new PTR_PCF_ORDER_OBSERVATION group
     */
    public PTR_PCF_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PTR_PCF_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
