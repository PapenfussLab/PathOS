...
/**
 * <p>Represents a RQA_I08_PROCEDURE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PR1 (Procedures) <b>  </b></li>
                         * <li>2: RQA_I08_AUTHORIZATION (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RQA_I08_PROCEDURE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RQA_I08_AUTHORIZATION.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RQA_I08_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RQA_I08_AUTHORIZATION getAUTHORIZATION() { 
       RQA_I08_AUTHORIZATION retVal = getTyped("AUTHORIZATION", RQA_I08_AUTHORIZATION.class);
       return retVal;
    }
