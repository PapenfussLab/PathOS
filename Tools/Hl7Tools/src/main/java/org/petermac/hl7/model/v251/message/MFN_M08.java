 ...
 * <ul>
		                 ...
		                 * <li>4: MFN_M08_MF_TEST_NUMERIC (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class MFN_M08 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFN_M08 message with DefaultModelClassFactory. 
     */ 
    public MFN_M08() { 
    ...
    /** 
     * Creates a new MFN_M08 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M08 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * MF_TEST_NUMERIC (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFN_M08_MF_TEST_NUMERIC getMF_TEST_NUMERIC() { 
       return getTyped("MF_TEST_NUMERIC", MFN_M08_MF_TEST_NUMERIC.class);
    }
    ...
    public MFN_M08_MF_TEST_NUMERIC getMF_TEST_NUMERIC(int rep) { 
       return getTyped("MF_TEST_NUMERIC", rep, MFN_M08_MF_TEST_NUMERIC.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of MF_TEST_NUMERIC 
     * </p>
     * 
     */ 
    public int getMF_TEST_NUMERICReps() { 
    	return getReps("MF_TEST_NUMERIC");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MF_TEST_NUMERIC.
     * <p>
     * <p>
     * Note that unlike {@link #getMF_TEST_NUMERIC()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFN_M08_MF_TEST_NUMERIC> getMF_TEST_NUMERICAll() throws HL7Exception {
    	return getAllAsList("MF_TEST_NUMERIC", MFN_M08_MF_TEST_NUMERIC.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of MF_TEST_NUMERIC (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    /**
     * <p>
     * Removes a specific repetition of MF_TEST_NUMERIC (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
