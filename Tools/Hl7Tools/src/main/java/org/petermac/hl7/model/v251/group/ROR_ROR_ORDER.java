...
/**
 * <p>Represents a ROR_ROR_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: RXO (Pharmacy/Treatment Order) <b>  </b></li>
...
public class ROR_ROR_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ROR_ROR_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
