...
public class MRG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CX.class, true, 0, 250, new Object[]{ getMessage() }, "Prior Patient Identifier List");
                                  this.add(CX.class, false, 0, 250, new Object[]{ getMessage() }, "Prior Alternate Patient ID");
                                  this.add(CX.class, false, 1, 250, new Object[]{ getMessage() }, "Prior Patient Account Number");
                                  this.add(CX.class, false, 1, 250, new Object[]{ getMessage() }, "Prior Patient ID");
                                  this.add(CX.class, false, 1, 250, new Object[]{ getMessage() }, "Prior Visit Number");
                                  this.add(CX.class, false, 1, 250, new Object[]{ getMessage() }, "Prior Alternate Visit ID");
                                  this.add(XPN.class, false, 0, 250, new Object[]{ getMessage() }, "Prior Patient Name");
