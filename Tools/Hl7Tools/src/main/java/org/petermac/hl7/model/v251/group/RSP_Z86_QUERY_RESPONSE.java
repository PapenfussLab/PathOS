...
public class RSP_Z86_QUERY_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(RSP_Z86_PATIENT.class, false, false, false);
                                  this.add(RSP_Z86_COMMON_ORDER.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z86_QUERY_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RSP_Z86_PATIENT getPATIENT() { 
       RSP_Z86_PATIENT retVal = getTyped("PATIENT", RSP_Z86_PATIENT.class);
       return retVal;
    }
    ...
    public RSP_Z86_COMMON_ORDER getCOMMON_ORDER() { 
       RSP_Z86_COMMON_ORDER retVal = getTyped("COMMON_ORDER", RSP_Z86_COMMON_ORDER.class);
       return retVal;
    }
    ...
    public RSP_Z86_COMMON_ORDER getCOMMON_ORDER(int rep) { 
       RSP_Z86_COMMON_ORDER retVal = getTyped("COMMON_ORDER", rep, RSP_Z86_COMMON_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RSP_Z86_COMMON_ORDER> getCOMMON_ORDERAll() throws HL7Exception {
    	return getAllAsList("COMMON_ORDER", RSP_Z86_COMMON_ORDER.class);
    } 
