...
/**
 * <p>Represents a ADT_A16_INSURANCE group structure (a Group object).
...
public class ADT_A16_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new ADT_A16_INSURANCE group
     */
    public ADT_A16_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A16_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
