...
/**
 * <p>Represents a ORL_O22_SPECIMEN group structure (a Group object).
...
public class ORL_O22_SPECIMEN extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORL_O22_SPECIMEN - this is probably a bug in the source code generator.", e);
       }
    }
