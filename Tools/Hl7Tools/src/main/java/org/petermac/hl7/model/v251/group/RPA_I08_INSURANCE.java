...
/**
 * <p>Represents a RPA_I08_INSURANCE group structure (a Group object).
...
public class RPA_I08_INSURANCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I08_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
