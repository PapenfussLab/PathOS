...
/**
 * <p>Represents a RSP_K11_ROW_DEFINITION group structure (a Group object).
...
public class RSP_K11_ROW_DEFINITION extends AbstractGroup {

    /** 
     * Creates a new RSP_K11_ROW_DEFINITION group
     */
    public RSP_K11_ROW_DEFINITION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_K11_ROW_DEFINITION - this is probably a bug in the source code generator.", e);
       }
    }
