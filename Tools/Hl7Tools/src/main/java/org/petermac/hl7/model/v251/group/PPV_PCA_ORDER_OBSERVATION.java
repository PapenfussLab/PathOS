...
/**
 * <p>Represents a PPV_PCA_ORDER_OBSERVATION group structure (a Group object).
...
public class PPV_PCA_ORDER_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new PPV_PCA_ORDER_OBSERVATION group
     */
    public PPV_PCA_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPV_PCA_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
