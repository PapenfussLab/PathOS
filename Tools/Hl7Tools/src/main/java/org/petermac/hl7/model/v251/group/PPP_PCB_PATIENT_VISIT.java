...
/**
 * <p>Represents a PPP_PCB_PATIENT_VISIT group structure (a Group object).
...
public class PPP_PCB_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new PPP_PCB_PATIENT_VISIT group
     */
    public PPP_PCB_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCB_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
