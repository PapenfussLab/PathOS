...
/**
 * <p>Represents a MFR_M01 message structure (see chapter 8.4.4). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>9: MFR_M01_MF_QUERY (a Group object) <b> repeating</b> </li>
...
public class MFR_M01 extends AbstractMessage  {
    ...
    public MFR_M01_MF_QUERY getMF_QUERY() { 
       return getTyped("MF_QUERY", MFR_M01_MF_QUERY.class);
    }
    ...
    public MFR_M01_MF_QUERY getMF_QUERY(int rep) { 
       return getTyped("MF_QUERY", rep, MFR_M01_MF_QUERY.class);
    }
     ...
     * 
     */ 
    public java.util.List<MFR_M01_MF_QUERY> getMF_QUERYAll() throws HL7Exception {
    	return getAllAsList("MF_QUERY", MFR_M01_MF_QUERY.class);
    } 
