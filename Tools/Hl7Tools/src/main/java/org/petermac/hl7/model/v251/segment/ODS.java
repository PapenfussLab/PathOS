 ...
 * <ul>
     ...
     * <li>ODS-2: Service Period (CE) <b>optional repeating</b>
     * <li>ODS-3: Diet, Supplement, or Preference Code (CE) <b> repeating</b>
...
public class ODS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 10, 250, new Object[]{ getMessage() }, "Service Period");
                                  this.add(CE.class, true, 20, 250, new Object[]{ getMessage() }, "Diet, Supplement, or Preference Code");
