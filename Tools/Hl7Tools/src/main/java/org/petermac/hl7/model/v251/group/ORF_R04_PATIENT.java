...
/**
 * <p>Represents a ORF_R04_PATIENT group structure (a Group object).
...
public class ORF_R04_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ORF_R04_PATIENT group
     */
    public ORF_R04_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORF_R04_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
