...
/**
 * <p>Represents a PRR_PC5_PATIENT_VISIT group structure (a Group object).
...
public class PRR_PC5_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new PRR_PC5_PATIENT_VISIT group
     */
    public PRR_PC5_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PRR_PC5_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
