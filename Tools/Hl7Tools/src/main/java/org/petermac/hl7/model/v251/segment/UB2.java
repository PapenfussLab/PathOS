...
public class UB2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(UVC.class, false, 12, 41, new Object[]{ getMessage() }, "Value Amount & Code");
                                  this.add(OCD.class, false, 8, 259, new Object[]{ getMessage() }, "Occurrence Code & Date (32-35)");
                                  this.add(OSP.class, false, 2, 268, new Object[]{ getMessage() }, "Occurrence Span Code/Dates (36)");
