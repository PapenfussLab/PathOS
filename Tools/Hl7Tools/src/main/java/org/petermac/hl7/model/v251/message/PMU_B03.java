...
/**
 * <p>Represents a PMU_B03 message structure (see chapter 15.3.3). This structure contains the 
...
public class PMU_B03 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PMU_B03 - this is probably a bug in the source code generator.", e);
       }
    }
