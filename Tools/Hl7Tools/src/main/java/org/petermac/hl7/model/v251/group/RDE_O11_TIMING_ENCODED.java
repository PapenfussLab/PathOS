...
/**
 * <p>Represents a RDE_O11_TIMING_ENCODED group structure (a Group object).
...
public class RDE_O11_TIMING_ENCODED extends AbstractGroup {

    /** 
     * Creates a new RDE_O11_TIMING_ENCODED group
     */
    public RDE_O11_TIMING_ENCODED(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDE_O11_TIMING_ENCODED - this is probably a bug in the source code generator.", e);
       }
    }
