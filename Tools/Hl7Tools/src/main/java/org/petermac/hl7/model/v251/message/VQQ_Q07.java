...
/**
 * <p>Represents a VQQ_Q07 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: VTQ (Virtual Table Query Request) <b> </b> </li>
		                 * <li>4: RDF (Table Row Definition) <b>optional </b> </li>
		                 * <li>5: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class VQQ_Q07 extends AbstractMessage  {

    /**
     * Creates a new VQQ_Q07 message with DefaultModelClassFactory. 
     */ 
    public VQQ_Q07() { 
    ...
    /** 
     * Creates a new VQQ_Q07 message with custom ModelClassFactory.
     */
    public VQQ_Q07(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating VQQ_Q07 - this is probably a bug in the source code generator.", e);
       }
    }
