 ...
 * <ul>
		                 ...
		                 * <li>4: RPI_I04_PROVIDER (a Group object) <b> repeating</b> </li>
		                 * <li>5: PID (Patient Identification) <b> </b> </li>
		                 * <li>6: NK1 (Next of Kin / Associated Parties) <b>optional repeating</b> </li>
		                 * <li>7: RPI_I04_GUARANTOR_INSURANCE (a Group object) <b>optional </b> </li>
...
public class RPI_I04 extends AbstractMessage  {
    ...
    /**
     * Creates a new RPI_I04 message with DefaultModelClassFactory. 
     */ 
    public RPI_I04() { 
    ...
    /** 
     * Creates a new RPI_I04 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPI_I04 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RPI_I04_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RPI_I04_PROVIDER.class);
    }
    ...
    public RPI_I04_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RPI_I04_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPI_I04_PROVIDER> getPROVIDERAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROVIDER(RPI_I04_PROVIDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPI_I04_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (RPI_I04_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RPI_I04_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (RPI_I04_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
    ...
    public RPI_I04_GUARANTOR_INSURANCE getGUARANTOR_INSURANCE() { 
       return getTyped("GUARANTOR_INSURANCE", RPI_I04_GUARANTOR_INSURANCE.class);
    }
