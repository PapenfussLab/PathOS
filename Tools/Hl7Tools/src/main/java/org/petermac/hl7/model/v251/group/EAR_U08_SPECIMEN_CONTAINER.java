...
/**
 * <p>Represents a EAR_U08_SPECIMEN_CONTAINER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: SAC (Specimen Container detail) <b>  </b></li>
                         * <li>2: SPM (Specimen) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class EAR_U08_SPECIMEN_CONTAINER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating EAR_U08_SPECIMEN_CONTAINER - this is probably a bug in the source code generator.", e);
       }
    }
