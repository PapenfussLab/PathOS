...
/**
 * <p>Represents a OSR_Q06_PATIENT group structure (a Group object).
...
public class OSR_Q06_PATIENT extends AbstractGroup {

    /** 
     * Creates a new OSR_Q06_PATIENT group
     */
    public OSR_Q06_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OSR_Q06_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
