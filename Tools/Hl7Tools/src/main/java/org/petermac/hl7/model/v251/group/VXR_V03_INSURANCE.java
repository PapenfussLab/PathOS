...
/**
 * <p>Represents a VXR_V03_INSURANCE group structure (a Group object).
...
public class VXR_V03_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new VXR_V03_INSURANCE group
     */
    public VXR_V03_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating VXR_V03_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
