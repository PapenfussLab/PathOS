...
/**
 * <p>Represents a OML_O33_OBSERVATION_REQUEST group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: OML_O33_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>6: OML_O33_PRIOR_RESULT (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class OML_O33_OBSERVATION_REQUEST extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OML_O33_OBSERVATION.class, false, true, false);
                                  this.add(OML_O33_PRIOR_RESULT.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OML_O33_OBSERVATION_REQUEST - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OML_O33_OBSERVATION getOBSERVATION() { 
       OML_O33_OBSERVATION retVal = getTyped("OBSERVATION", OML_O33_OBSERVATION.class);
       return retVal;
    }
    ...
    public OML_O33_OBSERVATION getOBSERVATION(int rep) { 
       OML_O33_OBSERVATION retVal = getTyped("OBSERVATION", rep, OML_O33_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OML_O33_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", OML_O33_OBSERVATION.class);
    } 
    ...
    public OML_O33_PRIOR_RESULT getPRIOR_RESULT() { 
       OML_O33_PRIOR_RESULT retVal = getTyped("PRIOR_RESULT", OML_O33_PRIOR_RESULT.class);
       return retVal;
    }
    ...
    public OML_O33_PRIOR_RESULT getPRIOR_RESULT(int rep) { 
       OML_O33_PRIOR_RESULT retVal = getTyped("PRIOR_RESULT", rep, OML_O33_PRIOR_RESULT.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OML_O33_PRIOR_RESULT> getPRIOR_RESULTAll() throws HL7Exception {
    	return getAllAsList("PRIOR_RESULT", OML_O33_PRIOR_RESULT.class);
    } 
