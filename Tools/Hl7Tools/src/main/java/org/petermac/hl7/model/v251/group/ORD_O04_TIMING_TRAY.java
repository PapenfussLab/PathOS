...
/**
 * <p>Represents a ORD_O04_TIMING_TRAY group structure (a Group object).
...
public class ORD_O04_TIMING_TRAY extends AbstractGroup {

    /** 
     * Creates a new ORD_O04_TIMING_TRAY group
     */
    public ORD_O04_TIMING_TRAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORD_O04_TIMING_TRAY - this is probably a bug in the source code generator.", e);
       }
    }
