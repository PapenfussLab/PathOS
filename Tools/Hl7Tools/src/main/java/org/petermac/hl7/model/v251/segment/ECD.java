...
public class ECD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(NM.class, true, 1, 20, new Object[]{ getMessage() }, "Reference Command Number");
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Remote Control Command");
                                              this.add(ID.class, false, 1, 80, new Object[]{ getMessage(), new Integer(136) }, "Response Required");
                                  this.add(TQ.class, false, 1, 200, new Object[]{ getMessage() }, "Requested Completion Time");
                                  this.add(TX.class, false, 0, 65536, new Object[]{ getMessage() }, "Parameters");
    ...
    public TQ getRequestedCompletionTime() { 
		TQ retVal = this.getTypedField(4, 0);
		return retVal;
    }
