...
/**
 * <p>Represents a ORU_R30_TIMING_QTY group structure (a Group object).
...
public class ORU_R30_TIMING_QTY extends AbstractGroup {

    /** 
     * Creates a new ORU_R30_TIMING_QTY group
     */
    public ORU_R30_TIMING_QTY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORU_R30_TIMING_QTY - this is probably a bug in the source code generator.", e);
       }
    }
