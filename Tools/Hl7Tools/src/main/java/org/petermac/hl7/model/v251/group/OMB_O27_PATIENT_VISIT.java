...
/**
 * <p>Represents a OMB_O27_PATIENT_VISIT group structure (a Group object).
...
public class OMB_O27_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new OMB_O27_PATIENT_VISIT group
     */
    public OMB_O27_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMB_O27_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
