...
/**
 * <p>Represents a ADT_A12 message structure (see chapter 3.3.12). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>10: DG1 (Diagnosis) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ADT_A12 extends AbstractMessage  {

    /**
     * Creates a new ADT_A12 message with DefaultModelClassFactory. 
     */ 
    public ADT_A12() { 
    ...
    /** 
     * Creates a new ADT_A12 message with custom ModelClassFactory.
     */
    public ADT_A12(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A12 - this is probably a bug in the source code generator.", e);
       }
    }
