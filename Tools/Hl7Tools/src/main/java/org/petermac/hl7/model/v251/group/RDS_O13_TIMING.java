...
/**
 * <p>Represents a RDS_O13_TIMING group structure (a Group object).
...
public class RDS_O13_TIMING extends AbstractGroup {
     ...
     */
    public RDS_O13_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDS_O13_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
