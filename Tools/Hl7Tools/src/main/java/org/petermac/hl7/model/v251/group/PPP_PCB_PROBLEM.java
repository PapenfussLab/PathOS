...
/**
 * <p>Represents a PPP_PCB_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPP_PCB_PROBLEM_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPP_PCB_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>6: PPP_PCB_GOAL (a Group object) <b>optional repeating </b></li>
                         * <li>7: PPP_PCB_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PPP_PCB_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPP_PCB_PROBLEM_ROLE.class, false, true, false);
                                  this.add(PPP_PCB_PROBLEM_OBSERVATION.class, false, true, false);
                                  this.add(PPP_PCB_GOAL.class, false, true, false);
                                  this.add(PPP_PCB_ORDER.class, false, true, false);
    ...
    public PPP_PCB_PROBLEM_ROLE getPROBLEM_ROLE() { 
       PPP_PCB_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", PPP_PCB_PROBLEM_ROLE.class);
       return retVal;
    }
    ...
    public PPP_PCB_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
       PPP_PCB_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", rep, PPP_PCB_PROBLEM_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM_ROLE(PPP_PCB_PROBLEM_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCB_PROBLEM_ROLE insertPROBLEM_ROLE(int rep) throws HL7Exception { 
       return (PPP_PCB_PROBLEM_ROLE)super.insertRepetition("PROBLEM_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCB_PROBLEM_ROLE removePROBLEM_ROLE(int rep) throws HL7Exception { 
       return (PPP_PCB_PROBLEM_ROLE)super.removeRepetition("PROBLEM_ROLE", rep);
    }
    ...
    public PPP_PCB_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       PPP_PCB_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", PPP_PCB_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPP_PCB_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       PPP_PCB_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, PPP_PCB_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM_OBSERVATION(PPP_PCB_PROBLEM_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCB_PROBLEM_OBSERVATION insertPROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (PPP_PCB_PROBLEM_OBSERVATION)super.insertRepetition("PROBLEM_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCB_PROBLEM_OBSERVATION removePROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (PPP_PCB_PROBLEM_OBSERVATION)super.removeRepetition("PROBLEM_OBSERVATION", rep);
    }
    ...
    public PPP_PCB_GOAL getGOAL() { 
       PPP_PCB_GOAL retVal = getTyped("GOAL", PPP_PCB_GOAL.class);
       return retVal;
    }
    ...
    public PPP_PCB_GOAL getGOAL(int rep) { 
       PPP_PCB_GOAL retVal = getTyped("GOAL", rep, PPP_PCB_GOAL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_GOAL> getGOALAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertGOAL(PPP_PCB_GOAL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCB_GOAL insertGOAL(int rep) throws HL7Exception { 
       return (PPP_PCB_GOAL)super.insertRepetition("GOAL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCB_GOAL removeGOAL(int rep) throws HL7Exception { 
       return (PPP_PCB_GOAL)super.removeRepetition("GOAL", rep);
    }
    ...
    public PPP_PCB_ORDER getORDER() { 
       PPP_PCB_ORDER retVal = getTyped("ORDER", PPP_PCB_ORDER.class);
       return retVal;
    }
    ...
    public PPP_PCB_ORDER getORDER(int rep) { 
       PPP_PCB_ORDER retVal = getTyped("ORDER", rep, PPP_PCB_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_ORDER> getORDERAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER(PPP_PCB_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCB_ORDER insertORDER(int rep) throws HL7Exception { 
       return (PPP_PCB_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCB_ORDER removeORDER(int rep) throws HL7Exception { 
       return (PPP_PCB_ORDER)super.removeRepetition("ORDER", rep);
    }
