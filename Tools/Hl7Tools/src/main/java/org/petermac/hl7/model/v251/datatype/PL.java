 ...
 * <ul>
 * <li>Point of Care (HD) (NON-STANDARD)
 * <li>Room (IS)
 * <li>Bed (IS)
 * <li>Facility (HD)
...
public class PL extends AbstractComposite {
    ...
    /**
     * Returns Point of Care (component 1) (NON-STANDARD).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public HD getPointOfCare() {
