...
public class RQD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Item Code - Internal");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Item Code - External");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Hospital Item Code");
                                  this.add(NM.class, false, 1, 6, new Object[]{ getMessage() }, "Requisition Quantity");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Requisition Unit of Measure");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Deliver To ID");
