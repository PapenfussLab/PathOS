 ...
 * <ul>
		                 ...
		                 * <li>9: MFR_M05_MF_QUERY (a Group object) <b> repeating</b> </li>
...
public class MFR_M05 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFR_M05 message with DefaultModelClassFactory. 
     */ 
    public MFR_M05() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFR_M05 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public MFR_M05_MF_QUERY getMF_QUERY() { 
       return getTyped("MF_QUERY", MFR_M05_MF_QUERY.class);
    }
    ...
    public MFR_M05_MF_QUERY getMF_QUERY(int rep) { 
       return getTyped("MF_QUERY", rep, MFR_M05_MF_QUERY.class);
    }
     ...
     * 
     */ 
    public java.util.List<MFR_M05_MF_QUERY> getMF_QUERYAll() throws HL7Exception {
    	return getAllAsList("MF_QUERY", MFR_M05_MF_QUERY.class);
    } 
