...
/**
 * <p>Represents a OUL_R24_CONTAINER group structure (a Group object).
...
public class OUL_R24_CONTAINER extends AbstractGroup {
     ...
     */
    public OUL_R24_CONTAINER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R24_CONTAINER - this is probably a bug in the source code generator.", e);
       }
    }
