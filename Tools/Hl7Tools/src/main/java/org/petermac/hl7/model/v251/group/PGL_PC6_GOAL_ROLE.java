...
/**
 * <p>Represents a PGL_PC6_GOAL_ROLE group structure (a Group object).
...
public class PGL_PC6_GOAL_ROLE extends AbstractGroup {

    /** 
     * Creates a new PGL_PC6_GOAL_ROLE group
     */
    public PGL_PC6_GOAL_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PGL_PC6_GOAL_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
