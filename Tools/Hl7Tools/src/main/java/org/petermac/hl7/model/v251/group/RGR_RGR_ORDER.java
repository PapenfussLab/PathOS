...
/**
 * <p>Represents a RGR_RGR_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: RGR_RGR_ENCODING (a Group object) <b>optional  </b></li>
                         * <li>3: RXG (Pharmacy/Treatment Give) <b> repeating </b></li>
                         * <li>4: RXR (Pharmacy/Treatment Route) <b> repeating </b></li>
                         * <li>5: RXC (Pharmacy/Treatment Component Order) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RGR_RGR_ORDER extends AbstractGroup {

    /** 
     * Creates a new RGR_RGR_ORDER group
     */
    public RGR_RGR_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGR_RGR_ENCODING.class, false, false, false);
                                  this.add(RXG.class, true, true, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGR_RGR_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RGR_RGR_ENCODING getENCODING() { 
       RGR_RGR_ENCODING retVal = getTyped("ENCODING", RGR_RGR_ENCODING.class);
       return retVal;
    }
    ...
    public RXG getRXG(int rep) { 
       RXG retVal = getTyped("RXG", rep, RXG.class);
       return retVal;
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getRXG()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<RXG> getRXGAll() throws HL7Exception {
    	return getAllAsList("RXG", RXG.class);
    } 

    /**
     * Inserts a specific repetition of RXG (Pharmacy/Treatment Give)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRXG(RXG structure, int rep) throws HL7Exception { 
       super.insertRepetition("RXG", structure, rep);
    }
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RXG insertRXG(int rep) throws HL7Exception { 
       return (RXG)super.insertRepetition("RXG", rep);
    }


    /**
     * Removes a specific repetition of RXG (Pharmacy/Treatment Give)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RXG removeRXG(int rep) throws HL7Exception { 
       return (RXG)super.removeRepetition("RXG", rep);
    }
