...
public class AFF extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 60, new Object[]{ getMessage() }, "Set ID - AFF");
                                  this.add(XON.class, true, 1, 250, new Object[]{ getMessage() }, "Professional Organization");
                                  this.add(XAD.class, false, 1, 250, new Object[]{ getMessage() }, "Professional Organization Address");
                                  this.add(DR.class, false, 0, 52, new Object[]{ getMessage() }, "Professional Organization Affiliation Date Range");
                                  this.add(ST.class, false, 1, 60, new Object[]{ getMessage() }, "Professional Affiliation Additional Information");
