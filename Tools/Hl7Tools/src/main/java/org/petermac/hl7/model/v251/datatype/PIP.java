 ...
 * 
 * The Original Code is "PIP.java".  Description:
 * "Composite class PIP"
 * 
...
/**
 * <p>Represents an HL7 PIP (Practitioner Institutional Privileges) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>Privilege (CE)
 * <li>Privilege Class (CE)
 * <li>Expiration Date (DT)
 * <li>Activation Date (DT)
 * <li>Facility (EI)
 * </ul>
 */
...
public class PIP extends AbstractComposite {
    ...
    /**
     * Returns Privilege (component 1).  This is a convenience method that saves you from 
    ...
    /**
     * Returns Privilege Class (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public CE getPrivilegeClass() {
       return getTyped(1, CE.class);
    }
    ...
    /**
     * Returns Activation Date (component 4).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    ...
    /**
     * Returns Facility (component 5).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public EI getFacility() {
       return getTyped(4, EI.class);
    }
