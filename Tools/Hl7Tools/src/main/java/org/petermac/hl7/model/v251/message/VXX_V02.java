 ...
 * <ul>
		                 ...
		                 * <li>6: VXX_V02_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class VXX_V02 extends AbstractMessage  {
    ...
    public VXX_V02_PATIENT getPATIENT() { 
       return getTyped("PATIENT", VXX_V02_PATIENT.class);
    }
    ...
    public VXX_V02_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, VXX_V02_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<VXX_V02_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", VXX_V02_PATIENT.class);
    } 
