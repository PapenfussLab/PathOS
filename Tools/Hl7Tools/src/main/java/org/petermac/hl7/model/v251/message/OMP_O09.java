...
/**
 * <p>Represents a OMP_O09 message structure (see chapter 4.13.3). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: NTE (Notes and Comments) <b>optional repeating</b> </li>
		                 * <li>4: OMP_O09_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>5: OMP_O09_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMP_O09 extends AbstractMessage  {

    /**
     * Creates a new OMP_O09 message with DefaultModelClassFactory. 
     */ 
    public OMP_O09() { 
    ...
    /** 
     * Creates a new OMP_O09 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMP_O09 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OMP_O09_PATIENT getPATIENT() { 
       return getTyped("PATIENT", OMP_O09_PATIENT.class);
    }
    ...
    public OMP_O09_ORDER getORDER() { 
       return getTyped("ORDER", OMP_O09_ORDER.class);
    }
    ...
    public OMP_O09_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, OMP_O09_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<OMP_O09_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", OMP_O09_ORDER.class);
    } 
