...
/**
 * <p>Represents a BRP_O30 message structure (see chapter 4.20.4). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: BRP_O30_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class BRP_O30 extends AbstractMessage  {

    /**
     * Creates a new BRP_O30 message with DefaultModelClassFactory. 
     */ 
    public BRP_O30() { 
    ...
    /** 
     * Creates a new BRP_O30 message with custom ModelClassFactory.
     */
    public BRP_O30(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(BRP_O30_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating BRP_O30 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public BRP_O30_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", BRP_O30_RESPONSE.class);
    }
