...
/**
 * <p>Represents a PPG_PCG_PROBLEM_ROLE group structure (a Group object).
...
public class PPG_PCG_PROBLEM_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPG_PCG_PROBLEM_ROLE group
     */
    public PPG_PCG_PROBLEM_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCG_PROBLEM_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
