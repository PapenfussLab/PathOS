...
/**
 * <p>Represents a BTS_O31_PRODUCT_STATUS group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: BTX (Blood Product Transfusion/Disposition) <b>  </b></li>
...
public class BTS_O31_PRODUCT_STATUS extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(BTX.class, true, false, false);
                                  this.add(NTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating BTS_O31_PRODUCT_STATUS - this is probably a bug in the source code generator.", e);
       }
    }
