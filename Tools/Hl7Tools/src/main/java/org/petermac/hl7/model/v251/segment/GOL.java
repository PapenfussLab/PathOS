...
public class GOL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Goal ID");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Goal Classification");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Goal Management Discipline");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Current Goal Review Status");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Goal Evaluation");
                                  this.add(ST.class, false, 0, 300, new Object[]{ getMessage() }, "Goal Evaluation Comment");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Goal Life Cycle Status");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Goal Life Cycle Status Date/Time");
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "Goal Target Type");
                                  this.add(XPN.class, false, 0, 250, new Object[]{ getMessage() }, "Goal Target Name");
