...
/**
 * <p>Represents a MFN_M06 message structure (see chapter 8.11.1). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: SFT (Software Segment) <b>optional repeating</b> </li>
		                 * <li>3: MFI (Master File Identification) <b> </b> </li>
		                 * <li>4: MFN_M06_MF_CLIN_STUDY (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class MFN_M06 extends AbstractMessage  {

    /**
     * Creates a new MFN_M06 message with DefaultModelClassFactory. 
     */ 
    public MFN_M06() { 
    ...
    /** 
     * Creates a new MFN_M06 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M06 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public MFN_M06_MF_CLIN_STUDY getMF_CLIN_STUDY() { 
       return getTyped("MF_CLIN_STUDY", MFN_M06_MF_CLIN_STUDY.class);
    }
    ...
    public MFN_M06_MF_CLIN_STUDY getMF_CLIN_STUDY(int rep) { 
       return getTyped("MF_CLIN_STUDY", rep, MFN_M06_MF_CLIN_STUDY.class);
    }
     ...
     * 
     */ 
    public java.util.List<MFN_M06_MF_CLIN_STUDY> getMF_CLIN_STUDYAll() throws HL7Exception {
    	return getAllAsList("MF_CLIN_STUDY", MFN_M06_MF_CLIN_STUDY.class);
    } 
