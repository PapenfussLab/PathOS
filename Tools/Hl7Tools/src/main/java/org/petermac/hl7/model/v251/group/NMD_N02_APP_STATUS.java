...
/**
 * <p>Represents a NMD_N02_APP_STATUS group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: NSC (Application Status Change) <b>  </b></li>
...
public class NMD_N02_APP_STATUS extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(NSC.class, true, false, false);
                                  this.add(NTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating NMD_N02_APP_STATUS - this is probably a bug in the source code generator.", e);
       }
    }
