...
public class CSR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(TS.class, false, 3, 26, new Object[]{ getMessage() }, "Study Randomization Date/time");
                                  this.add(CE.class, false, 3, 250, new Object[]{ getMessage() }, "Randomized Study Arm");
                                  this.add(CE.class, false, 3, 250, new Object[]{ getMessage() }, "Stratum for Study Randomization");
