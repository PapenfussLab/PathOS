...
/**
 * <p>Represents a ORD_O04_ORDER_DIET group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: ORD_O04_TIMING_DIET (a Group object) <b>optional repeating </b></li>
                         * <li>3: ODS (Dietary Orders, Supplements, and Preferences) <b>optional repeating </b></li>
...
public class ORD_O04_ORDER_DIET extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ORD_O04_TIMING_DIET.class, false, true, false);
                                  this.add(ODS.class, false, true, false);
                                  this.add(NTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORD_O04_ORDER_DIET - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORD_O04_TIMING_DIET getTIMING_DIET() { 
       ORD_O04_TIMING_DIET retVal = getTyped("TIMING_DIET", ORD_O04_TIMING_DIET.class);
       return retVal;
    }
    ...
    public ORD_O04_TIMING_DIET getTIMING_DIET(int rep) { 
       ORD_O04_TIMING_DIET retVal = getTyped("TIMING_DIET", rep, ORD_O04_TIMING_DIET.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORD_O04_TIMING_DIET> getTIMING_DIETAll() throws HL7Exception {
    	return getAllAsList("TIMING_DIET", ORD_O04_TIMING_DIET.class);
    } 
