...
/**
 * <p>Represents a BAR_P05_PROCEDURE group structure (a Group object).
...
public class BAR_P05_PROCEDURE extends AbstractGroup {

    /** 
     * Creates a new BAR_P05_PROCEDURE group
     */
    public BAR_P05_PROCEDURE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating BAR_P05_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
