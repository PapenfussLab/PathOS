...
/**
 * <p>Represents a PGL_PC6_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PGL_PC6_ORDER_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PGL_PC6_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new PGL_PC6_ORDER_DETAIL group
     */
    public PGL_PC6_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PGL_PC6_ORDER_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PGL_PC6_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PGL_PC6_ORDER_OBSERVATION getORDER_OBSERVATION() { 
       PGL_PC6_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", PGL_PC6_ORDER_OBSERVATION.class);
       return retVal;
    }
    ...
    public PGL_PC6_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) { 
       PGL_PC6_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", rep, PGL_PC6_ORDER_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("ORDER_OBSERVATION", PGL_PC6_ORDER_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER_OBSERVATION(PGL_PC6_ORDER_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_ORDER_OBSERVATION insertORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (PGL_PC6_ORDER_OBSERVATION)super.insertRepetition("ORDER_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_ORDER_OBSERVATION removeORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (PGL_PC6_ORDER_OBSERVATION)super.removeRepetition("ORDER_OBSERVATION", rep);
    }
