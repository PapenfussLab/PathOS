...
/**
 * <p>Represents a RGV_O15_ORDER_DETAIL_SUPPLEMENT group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: NTE (Notes and Comments) <b> repeating </b></li>
                         * <li>2: RXR (Pharmacy/Treatment Route) <b> repeating </b></li>
                         * <li>3: RGV_O15_COMPONENTS (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RGV_O15_ORDER_DETAIL_SUPPLEMENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGV_O15_COMPONENTS.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGV_O15_ORDER_DETAIL_SUPPLEMENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RGV_O15_COMPONENTS getCOMPONENTS() { 
       RGV_O15_COMPONENTS retVal = getTyped("COMPONENTS", RGV_O15_COMPONENTS.class);
       return retVal;
    }
    ...
    public RGV_O15_COMPONENTS getCOMPONENTS(int rep) { 
       RGV_O15_COMPONENTS retVal = getTyped("COMPONENTS", rep, RGV_O15_COMPONENTS.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of COMPONENTS 
     */ 
    public int getCOMPONENTSReps() {  
        return getReps("COMPONENTS");
    } 
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getCOMPONENTS()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<RGV_O15_COMPONENTS> getCOMPONENTSAll() throws HL7Exception {
    	return getAllAsList("COMPONENTS", RGV_O15_COMPONENTS.class);
    } 
