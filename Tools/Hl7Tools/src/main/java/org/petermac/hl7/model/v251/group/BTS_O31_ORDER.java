...
/**
 * <p>Represents a BTS_O31_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: BTS_O31_TIMING (a Group object) <b>optional repeating </b></li>
                         * <li>3: BPO (Blood product order) <b>  </b></li>
                         * <li>4: NTE (Notes and Comments) <b>optional repeating </b></li>
                         * <li>5: BTS_O31_PRODUCT_STATUS (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class BTS_O31_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating BTS_O31_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public BTS_O31_TIMING getTIMING() { 
       BTS_O31_TIMING retVal = getTyped("TIMING", BTS_O31_TIMING.class);
       return retVal;
    }
    ...
    public BTS_O31_TIMING getTIMING(int rep) { 
       BTS_O31_TIMING retVal = getTyped("TIMING", rep, BTS_O31_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<BTS_O31_TIMING> getTIMINGAll() throws HL7Exception {
    	return getAllAsList("TIMING", BTS_O31_TIMING.class);
    } 
     ...
     * Returns
     * the first repetition of 
     * PRODUCT_STATUS (a Group object) - creates it if necessary
     */
    public BTS_O31_PRODUCT_STATUS getPRODUCT_STATUS() { 
       BTS_O31_PRODUCT_STATUS retVal = getTyped("PRODUCT_STATUS", BTS_O31_PRODUCT_STATUS.class);
       return retVal;
    }
    ...
    public BTS_O31_PRODUCT_STATUS getPRODUCT_STATUS(int rep) { 
       BTS_O31_PRODUCT_STATUS retVal = getTyped("PRODUCT_STATUS", rep, BTS_O31_PRODUCT_STATUS.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of PRODUCT_STATUS 
     */ 
    public int getPRODUCT_STATUSReps() {  
        return getReps("PRODUCT_STATUS");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of PRODUCT_STATUS.
     * <p>
     * <p>
     * Note that unlike {@link #getPRODUCT_STATUS()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<BTS_O31_PRODUCT_STATUS> getPRODUCT_STATUSAll() throws HL7Exception {
    	return getAllAsList("PRODUCT_STATUS", BTS_O31_PRODUCT_STATUS.class);
    } 

    /**
     * Inserts a specific repetition of PRODUCT_STATUS (a Group object)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPRODUCT_STATUS(BTS_O31_PRODUCT_STATUS structure, int rep) throws HL7Exception { 
       super.insertRepetition("PRODUCT_STATUS", structure, rep);
    }
    ...
    /**
     * Removes a specific repetition of PRODUCT_STATUS (a Group object)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
