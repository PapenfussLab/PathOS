...
public class ORC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 60, new Object[]{ getMessage() }, "Advanced Beneficiary Notice Override Reason");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Filler's Expected Availability Date/Time");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Confidentiality Code");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Order Type");
                                  this.add(CNE.class, false, 1, 250, new Object[]{ getMessage() }, "Enterer Authorization Mode");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Parent Universal Service Identifier");
