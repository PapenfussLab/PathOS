...
/**
 * <p>Represents a RQA_I08_PROVIDER group structure (a Group object).
...
public class RQA_I08_PROVIDER extends AbstractGroup {
     ...
     */
    public RQA_I08_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQA_I08_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
