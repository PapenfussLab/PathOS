 ...
 * <ul>
		                 ...
		                 * <li>4: MFN_M04_MF_CDM (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class MFN_M04 extends AbstractMessage  {
     ...
     * Returns
     * the first repetition of 
     * MF_CDM (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFN_M04_MF_CDM getMF_CDM() { 
       return getTyped("MF_CDM", MFN_M04_MF_CDM.class);
    }
    ...
    public MFN_M04_MF_CDM getMF_CDM(int rep) { 
       return getTyped("MF_CDM", rep, MFN_M04_MF_CDM.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of MF_CDM 
     * </p>
     * 
     */ 
    public int getMF_CDMReps() { 
    	return getReps("MF_CDM");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MF_CDM.
     * <p>
     * <p>
     * Note that unlike {@link #getMF_CDM()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFN_M04_MF_CDM> getMF_CDMAll() throws HL7Exception {
    	return getAllAsList("MF_CDM", MFN_M04_MF_CDM.class);
    } 
