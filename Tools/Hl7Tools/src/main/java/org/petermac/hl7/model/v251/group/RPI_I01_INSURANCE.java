...
/**
 * <p>Represents a RPI_I01_INSURANCE group structure (a Group object).
...
public class RPI_I01_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new RPI_I01_INSURANCE group
     */
    public RPI_I01_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPI_I01_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
