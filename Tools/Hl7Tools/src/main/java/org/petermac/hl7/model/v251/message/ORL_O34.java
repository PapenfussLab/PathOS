...
/**
 * <p>Represents a ORL_O34 message structure (see chapter 4.4.9). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORL_O34_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORL_O34 extends AbstractMessage  {

    /**
     * Creates a new ORL_O34 message with DefaultModelClassFactory. 
     */ 
    public ORL_O34() { 
    ...
    /** 
     * Creates a new ORL_O34 message with custom ModelClassFactory.
     */
    public ORL_O34(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORL_O34_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORL_O34 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORL_O34_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORL_O34_RESPONSE.class);
    }
