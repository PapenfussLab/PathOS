 ...
 * <ul>
     ...
     * <li>QAK-3: Message Query Name (CE) <b>optional </b>
     * <li>QAK-4: Hit Count (NM) <b>optional </b>
...
public class QAK extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Message Query Name");
                                  this.add(NM.class, false, 1, 10, new Object[]{ getMessage() }, "Hit Count");
                                  this.add(NM.class, false, 1, 10, new Object[]{ getMessage() }, "This payload");
                                  this.add(NM.class, false, 1, 10, new Object[]{ getMessage() }, "Hits remaining");
    ...
    /**
     * Returns
     * QAK-4: "Hit Count" - creates it if necessary
     */
