...
/**
 * <p>Represents a RDS_O13_PATIENT_VISIT group structure (a Group object).
...
public class RDS_O13_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new RDS_O13_PATIENT_VISIT group
     */
    public RDS_O13_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDS_O13_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
