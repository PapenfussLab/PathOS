 ...
 * <ul>
     * <li>BLC-1: Blood Product Code (CE) <b>optional </b>
...
public class BLC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Blood Product Code");
                                  this.add(CQ.class, false, 1, 267, new Object[]{ getMessage() }, "Blood Amount");
