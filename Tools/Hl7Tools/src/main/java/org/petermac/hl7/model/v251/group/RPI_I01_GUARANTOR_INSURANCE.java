...
/**
 * <p>Represents a RPI_I01_GUARANTOR_INSURANCE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: GT1 (Guarantor) <b>optional repeating </b></li>
                         * <li>2: RPI_I01_INSURANCE (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RPI_I01_GUARANTOR_INSURANCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RPI_I01_INSURANCE.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RPI_I01_GUARANTOR_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RPI_I01_INSURANCE getINSURANCE() { 
       RPI_I01_INSURANCE retVal = getTyped("INSURANCE", RPI_I01_INSURANCE.class);
       return retVal;
    }
    ...
    public RPI_I01_INSURANCE getINSURANCE(int rep) { 
       RPI_I01_INSURANCE retVal = getTyped("INSURANCE", rep, RPI_I01_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RPI_I01_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", RPI_I01_INSURANCE.class);
    } 
