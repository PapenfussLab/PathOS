...
/**
 * <p>Represents a REF_I12_PATIENT_VISIT group structure (a Group object).
...
public class REF_I12_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new REF_I12_PATIENT_VISIT group
     */
    public REF_I12_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating REF_I12_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
