...
/**
 * <p>Represents a SRR_S01_LOCATION_RESOURCE group structure (a Group object).
...
public class SRR_S01_LOCATION_RESOURCE extends AbstractGroup {

    /** 
     * Creates a new SRR_S01_LOCATION_RESOURCE group
     */
    public SRR_S01_LOCATION_RESOURCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRR_S01_LOCATION_RESOURCE - this is probably a bug in the source code generator.", e);
       }
    }
