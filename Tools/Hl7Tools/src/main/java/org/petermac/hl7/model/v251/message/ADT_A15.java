...
/**
 * <p>Represents a ADT_A15 message structure (see chapter 3.3.15). This structure contains the 
...
public class ADT_A15 extends AbstractMessage  {

    /**
     * Creates a new ADT_A15 message with DefaultModelClassFactory. 
     */ 
    public ADT_A15() { 
    ...
    /** 
     * Creates a new ADT_A15 message with custom ModelClassFactory.
     */
    public ADT_A15(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A15 - this is probably a bug in the source code generator.", e);
       }
    }
