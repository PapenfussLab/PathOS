...
/**
 * <p>Represents a OUL_R23_VISIT group structure (a Group object).
...
public class OUL_R23_VISIT extends AbstractGroup {

    /** 
     * Creates a new OUL_R23_VISIT group
     */
    public OUL_R23_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R23_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
