...
/**
 * <p>Represents a RRI_I12_PATIENT_VISIT group structure (a Group object).
...
public class RRI_I12_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new RRI_I12_PATIENT_VISIT group
     */
    public RRI_I12_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRI_I12_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
