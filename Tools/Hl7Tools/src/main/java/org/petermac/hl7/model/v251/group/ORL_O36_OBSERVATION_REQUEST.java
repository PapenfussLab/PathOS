...
/**
 * <p>Represents a ORL_O36_OBSERVATION_REQUEST group structure (a Group object).
...
public class ORL_O36_OBSERVATION_REQUEST extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORL_O36_OBSERVATION_REQUEST - this is probably a bug in the source code generator.", e);
       }
    }
