...
/**
 * <p>Represents a SQM_S25_SERVICE group structure (a Group object).
...
public class SQM_S25_SERVICE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SQM_S25_SERVICE - this is probably a bug in the source code generator.", e);
       }
    }
