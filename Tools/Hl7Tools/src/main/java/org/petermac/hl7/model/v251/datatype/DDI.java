 ...
 * 
 * The Original Code is "DDI.java".  Description:
 * "Composite class DDI"
 * 
...
/**
 * <p>Represents an HL7 DDI (Daily Deductible Information) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>Delay Days (NM)
 * <li>Monetary Amount (MO)
...
public class DDI extends AbstractComposite {
    ...
    /**
     * Returns Delay Days (component 1).  This is a convenience method that saves you from 
    ...
    /**
     * Returns Monetary Amount (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    ...
    /**
     * Returns Number of Days (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
