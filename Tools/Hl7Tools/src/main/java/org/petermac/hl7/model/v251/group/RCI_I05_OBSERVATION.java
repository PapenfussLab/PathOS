...
/**
 * <p>Represents a RCI_I05_OBSERVATION group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RCI_I05_RESULTS (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RCI_I05_OBSERVATION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RCI_I05_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RCI_I05_RESULTS getRESULTS() { 
       RCI_I05_RESULTS retVal = getTyped("RESULTS", RCI_I05_RESULTS.class);
       return retVal;
    }
    ...
    public RCI_I05_RESULTS getRESULTS(int rep) { 
       RCI_I05_RESULTS retVal = getTyped("RESULTS", rep, RCI_I05_RESULTS.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RCI_I05_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", RCI_I05_RESULTS.class);
    } 
