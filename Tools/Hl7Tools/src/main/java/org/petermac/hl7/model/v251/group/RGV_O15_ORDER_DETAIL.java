...
public class RGV_O15_ORDER_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGV_O15_ORDER_DETAIL_SUPPLEMENT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGV_O15_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RGV_O15_ORDER_DETAIL_SUPPLEMENT getORDER_DETAIL_SUPPLEMENT() { 
       RGV_O15_ORDER_DETAIL_SUPPLEMENT retVal = getTyped("ORDER_DETAIL_SUPPLEMENT", RGV_O15_ORDER_DETAIL_SUPPLEMENT.class);
       return retVal;
    }
