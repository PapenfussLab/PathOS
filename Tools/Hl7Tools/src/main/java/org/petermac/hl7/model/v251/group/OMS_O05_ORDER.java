...
public class OMS_O05_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMS_O05_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public java.util.List<OMS_O05_TIMING> getTIMINGAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public java.util.List<OMS_O05_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
