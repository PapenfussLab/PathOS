 ...
 * <ul>
     ...
     * <li>LCC-2: Location Department (CE) <b> </b>
...
public class LCC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(PL.class, true, 1, 200, new Object[]{ getMessage() }, "Primary Key Value - LCC");
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Location Department");
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "Accommodation Type");
                                  this.add(CE.class, true, 0, 250, new Object[]{ getMessage() }, "Charge Code");
