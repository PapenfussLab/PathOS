...
/**
 * <p>Represents a RRG_O16_TIMING group structure (a Group object).
...
public class RRG_O16_TIMING extends AbstractGroup {

    /** 
     * Creates a new RRG_O16_TIMING group
     */
    public RRG_O16_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRG_O16_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
