 ...
 * <ul>
		                 ...
		                 * <li>5: ORR_O02_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
...
public class ORR_O02 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORR_O02 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORR_O02_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORR_O02_RESPONSE.class);
    }
