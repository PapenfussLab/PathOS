...
/**
 * <p>Represents a RDE_O11_INSURANCE group structure (a Group object).
...
public class RDE_O11_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new RDE_O11_INSURANCE group
     */
    public RDE_O11_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDE_O11_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
