 ...
 * <ul>
                         ...
                         * <li>2: DFT_P03_FINANCIAL_TIMING_QUANTITY (a Group object) <b>optional repeating </b></li>
                         * <li>3: DFT_P03_FINANCIAL_ORDER (a Group object) <b>optional  </b></li>
                         * <li>4: DFT_P03_FINANCIAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class DFT_P03_FINANCIAL_COMMON_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DFT_P03_FINANCIAL_TIMING_QUANTITY.class, false, true, false);
                                  this.add(DFT_P03_FINANCIAL_ORDER.class, false, false, false);
                                  this.add(DFT_P03_FINANCIAL_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating DFT_P03_FINANCIAL_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public DFT_P03_FINANCIAL_TIMING_QUANTITY getFINANCIAL_TIMING_QUANTITY() { 
       DFT_P03_FINANCIAL_TIMING_QUANTITY retVal = getTyped("FINANCIAL_TIMING_QUANTITY", DFT_P03_FINANCIAL_TIMING_QUANTITY.class);
       return retVal;
    }
    ...
    public DFT_P03_FINANCIAL_TIMING_QUANTITY getFINANCIAL_TIMING_QUANTITY(int rep) { 
       DFT_P03_FINANCIAL_TIMING_QUANTITY retVal = getTyped("FINANCIAL_TIMING_QUANTITY", rep, DFT_P03_FINANCIAL_TIMING_QUANTITY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<DFT_P03_FINANCIAL_TIMING_QUANTITY> getFINANCIAL_TIMING_QUANTITYAll() throws HL7Exception {
    	return getAllAsList("FINANCIAL_TIMING_QUANTITY", DFT_P03_FINANCIAL_TIMING_QUANTITY.class);
    } 
     ...
     */
    public void insertFINANCIAL_TIMING_QUANTITY(DFT_P03_FINANCIAL_TIMING_QUANTITY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public DFT_P03_FINANCIAL_TIMING_QUANTITY insertFINANCIAL_TIMING_QUANTITY(int rep) throws HL7Exception { 
       return (DFT_P03_FINANCIAL_TIMING_QUANTITY)super.insertRepetition("FINANCIAL_TIMING_QUANTITY", rep);
    }
     ...
     */
    public DFT_P03_FINANCIAL_TIMING_QUANTITY removeFINANCIAL_TIMING_QUANTITY(int rep) throws HL7Exception { 
       return (DFT_P03_FINANCIAL_TIMING_QUANTITY)super.removeRepetition("FINANCIAL_TIMING_QUANTITY", rep);
    }
    ...
    public DFT_P03_FINANCIAL_ORDER getFINANCIAL_ORDER() { 
       DFT_P03_FINANCIAL_ORDER retVal = getTyped("FINANCIAL_ORDER", DFT_P03_FINANCIAL_ORDER.class);
       return retVal;
    }
    ...
    public DFT_P03_FINANCIAL_OBSERVATION getFINANCIAL_OBSERVATION() { 
       DFT_P03_FINANCIAL_OBSERVATION retVal = getTyped("FINANCIAL_OBSERVATION", DFT_P03_FINANCIAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public DFT_P03_FINANCIAL_OBSERVATION getFINANCIAL_OBSERVATION(int rep) { 
       DFT_P03_FINANCIAL_OBSERVATION retVal = getTyped("FINANCIAL_OBSERVATION", rep, DFT_P03_FINANCIAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<DFT_P03_FINANCIAL_OBSERVATION> getFINANCIAL_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("FINANCIAL_OBSERVATION", DFT_P03_FINANCIAL_OBSERVATION.class);
    } 
