...
/**
 * <p>Represents a PPV_PCA_GOAL_PATHWAY group structure (a Group object).
...
public class PPV_PCA_GOAL_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new PPV_PCA_GOAL_PATHWAY group
     */
    public PPV_PCA_GOAL_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPV_PCA_GOAL_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
