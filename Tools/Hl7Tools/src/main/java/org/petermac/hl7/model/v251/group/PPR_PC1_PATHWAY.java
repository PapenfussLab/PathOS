...
/**
 * <p>Represents a PPR_PC1_PATHWAY group structure (a Group object).
...
public class PPR_PC1_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new PPR_PC1_PATHWAY group
     */
    public PPR_PC1_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPR_PC1_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
