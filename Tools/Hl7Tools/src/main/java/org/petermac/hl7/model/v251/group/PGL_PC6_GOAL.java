...
/**
 * <p>Represents a PGL_PC6_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PGL_PC6_GOAL_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PGL_PC6_PATHWAY (a Group object) <b>optional repeating </b></li>
                         * <li>6: PGL_PC6_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>7: PGL_PC6_PROBLEM (a Group object) <b>optional repeating </b></li>
                         * <li>8: PGL_PC6_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PGL_PC6_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PGL_PC6_GOAL_ROLE.class, false, true, false);
                                  this.add(PGL_PC6_PATHWAY.class, false, true, false);
                                  this.add(PGL_PC6_OBSERVATION.class, false, true, false);
                                  this.add(PGL_PC6_PROBLEM.class, false, true, false);
                                  this.add(PGL_PC6_ORDER.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PGL_PC6_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PGL_PC6_GOAL_ROLE getGOAL_ROLE() { 
       PGL_PC6_GOAL_ROLE retVal = getTyped("GOAL_ROLE", PGL_PC6_GOAL_ROLE.class);
       return retVal;
    }
    ...
    public PGL_PC6_GOAL_ROLE getGOAL_ROLE(int rep) { 
       PGL_PC6_GOAL_ROLE retVal = getTyped("GOAL_ROLE", rep, PGL_PC6_GOAL_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
    	return getAllAsList("GOAL_ROLE", PGL_PC6_GOAL_ROLE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertGOAL_ROLE(PGL_PC6_GOAL_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_GOAL_ROLE insertGOAL_ROLE(int rep) throws HL7Exception { 
       return (PGL_PC6_GOAL_ROLE)super.insertRepetition("GOAL_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_GOAL_ROLE removeGOAL_ROLE(int rep) throws HL7Exception { 
       return (PGL_PC6_GOAL_ROLE)super.removeRepetition("GOAL_ROLE", rep);
    }
    ...
    public PGL_PC6_PATHWAY getPATHWAY() { 
       PGL_PC6_PATHWAY retVal = getTyped("PATHWAY", PGL_PC6_PATHWAY.class);
       return retVal;
    }
    ...
    public PGL_PC6_PATHWAY getPATHWAY(int rep) { 
       PGL_PC6_PATHWAY retVal = getTyped("PATHWAY", rep, PGL_PC6_PATHWAY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_PATHWAY> getPATHWAYAll() throws HL7Exception {
    	return getAllAsList("PATHWAY", PGL_PC6_PATHWAY.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATHWAY(PGL_PC6_PATHWAY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_PATHWAY insertPATHWAY(int rep) throws HL7Exception { 
       return (PGL_PC6_PATHWAY)super.insertRepetition("PATHWAY", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_PATHWAY removePATHWAY(int rep) throws HL7Exception { 
       return (PGL_PC6_PATHWAY)super.removeRepetition("PATHWAY", rep);
    }
    ...
    public PGL_PC6_OBSERVATION getOBSERVATION() { 
       PGL_PC6_OBSERVATION retVal = getTyped("OBSERVATION", PGL_PC6_OBSERVATION.class);
       return retVal;
    }
    ...
    public PGL_PC6_OBSERVATION getOBSERVATION(int rep) { 
       PGL_PC6_OBSERVATION retVal = getTyped("OBSERVATION", rep, PGL_PC6_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", PGL_PC6_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBSERVATION(PGL_PC6_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_OBSERVATION insertOBSERVATION(int rep) throws HL7Exception { 
       return (PGL_PC6_OBSERVATION)super.insertRepetition("OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_OBSERVATION removeOBSERVATION(int rep) throws HL7Exception { 
       return (PGL_PC6_OBSERVATION)super.removeRepetition("OBSERVATION", rep);
    }
    ...
    public PGL_PC6_PROBLEM getPROBLEM() { 
       PGL_PC6_PROBLEM retVal = getTyped("PROBLEM", PGL_PC6_PROBLEM.class);
       return retVal;
    }
    ...
    public PGL_PC6_PROBLEM getPROBLEM(int rep) { 
       PGL_PC6_PROBLEM retVal = getTyped("PROBLEM", rep, PGL_PC6_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_PROBLEM> getPROBLEMAll() throws HL7Exception {
    	return getAllAsList("PROBLEM", PGL_PC6_PROBLEM.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM(PGL_PC6_PROBLEM structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_PROBLEM insertPROBLEM(int rep) throws HL7Exception { 
       return (PGL_PC6_PROBLEM)super.insertRepetition("PROBLEM", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_PROBLEM removePROBLEM(int rep) throws HL7Exception { 
       return (PGL_PC6_PROBLEM)super.removeRepetition("PROBLEM", rep);
    }
    ...
    public PGL_PC6_ORDER getORDER() { 
       PGL_PC6_ORDER retVal = getTyped("ORDER", PGL_PC6_ORDER.class);
       return retVal;
    }
    ...
    public PGL_PC6_ORDER getORDER(int rep) { 
       PGL_PC6_ORDER retVal = getTyped("ORDER", rep, PGL_PC6_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", PGL_PC6_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER(PGL_PC6_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_ORDER insertORDER(int rep) throws HL7Exception { 
       return (PGL_PC6_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_ORDER removeORDER(int rep) throws HL7Exception { 
       return (PGL_PC6_ORDER)super.removeRepetition("ORDER", rep);
    }
