...
static TestSuite suite()
{
    ...
    suite.addTestSuite( gsuite.compile( test_util + 'HollyUtilTest.groovy'))
    ...
    suite.addTestSuite( gsuite.compile( test_pipeline + 'CanaryTest.groovy'))
    ...
    suite.addTestSuite( gsuite.compile( test_pipeline + 'MutalyzerIntTest.groovy'))
