...
<div id="clinContextHolder" class="fieldcontain ${hasErrors(bean: variantInstance, field: 'clinContext', 'error')} ">
    <label for="clinContext">
        Clinical Context<br/>
    </label>
    <%--  MutContext of a CurVar Cannot Be Altered --%>
        <span id="changeClinContext"><b>${variantInstance.clinContext? variantInstance.clinContext : 'None'}</b></span>
</div>
...
<r:script>
    ...
    // $(function(){
    //     $("a#mutContextHolder").click(function(){
    //         $("#changeMutContext").toggle();
    //     });
    // });
/*    $('#mutContextPicker').on('change', function() {
        //call a function in controller
        //print a message (dont need logic)
         mutContext = $('#mutContextPicker').val()
         cvid = ${variantInstance.id}
/*
