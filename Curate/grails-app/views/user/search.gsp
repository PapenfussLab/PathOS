...
<div>
	...
	<g:form action='userSearch' name='userSearchForm'>
		...
		<table>
            ...
            <tr>
                <td><g:message code='user.displayName.label' default='Display Name'/>:</td>
                <td colspan='3'><g:textField name='displayName' size='50' maxlength='255' autocomplete='off' value='${dispayName}'/></td>
            </tr>
            <tr>
...
<%
def queryParams = [username: username, displayName: displayName, email: email, enabled: enabled, accountExpired: accountExpired, accountLocked: accountLocked, passwordExpired: passwordExpired]
%>
	...
	<table>
		...
		<tr>
            ...
            <g:sortableColumn property="displayName" title="${message(code: 'user.displayName.label', default: 'Display Name')}" params="${queryParams}"/>
		...
		<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
            ...
            <td><g:link action="edit" id="${user.id}">${fieldValue(bean: user, field: "displayName")}</g:link></td>
	...
	<div class="paginateButtons">
        ...
        <g:if test='${mailtoString}'>
        <br/>
            <g:if test="${totalCount == 1}">
                <a href='mailto:${mailtoString}'>Mail this ${totalCount} user</a>
            </g:if>
            <g:else>
                <a href='mailto:${mailtoString}'>Mail these ${totalCount} users</a>
            </g:else>
            <br/>
        <br/>
        </g:if>
