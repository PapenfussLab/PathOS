...
<html>
	...
	<body>
		<a href="#edit-drug" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-drug" class="content scaffold-edit" role="main">
