...
<html>
	...
	<body>
		<a href="#edit-clinContext" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-clinContext" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${clinContextInstance?.version}" />
				<fieldset class="form">
