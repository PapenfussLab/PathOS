...
ALTER TABLE grp_variant DROP INDEX  `FK2955932BC6CECA17`;
...
ALTER TABLE seq_variant DROP FOREIGN KEY `FK5097A4A55BA530E5`;
ALTER TABLE seq_variant DROP INDEX `FK5097A4A57BAB8115`;
ALTER TABLE seq_variant DROP INDEX `FK5097A4A55BA530E5`;
