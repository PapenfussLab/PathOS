...
searchable {
    ...
    //  Note this is overridden by environment specific values at end of this file
    //
    compassConnection = new File( loc.prop.get('pathos.searchable.index_home') as String).absolutePath
...
// We're turning off bulk indexing and mirroring by default
// And then turning them on using BootStrap.groovy
// DKGM 14-07-2016

// per-environment settings go here if needed
environments {
}
