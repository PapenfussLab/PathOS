...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clipboard = __webpack_require__(304);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buildAxisDta = function _buildAxisDta(value, axesGroup, conf) {
	  return {
	    value: value,
	...
	var Highlight = function (_Track) {
	  ...
	  _createClass(Highlight, [{
	    ...
	    value: function renderDatum(parentElement, conf, layout) {
	      ...
	      conf.arc = (0, _d3Shape.arc)().innerRadius(conf.innerRadius).outerRadius(conf.outerRadius).startAngle(function (d, i) {
	      ...
	      return parentElement.selectAll('tile').data(function (d) {
	        return d.values;
	      }).enter().append('path').attr('class', 'tile').attr('d', conf.arc).attr('fill', conf.colorValue).attr('opacity', conf.opacity).attr('stroke-width', conf.strokeWidth).attr('stroke', conf.strokeColor);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clipboardJs = __webpack_require__(305);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(306).setImmediate))
